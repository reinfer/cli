...
/// UserAccessModelKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum UserAccessModelKind {
    #[serde(rename = "user_access")]
    UserAccess,

}

impl std::fmt::Display for UserAccessModelKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::UserAccess => write!(f, "user_access"),
        }
    }
}

impl Default for UserAccessModelKind {
    fn default() -> UserAccessModelKind {
        Self::UserAccess
    }
}
