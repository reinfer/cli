...
pub struct GetAllIntegrationsResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetAllIntegrationsResponse {
    pub fn new(status: Status, integrations: Vec<models::Integration>) -> GetAllIntegrationsResponse {
