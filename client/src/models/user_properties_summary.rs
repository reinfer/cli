...
pub struct UserPropertiesSummary {
    #[serde(rename = "number")]
    pub number: Vec<models::NumberUserPropertySummary>,
    #[serde(rename = "string")]
    pub string: Vec<models::StringUserPropertySummary>,
}

impl UserPropertiesSummary {
    pub fn new(number: Vec<models::NumberUserPropertySummary>, string: Vec<models::StringUserPropertySummary>) -> UserPropertiesSummary {
        UserPropertiesSummary {
            number,
            string,
        }
    }
