...
/// LabelDefUpdate : Definition of a label def to be updated
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LabelDefUpdate {
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "properties", skip_serializing_if = "Option::is_none")]
    pub properties: Option<Vec<models::LabelDefProperty>>,
    ...
    #[serde(rename = "pretrained", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pretrained: Option<Option<Box<models::BuiltinLabelDefRequest>>>,
    #[serde(rename = "trainable", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub trainable: Option<Option<bool>>,
    #[serde(rename = "moon_form", skip_serializing_if = "Option::is_none")]
    pub moon_form: Option<Vec<models::LabelDefUpdateMoonFormInner>>,
}

impl LabelDefUpdate {
    /// Definition of a label def to be updated
    pub fn new() -> LabelDefUpdate {
        LabelDefUpdate {
            name: None,
            properties: None,
            title: None,
