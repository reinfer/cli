...
/// DatasetFlag : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum DatasetFlag {
    #[serde(rename = "conversational_filters")]
    ConversationalFilters,
    #[serde(rename = "external_moon_llm")]
    ExternalMoonLlm,
    #[serde(rename = "generative_extraction")]
    GenerativeExtraction,
    #[serde(rename = "generative_prelabelling")]
    GenerativePrelabelling,
    #[serde(rename = "gpt4")]
    Gpt4,
    #[serde(rename = "llm_assisted_labelling")]
    LlmAssistedLabelling,
    #[serde(rename = "qos")]
    Qos,
    #[serde(rename = "zero_shot_labels")]
    ZeroShotLabels,
    #[serde(rename = "ixp")]
    Ixp,
...
impl std::fmt::Display for DatasetFlag {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::ConversationalFilters => write!(f, "conversational_filters"),
            Self::ExternalMoonLlm => write!(f, "external_moon_llm"),
            Self::GenerativeExtraction => write!(f, "generative_extraction"),
            Self::GenerativePrelabelling => write!(f, "generative_prelabelling"),
            Self::Gpt4 => write!(f, "gpt4"),
            Self::LlmAssistedLabelling => write!(f, "llm_assisted_labelling"),
            Self::Qos => write!(f, "qos"),
            Self::ZeroShotLabels => write!(f, "zero_shot_labels"),
            Self::Ixp => write!(f, "ixp"),
        }
    }
}

impl Default for DatasetFlag {
    fn default() -> DatasetFlag {
        Self::ConversationalFilters
    }
}
