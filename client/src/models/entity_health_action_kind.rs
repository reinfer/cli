...
/// EntityHealthActionKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum EntityHealthActionKind {
    #[serde(rename = "teach")]
    Teach,
    #[serde(rename = "correct_entity")]
    CorrectEntity,
    #[serde(rename = "missing_entity")]
    MissingEntity,
    #[serde(rename = "shuffle_filter")]
    ShuffleFilter,

}

impl std::fmt::Display for EntityHealthActionKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Teach => write!(f, "teach"),
            Self::CorrectEntity => write!(f, "correct_entity"),
            Self::MissingEntity => write!(f, "missing_entity"),
            Self::ShuffleFilter => write!(f, "shuffle_filter"),
        }
    }
}

impl Default for EntityHealthActionKind {
    fn default() -> EntityHealthActionKind {
        Self::Teach
    }
}
