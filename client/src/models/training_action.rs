...
impl TrainingAction {
    pub fn new(id: String, kind: Kind, plan: models::LabelAction, factor_kind: models::ModelRatingFactorKind, quality: models::DatasetQuality, sub_kind: String) -> TrainingAction {
        TrainingAction {
            id,
            kind,
            plan: Box::new(plan),
