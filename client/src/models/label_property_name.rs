...
/// LabelPropertyName : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum LabelPropertyName {
    #[serde(rename = "tone")]
    Tone,
    #[serde(rename = "quality_of_service")]
    QualityOfService,

}

impl std::fmt::Display for LabelPropertyName {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Tone => write!(f, "tone"),
            Self::QualityOfService => write!(f, "quality_of_service"),
        }
    }
}

impl Default for LabelPropertyName {
    fn default() -> LabelPropertyName {
        Self::Tone
    }
}
