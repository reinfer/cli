...
pub struct RichDiagnosticKind {
    #[serde(rename = "diagnostic_kind")]
    pub diagnostic_kind: models::DiagnosticKind,
    #[serde(rename = "related_to", deserialize_with = "Option::deserialize")]
    pub related_to: Option<String>,
}

impl RichDiagnosticKind {
    pub fn new(diagnostic_kind: models::DiagnosticKind, related_to: Option<String>) -> RichDiagnosticKind {
        RichDiagnosticKind {
            diagnostic_kind,
            related_to,
        }
