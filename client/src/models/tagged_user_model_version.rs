...
pub struct TaggedUserModelVersion {
    #[serde(rename = "name")]
    pub name: models::TaggedUserModelVersionName,
...
impl TaggedUserModelVersion {
    pub fn new(name: models::TaggedUserModelVersionName, version: i32, updated_at: String) -> TaggedUserModelVersion {
        TaggedUserModelVersion {
            name,
            version,
            updated_at,
        }
