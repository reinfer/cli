...
pub struct UpdateModelTagResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "model_tag")]
    pub model_tag: Box<models::TaggedUserModelVersion>,
}

impl UpdateModelTagResponse {
    pub fn new(status: Status, model_tag: models::TaggedUserModelVersion) -> UpdateModelTagResponse {
        UpdateModelTagResponse {
            status,
            model_tag: Box::new(model_tag),
        }
    }
}
/// 
