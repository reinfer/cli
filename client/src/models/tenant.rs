...
pub struct Tenant {
    ...
    #[serde(rename = "uipath_context", deserialize_with = "Option::deserialize")]
    pub uipath_context: Option<Box<models::FieldUipathContextModel>>,
    /// Support ID/Licence Code that links user with UiPath support
    #[serde(rename = "uipath_support_id", deserialize_with = "Option::deserialize")]
    pub uipath_support_id: Option<String>,
}

impl Tenant {
    pub fn new(tenant_id: String, name: String, title: String, description: String, created_at: String, updated_at: String, flags: Vec<String>, uipath_context: Option<models::FieldUipathContextModel>, uipath_support_id: Option<String>) -> Tenant {
        Tenant {
            tenant_id,
            name,
            title,
            ...
            updated_at,
            flags,
            uipath_context: if let Some(x) = uipath_context {Some(Box::new(x))} else {None},
            uipath_support_id,
        }
    }
}
