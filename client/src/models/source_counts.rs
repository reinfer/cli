...
pub struct SourceCounts {
    ...
    pub settings: Box<models::SourceCountsSettings>,
...
impl SourceCounts {
    pub fn new(values: Vec<String>, labels: Vec<String>, num_comments: Vec<f64>, num_labels: Vec<Vec<f64>>, settings: models::SourceCountsSettings) -> SourceCounts {
        SourceCounts {
            values,
            labels,
            num_comments,
