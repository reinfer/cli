...
pub struct LabelPropertySummaryLabel {
    #[serde(rename = "label_name")]
    pub label_name: String,
    #[serde(rename = "label_property_sums")]
    pub label_property_sums: Vec<f64>,
}

impl LabelPropertySummaryLabel {
    pub fn new(label_name: String, label_property_sums: Vec<f64>) -> LabelPropertySummaryLabel {
        LabelPropertySummaryLabel {
            label_name,
            label_property_sums,
        }
    }
