...
pub struct DocPathIxpModelConfig {
    ...
    #[serde(rename = "num_pages_per_chunk", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub num_pages_per_chunk: Option<Option<i32>>,
}

impl DocPathIxpModelConfig {
    pub fn new() -> DocPathIxpModelConfig {
        DocPathIxpModelConfig {
            kind: None,
