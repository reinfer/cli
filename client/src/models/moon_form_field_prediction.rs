...
pub struct MoonFormFieldPrediction {
...
impl MoonFormFieldPrediction {
    pub fn new(field_id: String, id: String, field_type_id: String, name: String, kind: String, formatted_value: String, probability: f64, document_spans: Vec<models::DocumentSpan>) -> MoonFormFieldPrediction {
        MoonFormFieldPrediction {
            field_id,
            id,
            field_type_id,
            name,
