...
pub struct DatasetTrainingAction {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "kind")]
    pub kind: Kind,
    ...
    #[serde(rename = "plan")]
    pub plan: models::ModelRatingAction,
}

impl DatasetTrainingAction {
    pub fn new(id: String, kind: Kind, factor_kind: models::ModelRatingFactorKind, quality: models::DatasetQuality, plan: models::ModelRatingAction) -> DatasetTrainingAction {
        DatasetTrainingAction {
            id,
            kind,
            factor_kind,
            quality,
