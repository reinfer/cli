...
pub struct MoonFormLabelPrediction {
    #[serde(rename = "label")]
    pub label: Box<models::PredictedLabel>,
    #[serde(rename = "captures")]
    pub captures: Vec<models::MoonFormCaptureFieldsPrediction>,
}

impl MoonFormLabelPrediction {
    pub fn new(label: models::PredictedLabel, captures: Vec<models::MoonFormCaptureFieldsPrediction>) -> MoonFormLabelPrediction {
        MoonFormLabelPrediction {
            label: Box::new(label),
            captures,
        }
    }
