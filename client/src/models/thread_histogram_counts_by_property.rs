...
pub struct ThreadHistogramCountsByProperty {
    #[serde(rename = "duration", skip_serializing_if = "Option::is_none")]
    pub duration: Option<Box<models::ThreadHistogramCounts>>,
    #[serde(rename = "num_messages", skip_serializing_if = "Option::is_none")]
    pub num_messages: Option<Box<models::ThreadHistogramCounts>>,
    #[serde(rename = "num_participants", skip_serializing_if = "Option::is_none")]
    pub num_participants: Option<Box<models::ThreadHistogramCounts>>,
    #[serde(rename = "response_time", skip_serializing_if = "Option::is_none")]
    pub response_time: Option<Box<models::ThreadHistogramCounts>>,
}

impl ThreadHistogramCountsByProperty {
    pub fn new() -> ThreadHistogramCountsByProperty {
        ThreadHistogramCountsByProperty {
            duration: None,
            num_messages: None,
