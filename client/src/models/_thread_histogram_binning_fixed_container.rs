...
pub struct ThreadHistogramBinningFixedContainer {
    #[serde(rename = "fixed")]
    pub fixed: Box<models::ThreadHistogramBinningFixed>,
}

impl ThreadHistogramBinningFixedContainer {
    pub fn new(fixed: models::ThreadHistogramBinningFixed) -> ThreadHistogramBinningFixedContainer {
