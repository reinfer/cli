...
pub struct LabelPropertySummary {
    #[serde(rename = "labels")]
    pub labels: Vec<models::LabelPropertySummaryLabel>,
    #[serde(rename = "timeseries")]
    pub timeseries: Vec<models::LabelPropertyTimeSeriesRow>,
    #[serde(rename = "totals")]
    pub totals: Vec<f64>,
}

impl LabelPropertySummary {
    pub fn new(labels: Vec<models::LabelPropertySummaryLabel>, timeseries: Vec<models::LabelPropertyTimeSeriesRow>, totals: Vec<f64>) -> LabelPropertySummary {
        LabelPropertySummary {
            labels,
            timeseries,
            totals,
        }
