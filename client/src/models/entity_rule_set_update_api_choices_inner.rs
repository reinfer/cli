...
pub struct EntityRuleSetUpdateApiChoicesInner {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "name")]
    pub name: String,
...
impl EntityRuleSetUpdateApiChoicesInner {
    pub fn new(id: String, name: String, values: Vec<String>) -> EntityRuleSetUpdateApiChoicesInner {
