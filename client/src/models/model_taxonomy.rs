...
pub struct ModelTaxonomy {
    ...
    #[serde(rename = "labels")]
    pub labels: Vec<models::LabelDefinition>,
    #[serde(rename = "general_fields")]
    pub general_fields: Vec<models::GeneralFieldDefinition>,
    #[serde(rename = "field_types")]
    pub field_types: Vec<models::FieldType>,
}

impl ModelTaxonomy {
    pub fn new(name: String, instructions: String, labels: Vec<models::LabelDefinition>, general_fields: Vec<models::GeneralFieldDefinition>, field_types: Vec<models::FieldType>) -> ModelTaxonomy {
        ModelTaxonomy {
            name,
            instructions,
            labels,
