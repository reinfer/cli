...
pub struct ExportedComment {
    ...
    pub annotations: Box<models::ExportedAnnotations>,
    #[serde(rename = "predictions")]
    pub predictions: Box<models::ExportedPredictions>,
...
impl ExportedComment {
    pub fn new(comment: models::Comment, annotations: models::ExportedAnnotations, predictions: models::ExportedPredictions) -> ExportedComment {
        ExportedComment {
