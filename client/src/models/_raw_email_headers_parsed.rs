...
pub struct RawEmailHeadersParsed {
    #[serde(rename = "parsed")]
    pub parsed: std::collections::HashMap<String, models::ParsedValue>,
}

impl RawEmailHeadersParsed {
    pub fn new(parsed: std::collections::HashMap<String, models::ParsedValue>) -> RawEmailHeadersParsed {
        RawEmailHeadersParsed {
            parsed,
        }
    }
}
