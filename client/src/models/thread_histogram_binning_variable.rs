...
pub struct ThreadHistogramBinningVariable {
    #[serde(rename = "max_bins")]
    pub max_bins: i32,
}

impl ThreadHistogramBinningVariable {
    pub fn new(max_bins: i32) -> ThreadHistogramBinningVariable {
