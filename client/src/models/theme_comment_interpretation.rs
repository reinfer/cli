...
pub struct ThemeCommentInterpretation {
    #[serde(rename = "content_part")]
    pub content_part: ContentPart,
    /// A legacy field, which dictates message in a multiple message verbatim the spans are upon
    #[serde(rename = "message_index")]
    pub message_index: i32,
    #[serde(rename = "spans")]
    pub spans: Vec<models::InterpretationSpan>,
}

impl ThemeCommentInterpretation {
    pub fn new(content_part: ContentPart, message_index: i32, spans: Vec<models::InterpretationSpan>) -> ThemeCommentInterpretation {
        ThemeCommentInterpretation {
            content_part,
            message_index,
            spans,
        }
