...
pub struct UiPathProvisionCreateRequest {
    ...
    pub properties: Box<models::UiPathProvisionCreateProperties>,
}

impl UiPathProvisionCreateRequest {
    pub fn new(callback_url: Option<String>, tenant_id: String, organization_id: String, service_type: String, properties: models::UiPathProvisionCreateProperties) -> UiPathProvisionCreateRequest {
        UiPathProvisionCreateRequest {
            callback_url,
            tenant_id,
            organization_id,
            service_type,
