...
pub struct ByLabelsIncludeContainer {
    #[serde(rename = "include")]
    pub include: Box<models::ByLabelsInclude>,
}

impl ByLabelsIncludeContainer {
    pub fn new(include: models::ByLabelsInclude) -> ByLabelsIncludeContainer {
        ByLabelsIncludeContainer {
