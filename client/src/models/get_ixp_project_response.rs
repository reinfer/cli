...
pub struct GetIxpProjectResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "project")]
    pub project: Box<models::IxpProject>,
}

impl GetIxpProjectResponse {
    pub fn new(status: Status, project: models::IxpProject) -> GetIxpProjectResponse {
