...
pub struct ByLabelsTop {
    #[serde(rename = "num_top_labels")]
    pub num_top_labels: i32,
    #[serde(rename = "exclude_labels")]
    pub exclude_labels: Vec<String>,
}

impl ByLabelsTop {
    pub fn new(num_top_labels: i32, exclude_labels: Vec<String>) -> ByLabelsTop {
        ByLabelsTop {
            num_top_labels,
            exclude_labels,
        }
