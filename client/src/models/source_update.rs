...
pub struct SourceUpdate {
    #[serde(rename = "_kind", skip_serializing_if = "Option::is_none")]
    pub _kind: Option<models::SourceKind>,
    ...
    #[serde(rename = "should_translate", skip_serializing_if = "Option::is_none")]
    pub should_translate: Option<bool>,
    #[serde(rename = "sensitive_properties", skip_serializing_if = "Option::is_none")]
    pub sensitive_properties: Option<Vec<String>>,
    #[serde(rename = "bucket_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub bucket_id: Option<Option<String>>,
    /// A tag for email parsing logic. Changing this will cause a source to re-parse with other logic.
    #[serde(rename = "email_transform_tag", skip_serializing_if = "Option::is_none")]
    pub email_transform_tag: Option<String>,
    /// A version for parsing of this source with corresponding tag. Incrementing this will cause the source to re-parse.
    #[serde(rename = "email_transform_version", skip_serializing_if = "Option::is_none")]
    pub email_transform_version: Option<i32>,
}

impl SourceUpdate {
    pub fn new() -> SourceUpdate {
        SourceUpdate {
            _kind: None,
            language: None,
            title: None,
