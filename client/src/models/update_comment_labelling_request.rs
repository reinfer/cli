...
pub struct UpdateCommentLabellingRequest {
    #[serde(rename = "context", skip_serializing_if = "Option::is_none")]
    pub context: Option<String>,
    #[serde(rename = "labelling", skip_serializing_if = "Option::is_none")]
...
impl UpdateCommentLabellingRequest {
    pub fn new() -> UpdateCommentLabellingRequest {
