...
pub struct ThreadHistogramSettingsByProperty {
    #[serde(rename = "duration", skip_serializing_if = "Option::is_none")]
    pub duration: Option<Box<models::ThreadHistogramSettings>>,
    #[serde(rename = "num_messages", skip_serializing_if = "Option::is_none")]
    pub num_messages: Option<Box<models::ThreadHistogramSettings>>,
    #[serde(rename = "num_participants", skip_serializing_if = "Option::is_none")]
    pub num_participants: Option<Box<models::ThreadHistogramSettings>>,
    #[serde(rename = "response_time", skip_serializing_if = "Option::is_none")]
    pub response_time: Option<Box<models::ThreadHistogramSettings>>,
}

impl ThreadHistogramSettingsByProperty {
    pub fn new() -> ThreadHistogramSettingsByProperty {
        ThreadHistogramSettingsByProperty {
            duration: None,
            num_messages: None,
