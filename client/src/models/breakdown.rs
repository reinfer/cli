...
pub struct Breakdown {
    #[serde(rename = "label_contributions")]
    pub label_contributions: Vec<models::Contribution>,
    #[serde(rename = "other_group_contributions")]
    pub other_group_contributions: Vec<models::Contribution>,
}

impl Breakdown {
    pub fn new(label_contributions: Vec<models::Contribution>, other_group_contributions: Vec<models::Contribution>) -> Breakdown {
        Breakdown {
            label_contributions,
            other_group_contributions,
        }
    }
}
