...
pub struct IntentValidation {
    ...
    pub recalls: Vec<f64>,
    #[serde(rename = "test_error_count")]
    pub test_error_count: f64,
    #[serde(rename = "test_expected_count")]
    pub test_expected_count: f64,
    #[serde(rename = "precisions")]
...
impl IntentValidation {
    pub fn new(average_precision: Option<f64>, train_size: i32, test_size: i32, reviewed_size: i32, recalls: Vec<f64>, test_error_count: f64, test_expected_count: f64, precisions: Vec<f64>, thresholds: Vec<f64>, optimal_thresholds: Option<models::OptimalThreshold>, health: models::LabelHealth, num_test_captures: i32, num_train_captures: i32, num_reviewed_captures: i32) -> IntentValidation {
        IntentValidation {
            average_precision,
            train_size,
            test_size,
