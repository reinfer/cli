...
/// CreateOrUpdateLabelDefsBulkRequest : Request to create label defs in bulk in a dataset
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateOrUpdateLabelDefsBulkRequest {
    #[serde(rename = "label_defs")]
    pub label_defs: Vec<models::CreateOrUpdateLabelDefsBulkRequestLabelDefsInner>,
}

impl CreateOrUpdateLabelDefsBulkRequest {
    /// Request to create label defs in bulk in a dataset
    pub fn new(label_defs: Vec<models::CreateOrUpdateLabelDefsBulkRequestLabelDefsInner>) -> CreateOrUpdateLabelDefsBulkRequest {
        CreateOrUpdateLabelDefsBulkRequest {
            label_defs,
        }
    }
}
