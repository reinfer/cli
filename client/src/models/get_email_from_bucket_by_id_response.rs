...
pub struct GetEmailFromBucketByIdResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "emails")]
...
impl GetEmailFromBucketByIdResponse {
    pub fn new(status: Status, emails: Vec<models::Email>) -> GetEmailFromBucketByIdResponse {
