...
pub struct GetProjectResourceCountsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    ...
    pub sources: i32,
    #[serde(rename = "users_with_permissions")]
    pub users_with_permissions: i32,
}

impl GetProjectResourceCountsResponse {
    pub fn new(status: Status, buckets: i32, dashboards: i32, datasets: i32, integrations: i32, sources: i32, users_with_permissions: i32) -> GetProjectResourceCountsResponse {
        GetProjectResourceCountsResponse {
            status,
            buckets,
            dashboards,
            datasets,
