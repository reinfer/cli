...
pub struct GetAllDatasetsInProjectResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetAllDatasetsInProjectResponse {
    pub fn new(status: Status, datasets: Vec<models::Dataset>) -> GetAllDatasetsInProjectResponse {
