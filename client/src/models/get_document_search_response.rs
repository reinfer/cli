...
pub struct GetDocumentSearchResponse {
    ...
    pub search_results: Vec<models::DocumentSearchResult>,
}

impl GetDocumentSearchResponse {
    pub fn new(status: Status, search_results: Vec<models::DocumentSearchResult>) -> GetDocumentSearchResponse {
