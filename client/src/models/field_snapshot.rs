...
/// FieldSnapshot : Snapshot of a field at a specific model version
...
impl FieldSnapshot {
    /// Snapshot of a field at a specific model version
    pub fn new(field_id: String, field_type_id: String, name: String) -> FieldSnapshot {
        FieldSnapshot {
            field_id,
            field_type_id,
            name,
