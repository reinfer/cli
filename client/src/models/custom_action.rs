...
/// CustomAction : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum CustomAction {
    #[serde(rename = "missing-source")]
    MissingSource,
    #[serde(rename = "insufficient-verbatims-in-sources")]
    InsufficientVerbatimsInSources,
    #[serde(rename = "insufficient-verbatims")]
    InsufficientVerbatims,
    #[serde(rename = "insufficient-labels")]
    InsufficientLabels,
    #[serde(rename = "missing-model-rating")]
    MissingModelRating,
...
impl std::fmt::Display for CustomAction {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::MissingSource => write!(f, "missing-source"),
            Self::InsufficientVerbatimsInSources => write!(f, "insufficient-verbatims-in-sources"),
            Self::InsufficientVerbatims => write!(f, "insufficient-verbatims"),
            Self::InsufficientLabels => write!(f, "insufficient-labels"),
            Self::MissingModelRating => write!(f, "missing-model-rating"),
            Self::Shuffle => write!(f, "shuffle"),
            Self::TextSearch => write!(f, "text-search"),
        }
    }
}

impl Default for CustomAction {
    fn default() -> CustomAction {
        Self::MissingSource
    }
}
