...
pub struct SetTenantQuotaRequest {
    /// New limit to try and increase the quota to. If this falls beyond the value a user can automatically increase a quota to, the quota will be set to the highest accepted value and fail.
    #[serde(rename = "requested_limit")]
    pub requested_limit: i32,
}

impl SetTenantQuotaRequest {
    pub fn new(requested_limit: i32) -> SetTenantQuotaRequest {
