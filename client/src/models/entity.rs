...
pub struct Entity {
    ...
    #[serde(rename = "kind")]
    pub kind: String,
    /// Deprecated. Wil be populated by first span if there's exactly one span, for backwards compatibility.
...
impl Entity {
    pub fn new(id: String, name: String, kind: String, spans: Vec<models::TextSpan>, formatted_value: String, field_id: String) -> Entity {
        Entity {
            id,
            name,
            kind,
