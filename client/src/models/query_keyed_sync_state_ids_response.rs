...
pub struct QueryKeyedSyncStateIdsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    /// hex encoded ids of the keyed sync states
    #[serde(rename = "keyed_sync_state_ids")]
    pub keyed_sync_state_ids: Vec<String>,
}

impl QueryKeyedSyncStateIdsResponse {
    pub fn new(status: Status, keyed_sync_state_ids: Vec<String>) -> QueryKeyedSyncStateIdsResponse {
