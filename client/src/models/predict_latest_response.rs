...
pub struct PredictLatestResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl PredictLatestResponse {
    pub fn new(status: Status, predictions: Vec<Vec<models::PredictedLabel>>, model: Option<models::PredictionsModel>) -> PredictLatestResponse {
