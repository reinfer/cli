...
/// RetrievalMethod : An enumeration.
/// An enumeration.
...
pub enum RetrievalMethod {
    ...
    #[serde(rename = "by_label_self")]
    ByLabelSelf,
    #[serde(rename = "by_label_other")]
    ByLabelOther,
    #[serde(rename = "by_sentiment")]
    BySentiment,
...
impl std::fmt::Display for RetrievalMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::TeachLabel => write!(f, "teach_label"),
            Self::Teach => write!(f, "teach"),
            Self::TextSearch => write!(f, "text_search"),
            Self::AttachmentTextSearch => write!(f, "attachment_text_search"),
            Self::ByLabelSelf => write!(f, "by_label_self"),
            Self::ByLabelOther => write!(f, "by_label_other"),
            Self::BySentiment => write!(f, "by_sentiment"),
            ...
            Self::LabelProperty => write!(f, "label_property"),
            Self::TeachEntity => write!(f, "teach_entity"),
            Self::CheckEntity => write!(f, "check_entity"),
            Self::MissedEntity => write!(f, "missed_entity"),
        }
    }
}

impl Default for RetrievalMethod {
    fn default() -> RetrievalMethod {
        Self::Recent
    }
}
