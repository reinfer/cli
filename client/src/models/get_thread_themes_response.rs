...
pub struct GetThreadThemesResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "thread_themes")]
    pub thread_themes: Vec<models::ThreadTheme>,
}

impl GetThreadThemesResponse {
    pub fn new(status: Status, thread_themes: Vec<models::ThreadTheme>) -> GetThreadThemesResponse {
        GetThreadThemesResponse {
            status,
            thread_themes,
        }
    }
