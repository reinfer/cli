...
pub struct MarkupTableRow {
    #[serde(rename = "section")]
    pub section: models::MarkupTableSectionKind,
    #[serde(rename = "cells")]
    pub cells: Vec<models::MarkupTableCell>,
}

impl MarkupTableRow {
    pub fn new(section: models::MarkupTableSectionKind, cells: Vec<models::MarkupTableCell>) -> MarkupTableRow {
        MarkupTableRow {
            section,
            cells,
        }
