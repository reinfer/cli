...
/// UnaryLabelHealthActionKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum UnaryLabelHealthActionKind {
    #[serde(rename = "confirm_top_predicted")]
    ConfirmTopPredicted,
    #[serde(rename = "correct_label")]
    CorrectLabel,
    #[serde(rename = "missing_label")]
    MissingLabel,
    #[serde(rename = "teach_unreviewed")]
    TeachUnreviewed,
    #[serde(rename = "search_for_examples")]
    SearchForExamples,

}

impl std::fmt::Display for UnaryLabelHealthActionKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::ConfirmTopPredicted => write!(f, "confirm_top_predicted"),
            Self::CorrectLabel => write!(f, "correct_label"),
            Self::MissingLabel => write!(f, "missing_label"),
            Self::TeachUnreviewed => write!(f, "teach_unreviewed"),
            Self::SearchForExamples => write!(f, "search_for_examples"),
        }
    }
}

impl Default for UnaryLabelHealthActionKind {
    fn default() -> UnaryLabelHealthActionKind {
        Self::ConfirmTopPredicted
    }
}
