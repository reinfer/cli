...
/// KeyedFolderSyncState : Sync state for a specific folder within a mailbox.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct KeyedFolderSyncState {
...
impl KeyedFolderSyncState {
    /// Sync state for a specific folder within a mailbox.
    pub fn new(mailbox_name: String, folder_id: String, folder_path: Vec<String>, status: models::SyncStatus, last_synced_at: String) -> KeyedFolderSyncState {
