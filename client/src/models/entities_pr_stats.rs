...
pub struct EntitiesPrStats {
    #[serde(rename = "num_train_entities")]
    pub num_train_entities: i32,
    #[serde(rename = "num_test_entities")]
    pub num_test_entities: i32,
    #[serde(rename = "num_reviewed_entities")]
    pub num_reviewed_entities: i32,
    ...
    pub error_count: i32,
    #[serde(rename = "entities_by_def_id")]
    pub entities_by_def_id: std::collections::HashMap<String, models::EntityDefIdStat>,
    #[serde(rename = "precision", skip_serializing_if = "Option::is_none")]
    pub precision: Option<f64>,
    #[serde(rename = "recall", skip_serializing_if = "Option::is_none")]
    pub recall: Option<f64>,
    #[serde(rename = "f1_score", skip_serializing_if = "Option::is_none")]
    pub f1_score: Option<f64>,
}

impl EntitiesPrStats {
    pub fn new(num_train_entities: i32, num_test_entities: i32, num_reviewed_entities: i32, num_train_documents: i32, num_test_documents: i32, num_reviewed_documents: i32, error_count: i32, entities_by_def_id: std::collections::HashMap<String, models::EntityDefIdStat>) -> EntitiesPrStats {
        EntitiesPrStats {
            num_train_entities,
            num_test_entities,
            num_reviewed_entities,
            num_train_documents,
            num_test_documents,
