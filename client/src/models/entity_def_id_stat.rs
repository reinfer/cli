...
pub struct EntityDefIdStat {
    ...
    pub error_count: i32,
    #[serde(rename = "is_safe")]
    pub is_safe: bool,
    #[serde(rename = "health")]
    pub health: Box<models::EntityHealth>,
...
impl EntityDefIdStat {
    pub fn new(num_train_entities: i32, num_test_entities: i32, num_reviewed_entities: i32, num_train_documents: i32, num_test_documents: i32, num_reviewed_documents: i32, error_count: i32, is_safe: bool, health: models::EntityHealth) -> EntityDefIdStat {
        EntityDefIdStat {
            num_train_entities,
            num_test_entities,
