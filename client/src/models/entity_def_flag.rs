...
/// EntityDefFlag : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum EntityDefFlag {
    #[serde(rename = "appears_verbatim")]
    AppearsVerbatim,
    #[serde(rename = "allow_out_of_domain")]
    AllowOutOfDomain,

}

impl std::fmt::Display for EntityDefFlag {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::AppearsVerbatim => write!(f, "appears_verbatim"),
            Self::AllowOutOfDomain => write!(f, "allow_out_of_domain"),
        }
    }
}

impl Default for EntityDefFlag {
    fn default() -> EntityDefFlag {
        Self::AppearsVerbatim
    }
}
