...
/// CommentSpanNewChar : Definition of a comment span to be created
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CommentSpanNewChar {
...
impl CommentSpanNewChar {
    /// Definition of a comment span to be created
    pub fn new(content_part: models::ContentPart, message_index: i32, char_start: i32, char_end: i32) -> CommentSpanNewChar {
        CommentSpanNewChar {
            content_part,
            message_index,
            char_start,
