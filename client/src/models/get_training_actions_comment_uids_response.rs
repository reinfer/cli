...
pub struct GetTrainingActionsCommentUidsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "comment_uids")]
    pub comment_uids: Vec<String>,
}

impl GetTrainingActionsCommentUidsResponse {
    pub fn new(status: Status, comment_uids: Vec<String>) -> GetTrainingActionsCommentUidsResponse {
