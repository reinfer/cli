...
pub struct GetAllIxpProjectsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "projects")]
    pub projects: Vec<models::IxpProject>,
}

impl GetAllIxpProjectsResponse {
    pub fn new(status: Status, projects: Vec<models::IxpProject>) -> GetAllIxpProjectsResponse {
