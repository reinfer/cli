...
impl std::fmt::Display for GptIxpFlag {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::TaxonomyDescriptions => write!(f, "append_taxonomy_descriptions"),
            Self::TypeDescriptions => write!(f, "append_type_descriptions"),
            Self::GroupDescriptions => write!(f, "append_group_descriptions"),
            Self::FieldDescriptions => write!(f, "append_field_descriptions"),
        }
    }
}

impl Default for GptIxpFlag {
    fn default() -> GptIxpFlag {
        Self::TaxonomyDescriptions
    }
}
