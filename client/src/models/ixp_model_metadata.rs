...
pub struct IxpModelMetadata {
    ...
    pub validated: bool,
    /// Relative URL links to related pages
    #[serde(rename = "relative_urls")]
    pub relative_urls: Box<models::IxpRelativeUrls>,
    /// Model Taxonomy
    #[serde(rename = "taxonomy")]
    pub taxonomy: Box<models::IxpTaxonomy>,
}

impl IxpModelMetadata {
    pub fn new(version: i32, model_name: String, trained_time: String, description: String, validated: bool, relative_urls: models::IxpRelativeUrls, taxonomy: models::IxpTaxonomy) -> IxpModelMetadata {
        IxpModelMetadata {
            version,
            model_name,
            trained_time,
            description,
            validated,
            relative_urls: Box::new(relative_urls),
