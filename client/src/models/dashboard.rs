...
pub struct Dashboard {
    #[serde(rename = "id")]
    pub id: String,
    /// The name of the project the dashboard is in
    #[serde(rename = "owner")]
    pub owner: String,
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "title")]
    pub title: String,
    /// JSON blob containing dashboard charts and their filters
    #[serde(rename = "blob")]
    pub blob: String,
    #[serde(rename = "dataset_ids")]
    pub dataset_ids: Vec<String>,
    #[serde(rename = "default_for_datasets")]
    pub default_for_datasets: Vec<String>,
...
impl Dashboard {
    pub fn new(id: String, owner: String, name: String, title: String, blob: String, dataset_ids: Vec<String>, default_for_datasets: Vec<String>, created_at: String, updated_at: String) -> Dashboard {
        Dashboard {
            id,
            owner,
            name,
