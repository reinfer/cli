...
pub struct GetReducedPermissionsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "global_permissions")]
    pub global_permissions: Vec<models::GlobalPermission>,
    #[serde(rename = "organisation_permissions")]
    pub organisation_permissions: Vec<models::ProjectPermission>,
    #[serde(rename = "permissions")]
    pub permissions: Vec<models::GetReducedPermissionsResponsePermissionsInner>,
}

impl GetReducedPermissionsResponse {
    pub fn new(status: Status, global_permissions: Vec<models::GlobalPermission>, organisation_permissions: Vec<models::ProjectPermission>, permissions: Vec<models::GetReducedPermissionsResponsePermissionsInner>) -> GetReducedPermissionsResponse {
        GetReducedPermissionsResponse {
            status,
            global_permissions,
