...
/// NoUiMetadataReason : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum NoUiMetadataReason {
...
impl std::fmt::Display for NoUiMetadataReason {
...
impl Default for NoUiMetadataReason {
    fn default() -> NoUiMetadataReason {
        Self::InvalidState
    }
}
