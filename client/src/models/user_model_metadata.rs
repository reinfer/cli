...
pub struct UserModelMetadata {
    ...
    #[serde(rename = "training_duration")]
    ...
    #[serde(rename = "pinned")]
    pub pinned: bool,
    /// The number of times each label has been reviewed
    #[serde(rename = "reviewed_counts")]
    pub reviewed_counts: std::collections::HashMap<String, i32>,
    /// Whether the model is used by triggers
    #[serde(rename = "used_by_triggers")]
    pub used_by_triggers: bool,
    /// Settings for the model
    #[serde(rename = "settings")]
    pub settings: Box<models::UserModelMetadataSettings>,
    /// Whether the model is fresh, deprecated or unsupported
    #[serde(rename = "freshness")]
    pub freshness: models::Freshness,
    #[serde(rename = "flags")]
    pub flags: Vec<models::UserModelMetadataFlag>,
}
