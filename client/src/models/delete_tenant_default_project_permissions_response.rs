...
pub struct DeleteTenantDefaultProjectPermissionsResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl DeleteTenantDefaultProjectPermissionsResponse {
    pub fn new(status: Status, default_project_permissions: Vec<models::ProjectPermission>) -> DeleteTenantDefaultProjectPermissionsResponse {
