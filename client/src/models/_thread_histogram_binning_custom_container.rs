...
pub struct ThreadHistogramBinningCustomContainer {
    #[serde(rename = "custom")]
    pub custom: Box<models::ThreadHistogramBinningCustom>,
}

impl ThreadHistogramBinningCustomContainer {
    pub fn new(custom: models::ThreadHistogramBinningCustom) -> ThreadHistogramBinningCustomContainer {
        ThreadHistogramBinningCustomContainer {
