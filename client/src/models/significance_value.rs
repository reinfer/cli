...
pub struct SignificanceValue {
    #[serde(rename = "log_odds_ratio")]
    pub log_odds_ratio: f64,
    #[serde(rename = "is_significant")]
    pub is_significant: bool,
}

impl SignificanceValue {
    pub fn new(log_odds_ratio: f64, is_significant: bool) -> SignificanceValue {
        SignificanceValue {
            log_odds_ratio,
            is_significant,
        }
