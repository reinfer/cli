...
pub struct CustomTrainingAction {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "plan")]
    pub plan: models::CustomAction,
}

impl CustomTrainingAction {
    pub fn new(id: String, kind: Kind, plan: models::CustomAction) -> CustomTrainingAction {
