...
/// BinaryLabelHealthWarningKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum BinaryLabelHealthWarningKind {
    #[serde(rename = "confused")]
    Confused,

}

impl std::fmt::Display for BinaryLabelHealthWarningKind {
...
impl Default for BinaryLabelHealthWarningKind {
    fn default() -> BinaryLabelHealthWarningKind {
        Self::Confused
    }
}
