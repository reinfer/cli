...
pub struct FetchFromStreamResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl FetchFromStreamResponse {
    pub fn new(status: Status, filtered: i32, sequence_id: String, results: Vec<models::StreamCommentResult>, is_end_sequence: bool) -> FetchFromStreamResponse {
        FetchFromStreamResponse {
            status,
            filtered,
            sequence_id,
            results,
