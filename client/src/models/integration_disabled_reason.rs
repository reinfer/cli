...
/// IntegrationDisabledReason : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum IntegrationDisabledReason {
    #[serde(rename = "user")]
    User,
    #[serde(rename = "quota")]
    Quota,
...
impl std::fmt::Display for IntegrationDisabledReason {
...
impl Default for IntegrationDisabledReason {
    fn default() -> IntegrationDisabledReason {
        Self::User
    }
}
