...
pub struct TextImageInputConfig {
    ...
    pub text_config: Box<models::TextConfig>,
}

impl TextImageInputConfig {
    pub fn new(text_config: models::TextConfig) -> TextImageInputConfig {
        TextImageInputConfig {
            mode: None,
            text_config: Box::new(text_config),
        }
    }
}
/// 
