...
pub struct GetAlertSubscriptionsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "alert_subscriptions")]
    pub alert_subscriptions: Vec<models::AlertSubscription>,
}

impl GetAlertSubscriptionsResponse {
    pub fn new(status: Status, alert_subscriptions: Vec<models::AlertSubscription>) -> GetAlertSubscriptionsResponse {
