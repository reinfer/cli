...
pub struct LabelSuggestionReasoning {
    #[serde(rename = "label_suggestions")]
    pub label_suggestions: String,
    /// Populated if LLM features are enabled. The taxonomy refactor reasoning.
    #[serde(rename = "taxonomy_refactor", skip_serializing_if = "Option::is_none")]
    pub taxonomy_refactor: Option<String>,
}

impl LabelSuggestionReasoning {
    pub fn new(label_suggestions: String) -> LabelSuggestionReasoning {
        LabelSuggestionReasoning {
            label_suggestions,
            taxonomy_refactor: None,
        }
    }
}
