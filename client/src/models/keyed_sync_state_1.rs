...
impl KeyedSyncState1 {
    pub fn new(mailbox_name: String, folder_id: String, folder_path: Vec<String>, status: models::SyncStatus) -> KeyedSyncState1 {
        KeyedSyncState1 {
            mailbox_name,
            folder_id,
            folder_path,
