...
pub struct DeprecatedUserModelMetadata {
    /// The dataset ID
...
impl DeprecatedUserModelMetadata {
    pub fn new(dataset_id: String, version: i32, model_id: String, fingerprint: String, trained_time: String, input_updated_at: String, pinned: bool) -> DeprecatedUserModelMetadata {
        DeprecatedUserModelMetadata {
            dataset_id,
            version,
            model_id,
            fingerprint,
