...
pub struct GetIntegrationErrorsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "errors")]
    pub errors: Vec<models::IntegrationError>,
}

impl GetIntegrationErrorsResponse {
    pub fn new(status: Status, errors: Vec<models::IntegrationError>) -> GetIntegrationErrorsResponse {
