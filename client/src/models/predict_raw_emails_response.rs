...
pub struct PredictRawEmailsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "predictions")]
    pub predictions: Vec<Vec<models::PredictedLabel>>,
    #[serde(rename = "model", deserialize_with = "Option::deserialize")]
    pub model: Option<Box<models::PredictionsModel>>,
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<Vec<models::PredictedEntity>>>,
    #[serde(rename = "sentiment", skip_serializing_if = "Option::is_none")]
    pub sentiment: Option<Vec<models::CommentSentiment>>,
    #[serde(rename = "comments", skip_serializing_if = "Option::is_none")]
    pub comments: Option<Vec<models::ParseEmailNewComment>>,
    #[serde(rename = "label_properties", skip_serializing_if = "Option::is_none")]
    pub label_properties: Option<Vec<Vec<models::DocumentLabelPropertyPrediction>>>,
}

impl PredictRawEmailsResponse {
    pub fn new(status: Status, predictions: Vec<Vec<models::PredictedLabel>>, model: Option<models::PredictionsModel>) -> PredictRawEmailsResponse {
