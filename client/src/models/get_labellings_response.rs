...
pub struct GetLabellingsResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetLabellingsResponse {
    pub fn new(status: Status, entity_defs: Vec<models::EntityDef>, results: Vec<models::AnnotatedComment>) -> GetLabellingsResponse {
        GetLabellingsResponse {
            status,
            entity_defs,
            triggers: None,
            results,
