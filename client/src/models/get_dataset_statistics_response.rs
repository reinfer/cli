...
pub struct GetDatasetStatisticsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "statistics")]
    pub statistics: Box<models::Statistics>,
}

impl GetDatasetStatisticsResponse {
    pub fn new(status: Status, statistics: models::Statistics) -> GetDatasetStatisticsResponse {
