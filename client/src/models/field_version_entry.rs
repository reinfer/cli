...
/// FieldVersionEntry : A single version entry in field history
...
pub struct FieldVersionEntry {
    ...
    /// Snapshot of the field definition at this version
    #[serde(rename = "snapshot")]
    pub snapshot: Box<models::FieldSnapshot>,
}

impl FieldVersionEntry {
    /// A single version entry in field history
    pub fn new(model_version: i32, timestamp: String, snapshot: models::FieldSnapshot) -> FieldVersionEntry {
        FieldVersionEntry {
            model_version,
            timestamp,
