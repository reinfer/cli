...
pub struct GetAllDashboardsInProjectResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "dashboards")]
    pub dashboards: Vec<models::Dashboard>,
}

impl GetAllDashboardsInProjectResponse {
    pub fn new(status: Status, dashboards: Vec<models::Dashboard>) -> GetAllDashboardsInProjectResponse {
