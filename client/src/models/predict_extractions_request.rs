...
pub struct PredictExtractionsRequest {
    #[serde(rename = "documents")]
    pub documents: Vec<models::PredictDocument>,
}

impl PredictExtractionsRequest {
    pub fn new(documents: Vec<models::PredictDocument>) -> PredictExtractionsRequest {
        PredictExtractionsRequest {
            documents,
        }
    }
}
