...
pub struct PredictedLabelProperty {
...
impl PredictedLabelProperty {
    pub fn new(property_id: String, property_name: String, value: f64) -> PredictedLabelProperty {
        PredictedLabelProperty {
            property_id,
            property_name,
            value,
        }
