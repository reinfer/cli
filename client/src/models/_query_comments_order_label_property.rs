...
pub struct QueryCommentsOrderLabelProperty {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "label_property_id")]
    pub label_property_id: models::LabelPropertyId,
    #[serde(rename = "direction", skip_serializing_if = "Option::is_none")]
    pub direction: Option<Direction>,
}

impl QueryCommentsOrderLabelProperty {
    pub fn new(kind: Kind, label_property_id: models::LabelPropertyId) -> QueryCommentsOrderLabelProperty {
