...
pub struct NtlmApplicationModel {
    #[serde(rename = "kind", skip_serializing_if = "Option::is_none")]
    pub kind: Option<models::NtlmApplicationModelKind>,
}

impl NtlmApplicationModel {
    pub fn new() -> NtlmApplicationModel {
        NtlmApplicationModel {
            kind: None,
        }
    }
}
