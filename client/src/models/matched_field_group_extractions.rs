...
pub struct MatchedFieldGroupExtractions {
    #[serde(rename = "annotation", deserialize_with = "Option::deserialize")]
    pub annotation: Option<Box<models::FieldGroupAnnotationPrivate>>,
    #[serde(rename = "prediction", deserialize_with = "Option::deserialize")]
    pub prediction: Option<Box<models::FieldGroupPredictionPrivate>>,
}

impl MatchedFieldGroupExtractions {
    pub fn new(annotation: Option<models::FieldGroupAnnotationPrivate>, prediction: Option<models::FieldGroupPredictionPrivate>) -> MatchedFieldGroupExtractions {
        MatchedFieldGroupExtractions {
            annotation: if let Some(x) = annotation {Some(Box::new(x))} else {None},
