...
pub struct PredictExtractionsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "predictions")]
    pub predictions: Vec<models::CommentExtractionsPredictions>,
}

impl PredictExtractionsResponse {
    pub fn new(status: Status, predictions: Vec<models::CommentExtractionsPredictions>) -> PredictExtractionsResponse {
