...
pub struct LabelProperty {
    ...
    pub id: String,
    #[serde(rename = "name")]
    pub name: models::LabelPropertyName,
    #[serde(rename = "value")]
    pub value: f64,
    #[serde(rename = "breakdown", deserialize_with = "Option::deserialize")]
    pub breakdown: Option<Box<models::Breakdown>>,
}

impl LabelProperty {
    pub fn new(id: String, name: models::LabelPropertyName, value: f64, breakdown: Option<models::Breakdown>) -> LabelProperty {
        LabelProperty {
            id,
            name,
            value,
            breakdown: if let Some(x) = breakdown {Some(Box::new(x))} else {None},
        }
    }
}
