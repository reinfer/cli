...
pub struct PredictedEntity {
    ...
    pub kind: String,
    #[serde(rename = "span")]
    pub span: Box<models::TextSpan>,
    #[serde(rename = "spans")]
    pub spans: Vec<models::TextSpan>,
    #[serde(rename = "formatted_value")]
    pub formatted_value: String,
    #[serde(rename = "probability", deserialize_with = "Option::deserialize")]
    pub probability: Option<f64>,
    #[serde(rename = "capture_ids")]
    pub capture_ids: Vec<i32>,
}

impl PredictedEntity {
    pub fn new(id: String, name: String, kind: String, span: models::TextSpan, spans: Vec<models::TextSpan>, formatted_value: String, probability: Option<f64>, capture_ids: Vec<i32>) -> PredictedEntity {
        PredictedEntity {
            id,
            name,
            kind,
