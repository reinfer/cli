...
pub struct GetThemesResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "theme_set", deserialize_with = "Option::deserialize")]
    pub theme_set: Option<Box<models::ThemeSet>>,
    #[serde(rename = "available_models", skip_serializing_if = "Option::is_none")]
    pub available_models: Option<Vec<String>>,
}

impl GetThemesResponse {
    pub fn new(status: Status, theme_set: Option<models::ThemeSet>) -> GetThemesResponse {
        GetThemesResponse {
            status,
            theme_set: if let Some(x) = theme_set {Some(Box::new(x))} else {None},
