...
pub struct GetComparisonRequest {
    #[serde(rename = "cohort_a", skip_serializing_if = "Option::is_none")]
    pub cohort_a: Option<models::CommentFilter>,
    #[serde(rename = "cohort_b", skip_serializing_if = "Option::is_none")]
    pub cohort_b: Option<models::CommentFilter>,
    #[serde(rename = "attribute_filters_a", skip_serializing_if = "Option::is_none")]
    pub attribute_filters_a: Option<Vec<models::AttributeFilter>>,
    #[serde(rename = "attribute_filters_b", skip_serializing_if = "Option::is_none")]
    pub attribute_filters_b: Option<Vec<models::AttributeFilter>>,
    #[serde(rename = "thread_mode", skip_serializing_if = "Option::is_none")]
    pub thread_mode: Option<bool>,
}

impl GetComparisonRequest {
    pub fn new() -> GetComparisonRequest {
        GetComparisonRequest {
            cohort_a: None,
            cohort_b: None,
            attribute_filters_a: None,
            attribute_filters_b: None,
            thread_mode: None,
        }
    }
}
