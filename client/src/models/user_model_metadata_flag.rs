...
/// UserModelMetadataFlag : The flags that can be set on a user model.
/// The flags that can be set on a user model.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum UserModelMetadataFlag {
    #[serde(rename = "genx")]
    Genx,
    #[serde(rename = "external_genx")]
    ExternalGenx,
    #[serde(rename = "cross_validation")]
    CrossValidation,

}

impl std::fmt::Display for UserModelMetadataFlag {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Genx => write!(f, "genx"),
            Self::ExternalGenx => write!(f, "external_genx"),
            Self::CrossValidation => write!(f, "cross_validation"),
        }
    }
}

impl Default for UserModelMetadataFlag {
    fn default() -> UserModelMetadataFlag {
        Self::Genx
    }
}
