...
pub struct SyncRawEmailsRequest {
    /// A batch of at most 4096 raw emails
    #[serde(rename = "documents")]
    pub documents: Vec<models::RawEmailDocument>,
    /// If set to true, the comments parsed from the emailswill be returned in the response body
    #[serde(rename = "include_comments", skip_serializing_if = "Option::is_none")]
    pub include_comments: Option<bool>,
    /// A tag identifying the email integration sending the data. You should have received this tag during integration configuration setup.
    #[serde(rename = "transform_tag", skip_serializing_if = "Option::is_none")]
    pub transform_tag: Option<String>,
    #[serde(rename = "override_user_properties", skip_serializing_if = "Option::is_none")]
    pub override_user_properties: Option<Vec<String>>,
}

impl SyncRawEmailsRequest {
    pub fn new(documents: Vec<models::RawEmailDocument>) -> SyncRawEmailsRequest {
        SyncRawEmailsRequest {
            documents,
            include_comments: None,
            transform_tag: None,
            override_user_properties: None,
        }
    }
}
