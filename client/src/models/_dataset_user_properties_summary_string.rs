...
pub struct DatasetUserPropertiesSummaryString {
    /// Full name of the string
    #[serde(rename = "full_name")]
    pub full_name: String,
    /// Whether there are too many values to show
    #[serde(rename = "too_many_values")]
    pub too_many_values: bool,
    /// List of values
    #[serde(rename = "values")]
    pub values: Vec<models::DatasetStringSummaryValue>,
}

impl DatasetUserPropertiesSummaryString {
    pub fn new(full_name: String, too_many_values: bool, values: Vec<models::DatasetStringSummaryValue>) -> DatasetUserPropertiesSummaryString {
        DatasetUserPropertiesSummaryString {
            full_name,
            too_many_values,
            values,
        }
