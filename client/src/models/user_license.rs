...
/// UserLicense : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum UserLicense {
    #[serde(rename = "NonV2")]
    NonV2,
    #[serde(rename = "V2NoLicense")]
    V2NoLicense,
    #[serde(rename = "V2")]
    V2,
...
impl std::fmt::Display for UserLicense {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::NonV2 => write!(f, "NonV2"),
            Self::V2NoLicense => write!(f, "V2NoLicense"),
            Self::V2 => write!(f, "V2"),
        }
    }
}
