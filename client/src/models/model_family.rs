...
/// ModelFamily : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ModelFamily {
    #[serde(rename = "english")]
    English,
    #[serde(rename = "english-dev")]
    EnglishDev,
    #[serde(rename = "german")]
    German,
    #[serde(rename = "german-dev")]
    GermanDev,
    #[serde(rename = "random")]
    Random,
    #[serde(rename = "transformer-english")]
    TransformerEnglish,
    #[serde(rename = "transformer-xlm")]
    TransformerXlm,
...
impl std::fmt::Display for ModelFamily {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::EnglishDev => write!(f, "english-dev"),
            Self::German => write!(f, "german"),
            Self::GermanDev => write!(f, "german-dev"),
            Self::Random => write!(f, "random"),
            Self::TransformerEnglish => write!(f, "transformer-english"),
            Self::TransformerXlm => write!(f, "transformer-xlm"),
        }
    }
}

impl Default for ModelFamily {
    fn default() -> ModelFamily {
        Self::English
    }
}
