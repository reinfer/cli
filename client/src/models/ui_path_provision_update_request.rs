...
pub struct UiPathProvisionUpdateRequest {
    #[serde(rename = "callbackUrl", deserialize_with = "Option::deserialize")]
    pub callback_url: Option<String>,
    #[serde(rename = "status", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub status: Option<Option<models::UiPathTenantServiceStatus>>,
    #[serde(rename = "organizationId")]
    pub organization_id: String,
    #[serde(rename = "properties")]
    pub properties: Box<models::UiPathProvisionUpdateProperties>,
}

impl UiPathProvisionUpdateRequest {
    pub fn new(callback_url: Option<String>, organization_id: String, properties: models::UiPathProvisionUpdateProperties) -> UiPathProvisionUpdateRequest {
        UiPathProvisionUpdateRequest {
            callback_url,
            status: None,
            organization_id,
