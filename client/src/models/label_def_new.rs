...
/// LabelDefNew : Definition of a label def to be created
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LabelDefNew {
    #[serde(rename = "name")]
    pub name: String,
    ...
    pub moon_form: Option<Vec<models::MoonFormFieldDefNew>>,
}

impl LabelDefNew {
    /// Definition of a label def to be created
    pub fn new(name: String) -> LabelDefNew {
        LabelDefNew {
            name,
            title: None,
            instructions: None,
