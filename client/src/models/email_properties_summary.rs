...
pub struct EmailPropertiesSummary {
    #[serde(rename = "too_many_values")]
    pub too_many_values: bool,
    #[serde(rename = "values")]
    pub values: Vec<models::EmailPropertiesSummaryValue>,
}

impl EmailPropertiesSummary {
    pub fn new(too_many_values: bool, values: Vec<models::EmailPropertiesSummaryValue>) -> EmailPropertiesSummary {
        EmailPropertiesSummary {
            too_many_values,
            values,
        }
    }
