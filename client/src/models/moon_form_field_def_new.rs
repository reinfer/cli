...
pub struct MoonFormFieldDefNew {
    /// Deprecated. Use field_type_id instead
    #[serde(rename = "id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub id: Option<Option<String>>,
    /// ID of the field type.
    #[serde(rename = "field_type_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub field_type_id: Option<Option<String>>,
    /// The kind of moon form field
    ...
    #[serde(rename = "rule_set", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub rule_set: Option<Option<Box<models::BusinessRuleSet>>>,
}

impl MoonFormFieldDefNew {
    pub fn new(name: String) -> MoonFormFieldDefNew {
        MoonFormFieldDefNew {
            id: None,
            field_type_id: None,
            kind: None,
