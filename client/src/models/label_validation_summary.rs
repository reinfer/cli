...
pub struct LabelValidationSummary {
...
impl LabelValidationSummary {
    pub fn new(train_size: i32, test_size: i32, reviewed_size: i32, average_precision: Option<f64>, optimal_thresholds: Option<models::OptimalThreshold>, health: models::LabelHealth) -> LabelValidationSummary {
