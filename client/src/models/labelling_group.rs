...
pub struct LabellingGroup {
    #[serde(rename = "group")]
    pub group: Group,
    #[serde(rename = "assigned")]
    pub assigned: Vec<models::Label>,
    #[serde(rename = "dismissed")]
    pub dismissed: Vec<models::Label>,
    #[serde(rename = "uninformative", skip_serializing_if = "Option::is_none")]
    pub uninformative: Option<Box<models::UninformativeLabel>>,
    #[serde(rename = "predicted", skip_serializing_if = "Option::is_none")]
    pub predicted: Option<Vec<models::PredictedLabel>>,
}

impl LabellingGroup {
    pub fn new(group: Group, assigned: Vec<models::Label>, dismissed: Vec<models::Label>) -> LabellingGroup {
        LabellingGroup {
            group,
            assigned,
            dismissed,
