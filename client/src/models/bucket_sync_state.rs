...
pub struct BucketSyncState {
    ...
    #[serde(rename = "progress_timestamp", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub progress_timestamp: Option<Option<String>>,
...
impl BucketSyncState {
    pub fn new(sync_state: String) -> BucketSyncState {
        BucketSyncState {
            sync_state,
