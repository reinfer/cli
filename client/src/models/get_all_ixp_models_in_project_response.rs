...
pub struct GetAllIxpModelsInProjectResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "models")]
    pub models: Vec<models::IxpModelMetadata>,
    #[serde(rename = "tags")]
    pub tags: Vec<models::TaggedIxpModelVersion>,
...
impl GetAllIxpModelsInProjectResponse {
    pub fn new(status: Status, models: Vec<models::IxpModelMetadata>, tags: Vec<models::TaggedIxpModelVersion>, max_number_pinned_models: MaxNumberPinnedModels) -> GetAllIxpModelsInProjectResponse {
        GetAllIxpModelsInProjectResponse {
            status,
            models,
            tags,
