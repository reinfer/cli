...
/// NtlmApplicationModelKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum NtlmApplicationModelKind {
    #[serde(rename = "ntlm")]
    Ntlm,

}

impl std::fmt::Display for NtlmApplicationModelKind {
...
impl Default for NtlmApplicationModelKind {
    fn default() -> NtlmApplicationModelKind {
        Self::Ntlm
    }
}
