...
pub struct NumberRangeFilterWithKind {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "minimum", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub maximum: Option<Option<f64>>,
}

impl NumberRangeFilterWithKind {
    pub fn new(kind: Kind) -> NumberRangeFilterWithKind {
