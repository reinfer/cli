...
pub struct GetAllModelsInDatasetResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "labellers")]
    pub labellers: Vec<models::UserModelMetadata>,
    #[serde(rename = "model_tags")]
    pub model_tags: Vec<models::TaggedUserModelVersion>,
    /// The maximum number of pinned models
    #[serde(rename = "max_number_pinned_models")]
    pub max_number_pinned_models: MaxNumberPinnedModels,
}

impl GetAllModelsInDatasetResponse {
    pub fn new(status: Status, labellers: Vec<models::UserModelMetadata>, model_tags: Vec<models::TaggedUserModelVersion>, max_number_pinned_models: MaxNumberPinnedModels) -> GetAllModelsInDatasetResponse {
...
/// The maximum number of pinned models
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum MaxNumberPinnedModels {
    #[serde(rename = "100")]
    Variant100,
}

impl Default for MaxNumberPinnedModels {
    fn default() -> MaxNumberPinnedModels {
        Self::Variant100
    }
}
