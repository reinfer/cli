...
pub struct TaggedUserModelVersionUpdate {
...
impl TaggedUserModelVersionUpdate {
    pub fn new(version: i32) -> TaggedUserModelVersionUpdate {
        TaggedUserModelVersionUpdate {
            name: None,
            version,
            updated_at: None,
        }
