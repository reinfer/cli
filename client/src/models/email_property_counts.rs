...
pub struct EmailPropertyCounts {
    #[serde(rename = "settings")]
    pub settings: Box<models::EmailPropertyCountsSettings>,
    #[serde(rename = "values")]
    pub values: Vec<String>,
    #[serde(rename = "labels")]
    pub labels: Vec<String>,
    #[serde(rename = "num_comments")]
    pub num_comments: Vec<f64>,
    #[serde(rename = "num_labels")]
    pub num_labels: Vec<Vec<f64>>,
    #[serde(rename = "label_property_digest", skip_serializing_if = "Option::is_none")]
    pub label_property_digest: Option<Vec<models::LabelPropertiesDigest>>,
}

impl EmailPropertyCounts {
    pub fn new(settings: models::EmailPropertyCountsSettings, values: Vec<String>, labels: Vec<String>, num_comments: Vec<f64>, num_labels: Vec<Vec<f64>>) -> EmailPropertyCounts {
        EmailPropertyCounts {
