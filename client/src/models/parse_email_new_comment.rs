...
pub struct ParseEmailNewComment {
    #[serde(rename = "id")]
    pub id: String,
    ...
    pub text_format: models::TextFormat,
...
impl ParseEmailNewComment {
    pub fn new(id: String, timestamp: String, user_properties: std::collections::HashMap<String, models::UserPropertiesValue>, messages: Vec<models::Message>, text_format: models::TextFormat, attachments: Vec<models::Attachment>, thread_id: Option<String>) -> ParseEmailNewComment {
        ParseEmailNewComment {
            id,
            timestamp,
            user_properties,
            messages,
