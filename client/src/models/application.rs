...
pub struct Application {
    #[serde(rename = "kind")]
    pub kind: models::NtlmApplicationModelKind,
...
impl Application {
    pub fn new(kind: models::NtlmApplicationModelKind, tenant_id: String, client_id: String, thumbprint: String) -> Application {
        Application {
            kind,
            tenant_id,
            client_id,
