...
pub struct CreateProjectSetupCreatedResponse {
    /// Whether the project was newly created
    #[serde(rename = "project")]
    pub project: bool,
    /// Whether the source was newly created
    #[serde(rename = "source")]
    pub source: bool,
    /// Whether the dataset was newly created
    #[serde(rename = "dataset")]
    pub dataset: bool,
}

impl CreateProjectSetupCreatedResponse {
    pub fn new(project: bool, source: bool, dataset: bool) -> CreateProjectSetupCreatedResponse {
        CreateProjectSetupCreatedResponse {
            project,
            source,
            dataset,
        }
