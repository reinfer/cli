...
pub struct BusinessRuleSet {
    ...
    pub criticality: models::BusinessRuleSetCriticality,
    #[serde(rename = "rules")]
    pub rules: Vec<models::BusinessRule>,
}

impl BusinessRuleSet {
    pub fn new(name: String, criticality: models::BusinessRuleSetCriticality, rules: Vec<models::BusinessRule>) -> BusinessRuleSet {
        BusinessRuleSet {
            name,
            criticality,
            rules,
