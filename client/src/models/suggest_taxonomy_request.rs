...
pub struct SuggestTaxonomyRequest {
    /// Description of what the user wants to extract.
    #[serde(rename = "description")]
    pub description: String,
    /// Attachment references for example uploaded documents.
    #[serde(rename = "documents")]
    pub documents: Vec<String>,
}

impl SuggestTaxonomyRequest {
    pub fn new(description: String, documents: Vec<String>) -> SuggestTaxonomyRequest {
        SuggestTaxonomyRequest {
            description,
            documents,
        }
    }
