...
pub struct ThreadHistogramBinningCustom {
    #[serde(rename = "points")]
    pub points: Vec<f64>,
...
impl ThreadHistogramBinningCustom {
    pub fn new(points: Vec<f64>, negative_infinity: bool, positive_infinity: bool) -> ThreadHistogramBinningCustom {
        ThreadHistogramBinningCustom {
            points,
            negative_infinity,
            positive_infinity,
        }
