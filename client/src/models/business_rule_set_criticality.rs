...
/// BusinessRuleSetCriticality : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum BusinessRuleSetCriticality {
    #[serde(rename = "Must")]
    Must,
    #[serde(rename = "Should")]
    Should,
...
impl std::fmt::Display for BusinessRuleSetCriticality {
...
impl Default for BusinessRuleSetCriticality {
    fn default() -> BusinessRuleSetCriticality {
        Self::Must
    }
}
