...
pub struct UpdateTenantClientSubnetsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "client_subnets")]
    pub client_subnets: Vec<String>,
}

impl UpdateTenantClientSubnetsResponse {
    pub fn new(status: Status, client_subnets: Vec<String>) -> UpdateTenantClientSubnetsResponse {
