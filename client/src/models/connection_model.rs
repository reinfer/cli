...
pub struct ConnectionModel {
    ...
    #[serde(rename = "access")]
    pub access: Box<models::Access>,
    #[serde(rename = "microsoft_api")]
    pub microsoft_api: Box<models::MicrosoftApi>,
    #[serde(rename = "ews_endpoint", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub ews_endpoint: Option<Option<String>>,
    #[serde(rename = "build_version", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub build_version: Option<Option<String>>,
}

impl ConnectionModel {
    pub fn new(application: models::Application, access: models::Access, microsoft_api: models::MicrosoftApi) -> ConnectionModel {
        ConnectionModel {
            application: Box::new(application),
            access: Box::new(access),
            microsoft_api: Box::new(microsoft_api),
            ews_endpoint: None,
            build_version: None,
        }
    }
