...
pub struct ResetTriggerRequest {
    #[serde(rename = "to_comment_created_at")]
    pub to_comment_created_at: String,
}

impl ResetTriggerRequest {
    pub fn new(to_comment_created_at: String) -> ResetTriggerRequest {
        ResetTriggerRequest {
