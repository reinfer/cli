...
pub struct NpsSummary {
    #[serde(rename = "nps_property")]
    pub nps_property: String,
    #[serde(rename = "label_names")]
    pub label_names: Vec<String>,
    #[serde(rename = "timeseries")]
    pub timeseries: Vec<Vec<String>>,
...
impl NpsSummary {
    pub fn new(nps_property: String, label_names: Vec<String>, timeseries: Vec<Vec<String>>, histogram: Vec<Vec<f64>>, bubbles: Vec<Vec<f64>>) -> NpsSummary {
        NpsSummary {
            nps_property,
            label_names,
            timeseries,
