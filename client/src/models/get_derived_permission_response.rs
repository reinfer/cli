...
pub struct GetDerivedPermissionResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetDerivedPermissionResponse {
    pub fn new(status: Status, global_permissions: Vec<models::GlobalPermission>, organisation_permissions: Vec<models::ProjectPermission>, permissions: Vec<models::GetReducedPermissionsResponsePermissionsInner>) -> GetDerivedPermissionResponse {
