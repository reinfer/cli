...
pub struct CommentExtractionsPredictions {
    #[serde(rename = "groups")]
    pub groups: Vec<models::GroupPredictions>,
}

impl CommentExtractionsPredictions {
    pub fn new(groups: Vec<models::GroupPredictions>) -> CommentExtractionsPredictions {
        CommentExtractionsPredictions {
            groups,
        }
    }
}
