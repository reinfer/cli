...
pub struct GetDocumentMetadataResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "page_metadata")]
    pub page_metadata: Vec<models::PageMetadata>,
}

impl GetDocumentMetadataResponse {
    pub fn new(status: Status, page_metadata: Vec<models::PageMetadata>) -> GetDocumentMetadataResponse {
