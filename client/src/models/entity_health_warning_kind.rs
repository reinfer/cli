...
/// EntityHealthWarningKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum EntityHealthWarningKind {
    #[serde(rename = "low_reviewed_comments")]
    LowReviewedComments,
    #[serde(rename = "low_f1_score")]
    LowF1Score,
    #[serde(rename = "very_low_reviewed_comments")]
    VeryLowReviewedComments,
    #[serde(rename = "very_low_f1_score")]
    VeryLowF1Score,

}

impl std::fmt::Display for EntityHealthWarningKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::LowReviewedComments => write!(f, "low_reviewed_comments"),
            Self::LowF1Score => write!(f, "low_f1_score"),
            Self::VeryLowReviewedComments => write!(f, "very_low_reviewed_comments"),
            Self::VeryLowF1Score => write!(f, "very_low_f1_score"),
        }
    }
}

impl Default for EntityHealthWarningKind {
    fn default() -> EntityHealthWarningKind {
        Self::LowReviewedComments
    }
}
