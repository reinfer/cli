...
pub struct GetComparisonResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "compare")]
    pub compare: Box<models::Comparison>,
}

impl GetComparisonResponse {
    pub fn new(status: Status, compare: models::Comparison) -> GetComparisonResponse {
