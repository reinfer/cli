...
pub struct GetThreadsBySourceResponse {
    #[serde(rename = "status")]
    pub status: Status,
    /// List of comment threads
    #[serde(rename = "threads")]
    pub threads: Vec<models::CommentThread>,
}

impl GetThreadsBySourceResponse {
    pub fn new(status: Status, threads: Vec<models::CommentThread>) -> GetThreadsBySourceResponse {
        GetThreadsBySourceResponse {
            status,
            threads,
        }
    }
