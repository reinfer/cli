...
pub struct GetValidationV1Response {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "validation")]
    pub validation: Box<models::ValidationSummaryV1>,
}

impl GetValidationV1Response {
    pub fn new(status: Status, validation: models::ValidationSummaryV1) -> GetValidationV1Response {
        GetValidationV1Response {
            status,
