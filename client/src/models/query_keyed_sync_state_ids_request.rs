...
pub struct QueryKeyedSyncStateIdsRequest {
    /// The name of the mailbox to filter by.
    #[serde(rename = "mailbox_name")]
    pub mailbox_name: String,
}

impl QueryKeyedSyncStateIdsRequest {
    pub fn new(mailbox_name: String) -> QueryKeyedSyncStateIdsRequest {
