...
pub struct GetPageSelectionsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "selections")]
    pub selections: Vec<models::PageSelection>,
}

impl GetPageSelectionsResponse {
    pub fn new(status: Status, selections: Vec<models::PageSelection>) -> GetPageSelectionsResponse {
