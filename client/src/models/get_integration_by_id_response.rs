...
pub struct GetIntegrationByIdResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "integration")]
    pub integration: Box<models::Integration>,
}

impl GetIntegrationByIdResponse {
    pub fn new(status: Status, integration: models::Integration) -> GetIntegrationByIdResponse {
