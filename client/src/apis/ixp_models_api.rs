...
/// struct for typed errors of method [`get_ixp_consumability`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetIxpConsumabilityError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_ixp_models`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetIxpModelsError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_ixp_predictions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetIxpPredictionsError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`upload_ixp_document`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UploadIxpDocumentError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}
...
pub fn get_ixp_consumability(configuration: &configuration::Configuration, ) -> Result<models::GetIxpConsumabilityInfoResponse, Error<GetIxpConsumabilityError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/ixp/consumability", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetIxpConsumabilityError> = serde_json::from_str(&local_var_content).ok();
...
pub fn get_ixp_models(configuration: &configuration::Configuration, project_uuid: &str) -> Result<models::GetAllIxpModelsInProjectResponse, Error<GetIxpModelsError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/ixp/projects/{project_uuid}/models", local_var_configuration.base_path, project_uuid=crate::apis::urlencode(project_uuid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetIxpModelsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn get_ixp_predictions(configuration: &configuration::Configuration, project_uuid: &str, model_version: &str, document_id: &str) -> Result<models::IxpPredictExtractionsResponse, Error<GetIxpPredictionsError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/ixp/projects/{project_uuid}/models/{model_version}/documents/{document_id}/extractions", local_var_configuration.base_path, project_uuid=crate::apis::urlencode(project_uuid), model_version=crate::apis::urlencode(model_version), document_id=crate::apis::urlencode(document_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetIxpPredictionsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn upload_ixp_document(configuration: &configuration::Configuration, project_uuid: &str, model_version: &str, file: Option<std::path::PathBuf>) -> Result<models::IxpUploadDocumentResponse, Error<UploadIxpDocumentError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/ixp/projects/{project_uuid}/models/{model_version}/documents", local_var_configuration.base_path, project_uuid=crate::apis::urlencode(project_uuid), model_version=crate::apis::urlencode(model_version));
