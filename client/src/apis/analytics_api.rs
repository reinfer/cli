...
/// struct for typed errors of method [`create_page_view`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreatePageViewError {
...
pub fn create_page_view(configuration: &configuration::Configuration, create_page_view_request: models::CreatePageViewRequest) -> Result<models::CreatePageViewResponse, Error<CreatePageViewError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/analytics/pageview", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePageViewError> = serde_json::from_str(&local_var_content).ok();
