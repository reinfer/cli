...
pub fn get_themes(configuration: &configuration::Configuration, owner: &str, dataset_name: &str) -> Result<models::GetThemesResponse, Error<GetThemesError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/datasets/{owner}/{dataset_name}/themes", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), dataset_name=crate::apis::urlencode(dataset_name));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetThemesError> = serde_json::from_str(&local_var_content).ok();
