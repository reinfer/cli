...
/// struct for typed errors of method [`query_audit_events`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum QueryAuditEventsError {
...
pub fn query_audit_events(configuration: &configuration::Configuration, query_audit_events_request: models::QueryAuditEventsRequest) -> Result<models::QueryAuditEventsResponse, Error<QueryAuditEventsError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/audit_events/query", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueryAuditEventsError> = serde_json::from_str(&local_var_content).ok();
