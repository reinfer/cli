...
pub fn get_thread_themes(configuration: &configuration::Configuration, owner: &str, dataset_name: &str, get_thread_themes_request: models::GetThreadThemesRequest) -> Result<models::GetThreadThemesResponse, Error<GetThreadThemesError>> {
