...
pub struct ConversationalFilterRequest {
    #[serde(rename = "query")]
    pub query: String,
    #[serde(rename = "previous_filter", skip_serializing_if = "Option::is_none")]
    pub previous_filter: Option<String>,
}

impl ConversationalFilterRequest {
    pub fn new(query: String) -> ConversationalFilterRequest {
        ConversationalFilterRequest {
            query,
