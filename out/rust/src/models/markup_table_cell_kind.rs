...
/// MarkupTableCellKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum MarkupTableCellKind {
    #[serde(rename = "th")]
    Th,
    #[serde(rename = "td")]
    Td,
...
impl std::fmt::Display for MarkupTableCellKind {
...
impl Default for MarkupTableCellKind {
    fn default() -> MarkupTableCellKind {
        Self::Th
    }
}
