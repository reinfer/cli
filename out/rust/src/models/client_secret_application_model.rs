...
pub struct ClientSecretApplicationModel {
    #[serde(rename = "kind")]
    pub kind: models::ClientSecretApplicationModelKind,
...
impl ClientSecretApplicationModel {
    pub fn new(kind: models::ClientSecretApplicationModelKind, tenant_id: String, client_id: String) -> ClientSecretApplicationModel {
        ClientSecretApplicationModel {
            kind,
            tenant_id,
            client_id,
            client_secret: None,
