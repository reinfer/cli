...
pub struct Entities {
    ...
    pub assigned: Vec<models::Entity>,
    #[serde(rename = "dismissed")]
    pub dismissed: Vec<models::Entity>,
    #[serde(rename = "predicted")]
    pub predicted: Vec<models::PredictedEntity>,
}

impl Entities {
    pub fn new(assigned: Vec<models::Entity>, dismissed: Vec<models::Entity>, predicted: Vec<models::PredictedEntity>) -> Entities {
        Entities {
            assigned,
            dismissed,
            predicted,
