...
/// ErrorAction : The action take in response to the server error
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ErrorAction {
    /// An identifier/type discriminator for the action taken in response to the server error
    #[serde(rename = "kind")]
    pub kind: Kind,
    /// Email address for the mailbox that has been disabled
    #[serde(rename = "mailbox_name")]
    pub mailbox_name: String,
    /// Unique ID of the bucket where the mailbox was syncing
    #[serde(rename = "bucket_id")]
    pub bucket_id: String,
}

impl ErrorAction {
    /// The action take in response to the server error
    pub fn new(kind: Kind, mailbox_name: String, bucket_id: String) -> ErrorAction {
        ErrorAction {
            kind,
            mailbox_name,
            bucket_id,
