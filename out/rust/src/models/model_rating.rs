...
pub struct ModelRating {
    ...
    pub factors: Vec<models::ModelRatingFactor>,
    #[serde(rename = "bins")]
    pub bins: Vec<f64>,
}

impl ModelRating {
    pub fn new(score: f64, quality: models::DatasetQuality, needs_refinement: bool, factors: Vec<models::ModelRatingFactor>, bins: Vec<f64>) -> ModelRating {
        ModelRating {
            score,
            quality,
            needs_refinement,
