...
pub struct StreamTaxonomyPrediction {
    /// For future compatibility only pick the taxonomy named `default`.
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "labels")]
    pub labels: Vec<models::StreamLabelPrediction>,
    #[serde(rename = "general_fields")]
    pub general_fields: Vec<models::StreamGeneralFieldPrediction>,
}

impl StreamTaxonomyPrediction {
    pub fn new(name: String, labels: Vec<models::StreamLabelPrediction>, general_fields: Vec<models::StreamGeneralFieldPrediction>) -> StreamTaxonomyPrediction {
        StreamTaxonomyPrediction {
            name,
            labels,
            general_fields,
        }
