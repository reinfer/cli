...
/// TimePeriodComparison : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum TimePeriodComparison {
    #[serde(rename = "previous")]
    Previous,
    #[serde(rename = "same_in_previous_year")]
    SameInPreviousYear,
    #[serde(rename = "vs_long_running_average")]
    VsLongRunningAverage,

}

impl std::fmt::Display for TimePeriodComparison {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Previous => write!(f, "previous"),
            Self::SameInPreviousYear => write!(f, "same_in_previous_year"),
            Self::VsLongRunningAverage => write!(f, "vs_long_running_average"),
        }
    }
}

impl Default for TimePeriodComparison {
    fn default() -> TimePeriodComparison {
        Self::Previous
    }
}
