...
/// GraphApiModelKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum GraphApiModelKind {
    #[serde(rename = "graph")]
    Graph,

}

impl std::fmt::Display for GraphApiModelKind {
...
impl Default for GraphApiModelKind {
    fn default() -> GraphApiModelKind {
        Self::Graph
    }
}
