...
pub struct UiPathCvTableOnlyConfig {
    #[serde(rename = "kind", skip_serializing_if = "Option::is_none")]
    pub kind: Option<Kind>,
}

impl UiPathCvTableOnlyConfig {
    pub fn new() -> UiPathCvTableOnlyConfig {
...
pub enum Kind {
    #[serde(rename = "uipath_cv_table_only")]
    UipathCvTableOnly,
}

impl Default for Kind {
    fn default() -> Kind {
        Self::UipathCvTableOnly
    }
}
