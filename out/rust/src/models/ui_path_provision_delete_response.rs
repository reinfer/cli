...
pub struct UiPathProvisionDeleteResponse {
    #[serde(rename = "tenantId")]
    pub tenant_id: String,
    #[serde(rename = "serviceType")]
    pub service_type: String,
    #[serde(rename = "status")]
    pub status: models::UiPathTenantServiceStatus,
    #[serde(rename = "isHardDelete")]
    pub is_hard_delete: bool,
}

impl UiPathProvisionDeleteResponse {
    pub fn new(tenant_id: String, service_type: String, status: models::UiPathTenantServiceStatus, is_hard_delete: bool) -> UiPathProvisionDeleteResponse {
        UiPathProvisionDeleteResponse {
            tenant_id,
            service_type,
            status,
            is_hard_delete,
