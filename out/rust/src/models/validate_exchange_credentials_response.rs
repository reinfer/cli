...
pub struct ValidateExchangeCredentialsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    /// response to inform if provided crendetials are valid
    #[serde(rename = "result")]
    pub result: String,
}

impl ValidateExchangeCredentialsResponse {
    pub fn new(status: Status, result: String) -> ValidateExchangeCredentialsResponse {
        ValidateExchangeCredentialsResponse {
            status,
            result,
        }
    }
