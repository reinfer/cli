...
pub struct MessageRichTextTextMarkupInner {
    ...
    pub kind: Kind,
    #[serde(rename = "span")]
    pub span: Box<models::MessageSpan>,
    #[serde(rename = "break_kind")]
    pub break_kind: models::MarkupBreakKind,
    #[serde(rename = "children")]
    pub children: Vec<models::MarkupTableCellChildrenInner>,
    #[serde(rename = "href")]
    pub href: String,
    #[serde(rename = "style_kind")]
    pub style_kind: models::MarkupStyleKind,
    #[serde(rename = "paragraph_kind")]
    pub paragraph_kind: models::MarkupParagraphKind,
    #[serde(rename = "list_kind")]
    pub list_kind: models::MarkupListKind,
    #[serde(rename = "items")]
    pub items: Vec<models::MarkupListItem>,
    #[serde(rename = "rows")]
    pub rows: Vec<models::MarkupTableRow>,
    #[serde(rename = "captions")]
    pub captions: Vec<models::MarkupTableCaption>,
...
impl MessageRichTextTextMarkupInner {
    pub fn new(kind: Kind, span: models::MessageSpan, break_kind: models::MarkupBreakKind, children: Vec<models::MarkupTableCellChildrenInner>, href: String, style_kind: models::MarkupStyleKind, paragraph_kind: models::MarkupParagraphKind, list_kind: models::MarkupListKind, items: Vec<models::MarkupListItem>, rows: Vec<models::MarkupTableRow>, captions: Vec<models::MarkupTableCaption>, borderless: bool, src: String, alt: String) -> MessageRichTextTextMarkupInner {
