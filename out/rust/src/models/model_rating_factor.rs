...
pub struct ModelRatingFactor {
    #[serde(rename = "kind")]
    pub kind: models::ModelRatingFactorKind,
    #[serde(rename = "quality")]
    pub quality: models::DatasetQuality,
    #[serde(rename = "score")]
    pub score: f64,
    #[serde(rename = "dataset_actions")]
    pub dataset_actions: Vec<models::ModelRatingAction>,
    #[serde(rename = "label_actions")]
    pub label_actions: Vec<models::LabelAction>,
    #[serde(rename = "contributors")]
    pub contributors: Vec<models::Contributor>,
}

impl ModelRatingFactor {
    pub fn new(kind: models::ModelRatingFactorKind, quality: models::DatasetQuality, score: f64, dataset_actions: Vec<models::ModelRatingAction>, label_actions: Vec<models::LabelAction>, contributors: Vec<models::Contributor>) -> ModelRatingFactor {
        ModelRatingFactor {
            kind,
            quality,
            score,
