...
pub struct GetDatasetStatusResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "dataset_status")]
    pub dataset_status: Box<models::DatasetStatus>,
}

impl GetDatasetStatusResponse {
    pub fn new(status: Status, dataset_status: models::DatasetStatus) -> GetDatasetStatusResponse {
        GetDatasetStatusResponse {
            status,
            dataset_status: Box::new(dataset_status),
        }
    }
}
/// 
