...
pub struct FieldUipathContextModel {
...
impl FieldUipathContextModel {
    pub fn new(account_id: String, tenant_id: String, environment_name: String) -> FieldUipathContextModel {
        FieldUipathContextModel {
            account_id,
            tenant_id,
            environment_name,
        }
