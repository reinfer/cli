...
pub struct EntityRuleSetNewApi {
    ...
    pub choices: Option<Vec<models::FieldChoiceNewApi>>,
    #[serde(rename = "regex", deserialize_with = "Option::deserialize")]
    pub regex: Option<Box<models::Regex>>,
}

impl EntityRuleSetNewApi {
    pub fn new(regex: Option<models::Regex>) -> EntityRuleSetNewApi {
        EntityRuleSetNewApi {
            suppressors: None,
            choices: None,
