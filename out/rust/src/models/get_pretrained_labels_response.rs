...
pub struct GetPretrainedLabelsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "label_collections")]
    pub label_collections: Vec<models::LabelCollection>,
}

impl GetPretrainedLabelsResponse {
    pub fn new(status: Status, label_collections: Vec<models::LabelCollection>) -> GetPretrainedLabelsResponse {
