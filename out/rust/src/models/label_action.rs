...
pub struct LabelAction {
    ...
    pub label: String,
    #[serde(rename = "action")]
    pub action: Box<models::LabelHealthAction>,
    #[serde(rename = "warning", skip_serializing_if = "Option::is_none")]
    pub warning: Option<Box<models::LabelHealthWarning>>,
}

impl LabelAction {
    pub fn new(label: String, action: models::LabelHealthAction) -> LabelAction {
        LabelAction {
            label,
