...
pub struct MoonFormLabelAnnotationUpdate {
    #[serde(rename = "label")]
    pub label: Box<models::Label>,
    #[serde(rename = "captures")]
    pub captures: Vec<models::MoonFormCaptureFieldsAnnotationNew>,
}

impl MoonFormLabelAnnotationUpdate {
    pub fn new(label: models::Label, captures: Vec<models::MoonFormCaptureFieldsAnnotationNew>) -> MoonFormLabelAnnotationUpdate {
