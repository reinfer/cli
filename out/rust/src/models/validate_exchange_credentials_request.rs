...
pub struct ValidateExchangeCredentialsRequest {
    #[serde(rename = "connection")]
    pub connection: Box<models::ConnectionModel>,
    /// A mailbox must be provided to test the connection for ntlmcredentials
    #[serde(rename = "test_mailbox", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub test_mailbox: Option<Option<String>>,
    /// ID of an existing integration to validate credentials without providing all secrets
...
impl ValidateExchangeCredentialsRequest {
    pub fn new(connection: models::ConnectionModel) -> ValidateExchangeCredentialsRequest {
        ValidateExchangeCredentialsRequest {
