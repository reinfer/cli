...
pub struct EntityDef {
    ...
    pub rules: Option<Box<models::EntityRuleSetApi>>,
    #[serde(rename = "_entity_def_flags")]
    pub _entity_def_flags: Vec<models::EntityDefFlag>,
    #[serde(rename = "instructions", skip_serializing_if = "Option::is_none")]
    pub instructions: Option<String>,
}

impl EntityDef {
    pub fn new(id: String, color: i32, name: String, title: String, inherits_from: Vec<String>, trainable: bool, _entity_def_flags: Vec<models::EntityDefFlag>) -> EntityDef {
        EntityDef {
            id,
            color,
            name,
