...
pub struct UpdateApplianceConfigResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl UpdateApplianceConfigResponse {
    pub fn new(status: Status, changes: serde_json::Value) -> UpdateApplianceConfigResponse {
