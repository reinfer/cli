...
pub struct StringUserPropertyCountsSettings {
...
impl StringUserPropertyCountsSettings {
    pub fn new(group_by: String) -> StringUserPropertyCountsSettings {
        StringUserPropertyCountsSettings {
            group_by,
            limit: None,
            values: None,
        }
