...
pub struct ResetAnnotationsToPreviousPinnedModelResponse {
    #[serde(rename = "status")]
    pub status: Status,
}

impl ResetAnnotationsToPreviousPinnedModelResponse {
    pub fn new(status: Status) -> ResetAnnotationsToPreviousPinnedModelResponse {
