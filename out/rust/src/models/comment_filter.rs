...
pub struct CommentFilter {
    ...
    pub entities: Option<Box<models::EntitiesRules>>,
    #[serde(rename = "thread_properties", skip_serializing_if = "Option::is_none")]
    pub thread_properties: Option<Box<models::ThreadPropertyFilter>>,
    #[serde(rename = "timestamp", skip_serializing_if = "Option::is_none")]
    pub timestamp: Option<Box<models::TimestampRangeFilter>>,
    #[serde(rename = "reviewed", skip_serializing_if = "Option::is_none")]
    pub reviewed: Option<models::Reviewed>,
    #[serde(rename = "sources", skip_serializing_if = "Option::is_none")]
    pub sources: Option<Vec<String>>,
    #[serde(rename = "messages", skip_serializing_if = "Option::is_none")]
    pub messages: Option<Box<models::MessageFilter>>,
    ...
    pub trigger_exceptions: Option<std::collections::HashMap<String, models::NullableStringArrayFilter>>,
    #[serde(rename = "annotations", skip_serializing_if = "Option::is_none")]
    pub annotations: Option<Box<models::Annotations>>,
}
