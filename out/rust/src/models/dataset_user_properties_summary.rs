...
pub struct DatasetUserPropertiesSummary {
    /// List of numbers
    #[serde(rename = "number")]
    pub number: Vec<models::DatasetUserPropertiesSummaryNumber>,
    /// List of strings
    #[serde(rename = "string")]
    pub string: Vec<models::DatasetUserPropertiesSummaryString>,
}

impl DatasetUserPropertiesSummary {
    pub fn new(number: Vec<models::DatasetUserPropertiesSummaryNumber>, string: Vec<models::DatasetUserPropertiesSummaryString>) -> DatasetUserPropertiesSummary {
        DatasetUserPropertiesSummary {
            number,
            string,
        }
    }
