...
/// UnaryLabelHealthWarningKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum UnaryLabelHealthWarningKind {
    #[serde(rename = "biased")]
    Biased,
    #[serde(rename = "low_average_precision")]
    LowAveragePrecision,
    #[serde(rename = "low_reviewed_comments")]
    LowReviewedComments,
    #[serde(rename = "very_low_average_precision")]
    VeryLowAveragePrecision,
    #[serde(rename = "very_low_reviewed_comments")]
    VeryLowReviewedComments,
    #[serde(rename = "poor_coverage")]
    PoorCoverage,

}

impl std::fmt::Display for UnaryLabelHealthWarningKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Biased => write!(f, "biased"),
            Self::LowAveragePrecision => write!(f, "low_average_precision"),
            Self::LowReviewedComments => write!(f, "low_reviewed_comments"),
            Self::VeryLowAveragePrecision => write!(f, "very_low_average_precision"),
            Self::VeryLowReviewedComments => write!(f, "very_low_reviewed_comments"),
            Self::PoorCoverage => write!(f, "poor_coverage"),
        }
    }
}

impl Default for UnaryLabelHealthWarningKind {
    fn default() -> UnaryLabelHealthWarningKind {
        Self::Biased
    }
}
