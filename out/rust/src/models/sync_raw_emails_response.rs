...
impl SyncRawEmailsResponse {
    pub fn new(status: Status, updated: i32, updated_properties_only: i32, updated_text_changed: i32, unchanged: i32, new: i32) -> SyncRawEmailsResponse {
