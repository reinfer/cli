...
pub struct AuditEvent {
    ...
    #[serde(rename = "actor_tenant_id")]
    pub actor_tenant_id: String,
    #[serde(rename = "tenant_ids")]
    ...
    #[serde(rename = "trigger_ids", skip_serializing_if = "Option::is_none")]
...
impl AuditEvent {
    pub fn new(event_id: String, event_type: String, timestamp: String, actor_user_id: String, actor_tenant_id: String, tenant_ids: Vec<String>) -> AuditEvent {
        AuditEvent {
            event_id,
            event_type,
            timestamp,
