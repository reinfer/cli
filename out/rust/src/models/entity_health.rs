...
pub struct EntityHealth {
    #[serde(rename = "need_pinned", skip_serializing_if = "Option::is_none")]
    pub need_pinned: Option<f64>,
    #[serde(rename = "need_pinned_increment", skip_serializing_if = "Option::is_none")]
    pub need_pinned_increment: Option<f64>,
    #[serde(rename = "smart", deserialize_with = "Option::deserialize")]
    pub smart: Option<Box<models::EntityHealthSmart>>,
}

impl EntityHealth {
    pub fn new(smart: Option<models::EntityHealthSmart>) -> EntityHealth {
        EntityHealth {
            need_pinned: None,
            need_pinned_increment: None,
            smart: if let Some(x) = smart {Some(Box::new(x))} else {None},
        }
    }
}
