...
pub struct BinaryLabelHealthAction {
    #[serde(rename = "kind")]
    pub kind: models::BinaryLabelHealthActionKind,
    #[serde(rename = "label")]
    pub label: String,
}

impl BinaryLabelHealthAction {
    pub fn new(kind: models::BinaryLabelHealthActionKind, label: String) -> BinaryLabelHealthAction {
        BinaryLabelHealthAction {
            kind,
            label,
        }
    }
