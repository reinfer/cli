...
/// TrainingActionCompleteness : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum TrainingActionCompleteness {
    #[serde(rename = "uncompletable")]
    Uncompletable,
    #[serde(rename = "incomplete")]
    Incomplete,
    #[serde(rename = "already-complete")]
    AlreadyComplete,
    #[serde(rename = "newly-completed")]
    NewlyCompleted,

}

impl std::fmt::Display for TrainingActionCompleteness {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Uncompletable => write!(f, "uncompletable"),
            Self::Incomplete => write!(f, "incomplete"),
            Self::AlreadyComplete => write!(f, "already-complete"),
            Self::NewlyCompleted => write!(f, "newly-completed"),
        }
    }
}

impl Default for TrainingActionCompleteness {
    fn default() -> TrainingActionCompleteness {
        Self::Uncompletable
    }
}
