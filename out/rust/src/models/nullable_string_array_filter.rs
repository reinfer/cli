...
pub struct NullableStringArrayFilter {
    ...
    /// A list of string or null values for which the filter should not apply
    #[serde(rename = "not_one_of", skip_serializing_if = "Option::is_none")]
    pub not_one_of: Option<Vec<String>>,
    /// Whether to include missing values in the filter
    #[serde(rename = "include_missing", skip_serializing_if = "Option::is_none")]
    pub include_missing: Option<bool>,
}

impl NullableStringArrayFilter {
    pub fn new() -> NullableStringArrayFilter {
        NullableStringArrayFilter {
            one_of: None,
            not_one_of: None,
