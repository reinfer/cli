...
pub struct QueryDatasetUserPropertyValuesFilter {
...
impl QueryDatasetUserPropertyValuesFilter {
    pub fn new() -> QueryDatasetUserPropertyValuesFilter {
        QueryDatasetUserPropertyValuesFilter {
            comment_filter: None,
