...
pub struct PredictLatestRequest {
    #[serde(rename = "documents")]
    pub documents: Vec<models::PredictDocument>,
    ...
    #[serde(rename = "_include_comments", skip_serializing_if = "Option::is_none")]
    pub _include_comments: Option<bool>,
}

impl PredictLatestRequest {
    pub fn new(documents: Vec<models::PredictDocument>) -> PredictLatestRequest {
