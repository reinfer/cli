...
pub struct GetLabelValidationRequest {
    #[serde(rename = "label")]
    pub label: String,
    #[serde(rename = "moon", skip_serializing_if = "Option::is_none")]
    pub moon: Option<Box<models::MoonIntentValidationRequest>>,
}

impl GetLabelValidationRequest {
    pub fn new(label: String) -> GetLabelValidationRequest {
        GetLabelValidationRequest {
            label,
            moon: None,
        }
    }
