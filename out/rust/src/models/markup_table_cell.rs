...
pub struct MarkupTableCell {
    #[serde(rename = "children")]
    pub children: Vec<models::MarkupTableCellChildrenInner>,
    #[serde(rename = "cell_kind")]
    pub cell_kind: models::MarkupTableCellKind,
...
impl MarkupTableCell {
    pub fn new(children: Vec<models::MarkupTableCellChildrenInner>, cell_kind: models::MarkupTableCellKind, rowspan: i32, colspan: i32) -> MarkupTableCell {
        MarkupTableCell {
            children,
            cell_kind,
            rowspan,
