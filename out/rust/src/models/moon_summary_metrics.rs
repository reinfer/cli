...
pub struct MoonSummaryMetrics {
    ...
    #[serde(rename = "num_train_documents")]
    pub num_train_documents: i32,
    #[serde(rename = "num_test_documents")]
    pub num_test_documents: i32,
    #[serde(rename = "num_reviewed_documents")]
    pub num_reviewed_documents: i32,
    #[serde(rename = "intents")]
    pub intents: std::collections::HashMap<String, models::IntentsValue>,
    #[serde(rename = "recalls")]
    pub recalls: Vec<f64>,
    #[serde(rename = "mean_curve")]
    pub mean_curve: Box<models::MeanPrCurve>,
    #[serde(rename = "average_field_stats")]
    pub average_field_stats: Box<models::EntityAverageStats>,
    #[serde(rename = "mean_capture_curve")]
    pub mean_capture_curve: Box<models::MeanPrCurve>,
}

impl MoonSummaryMetrics {
    pub fn new(num_train_captures: i32, num_test_captures: i32, num_reviewed_captures: i32, num_train_documents: i32, num_test_documents: i32, num_reviewed_documents: i32, intents: std::collections::HashMap<String, models::IntentsValue>, recalls: Vec<f64>, mean_curve: models::MeanPrCurve, average_field_stats: models::EntityAverageStats, mean_capture_curve: models::MeanPrCurve) -> MoonSummaryMetrics {
        MoonSummaryMetrics {
            num_train_captures,
            num_test_captures,
            ...
            num_train_documents,
            num_test_documents,
            num_reviewed_documents,
            intents,
            recalls,
            mean_curve: Box::new(mean_curve),
            average_field_stats: Box::new(average_field_stats),
            mean_capture_curve: Box::new(mean_capture_curve),
        }
    }
}
