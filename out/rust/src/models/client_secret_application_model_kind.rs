...
/// ClientSecretApplicationModelKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ClientSecretApplicationModelKind {
    #[serde(rename = "custom")]
    Custom,

}

impl std::fmt::Display for ClientSecretApplicationModelKind {
...
impl Default for ClientSecretApplicationModelKind {
    fn default() -> ClientSecretApplicationModelKind {
        Self::Custom
    }
}
