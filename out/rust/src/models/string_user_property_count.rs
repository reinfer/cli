...
pub struct StringUserPropertyCount {
    #[serde(rename = "settings")]
    pub settings: Box<models::StringUserPropertyCountsSettings>,
    #[serde(rename = "values")]
...
impl StringUserPropertyCount {
    pub fn new(settings: models::StringUserPropertyCountsSettings, values: Vec<String>, labels: Vec<String>, num_comments: Vec<f64>, num_labels: Vec<Vec<f64>>) -> StringUserPropertyCount {
        StringUserPropertyCount {
