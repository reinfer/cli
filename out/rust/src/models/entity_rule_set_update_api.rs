...
pub struct EntityRuleSetUpdateApi {
    #[serde(rename = "suppressors", skip_serializing_if = "Option::is_none")]
    pub suppressors: Option<Vec<String>>,
    #[serde(rename = "choices", skip_serializing_if = "Option::is_none")]
    pub choices: Option<Vec<models::EntityRuleSetUpdateApiChoicesInner>>,
    #[serde(rename = "regex", deserialize_with = "Option::deserialize")]
    pub regex: Option<Box<models::Regex>>,
}

impl EntityRuleSetUpdateApi {
    pub fn new(regex: Option<models::Regex>) -> EntityRuleSetUpdateApi {
        EntityRuleSetUpdateApi {
            suppressors: None,
            choices: None,
            regex: if let Some(x) = regex {Some(Box::new(x))} else {None},
        }
    }
}
