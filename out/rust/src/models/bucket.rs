...
pub struct Bucket {
    ...
    pub last_updated_by: Option<Box<models::BucketUpdatedBy>>,
}

impl Bucket {
    pub fn new(id: String, owner: String, name: String, title: String, created_at: String, updated_at: String) -> Bucket {
        Bucket {
            id,
            owner,
            name,
