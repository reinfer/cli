...
pub struct UnaryLabelHealthAction {
    #[serde(rename = "kind")]
    pub kind: models::UnaryLabelHealthActionKind,
}

impl UnaryLabelHealthAction {
    pub fn new(kind: models::UnaryLabelHealthActionKind) -> UnaryLabelHealthAction {
        UnaryLabelHealthAction {
            kind,
        }
    }
}
