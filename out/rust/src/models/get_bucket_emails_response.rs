...
pub struct GetBucketEmailsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "emails")]
...
impl GetBucketEmailsResponse {
    pub fn new(status: Status, emails: Vec<models::Email>) -> GetBucketEmailsResponse {
        GetBucketEmailsResponse {
            status,
            emails,
            continuation: None,
        }
