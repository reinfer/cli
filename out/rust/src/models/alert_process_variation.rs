...
pub struct AlertProcessVariation {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "value")]
    pub value: f64,
    #[serde(rename = "variation_kind")]
    pub variation_kind: models::VariationKind,
    #[serde(rename = "compared_to")]
    pub compared_to: models::TimePeriodComparison,
}

impl AlertProcessVariation {
    pub fn new(kind: Kind, value: f64, variation_kind: models::VariationKind, compared_to: models::TimePeriodComparison) -> AlertProcessVariation {
