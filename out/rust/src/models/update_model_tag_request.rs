...
pub struct UpdateModelTagRequest {
    #[serde(rename = "model_tag")]
    pub model_tag: Box<models::TaggedUserModelVersionUpdate>,
}

impl UpdateModelTagRequest {
    pub fn new(model_tag: models::TaggedUserModelVersionUpdate) -> UpdateModelTagRequest {
        UpdateModelTagRequest {
