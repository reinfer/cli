...
pub struct MoonIntentFieldsMetrics {
    #[serde(rename = "field_stats")]
    pub field_stats: std::collections::HashMap<String, models::EntityDefIdStat>,
    #[serde(rename = "average_field_stats")]
    pub average_field_stats: Box<models::EntityAverageStats>,
    #[serde(rename = "capture_pr", deserialize_with = "Option::deserialize")]
    pub capture_pr: Option<Box<models::PrCurve>>,
...
impl MoonIntentFieldsMetrics {
    pub fn new(field_stats: std::collections::HashMap<String, models::EntityDefIdStat>, average_field_stats: models::EntityAverageStats, capture_pr: Option<models::PrCurve>, optimal_thresholds: Option<models::OptimalThreshold>) -> MoonIntentFieldsMetrics {
        MoonIntentFieldsMetrics {
            field_stats,
            average_field_stats: Box::new(average_field_stats),
            capture_pr: if let Some(x) = capture_pr {Some(Box::new(x))} else {None},
