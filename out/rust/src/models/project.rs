...
pub struct Project {
    ...
    #[serde(rename = "user_auto_join")]
    pub user_auto_join: bool,
}

impl Project {
    pub fn new(id: String, name: String, title: String, description: String, created_at: String, updated_at: String, user_auto_join: bool) -> Project {
        Project {
            id,
            name,
            title,
