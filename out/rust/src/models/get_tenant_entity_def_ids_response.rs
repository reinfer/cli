...
pub struct GetTenantEntityDefIdsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "entity_def_ids")]
    pub entity_def_ids: Vec<String>,
}

impl GetTenantEntityDefIdsResponse {
    pub fn new(status: Status, entity_def_ids: Vec<String>) -> GetTenantEntityDefIdsResponse {
        GetTenantEntityDefIdsResponse {
            status,
            entity_def_ids,
        }
    }
