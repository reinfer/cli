...
pub struct KeyedFolderSyncStateUpdate {
...
impl KeyedFolderSyncStateUpdate {
    pub fn new(mailbox_name: String, folder_id: String, folder_path: Vec<String>, status: models::SyncStatus) -> KeyedFolderSyncStateUpdate {
