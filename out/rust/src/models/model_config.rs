...
/// ModelConfig : The model config for the dataset
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ModelConfig {
    #[serde(rename = "kind", skip_serializing_if = "Option::is_none")]
    pub kind: Option<Kind>,
    #[serde(rename = "num_pages_per_chunk", skip_serializing_if = "Option::is_none")]
    pub num_pages_per_chunk: Option<i32>,
    #[serde(rename = "model_version", skip_serializing_if = "Option::is_none")]
    pub model_version: Option<models::GptModelVersion>,
    ...
    #[serde(rename = "system_prompt_override", skip_serializing_if = "Option::is_none")]
    ...
    pub iterative_config: Option<Box<models::IterativeConfig>>,
}

impl ModelConfig {
    /// The model config for the dataset
    pub fn new(flags: Vec<models::GptIxpFlag>) -> ModelConfig {
        ModelConfig {
            kind: None,
            num_pages_per_chunk: None,
            model_version: None,
            input_config: None,
