...
pub struct LabelPropertiesDigest {
    #[serde(rename = "label_property_digests")]
    pub label_property_digests: Vec<models::LabelPropertyDigest>,
}

impl LabelPropertiesDigest {
    pub fn new(label_property_digests: Vec<models::LabelPropertyDigest>) -> LabelPropertiesDigest {
        LabelPropertiesDigest {
            label_property_digests,
        }
    }
}
