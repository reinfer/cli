...
pub struct QueryDatasetUserPropertyValuesResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "user_property")]
    pub user_property: Box<models::StringUserPropertySummary>,
}

impl QueryDatasetUserPropertyValuesResponse {
    pub fn new(status: Status, user_property: models::StringUserPropertySummary) -> QueryDatasetUserPropertyValuesResponse {
        QueryDatasetUserPropertyValuesResponse {
            status,
            user_property: Box::new(user_property),
        }
    }
}
/// 
