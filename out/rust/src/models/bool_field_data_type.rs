...
pub struct BoolFieldDataType {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "true_formatted", deserialize_with = "Option::deserialize")]
    pub true_formatted: Option<String>,
    #[serde(rename = "false_formatted", deserialize_with = "Option::deserialize")]
    pub false_formatted: Option<String>,
}

impl BoolFieldDataType {
    pub fn new(kind: Kind, true_formatted: Option<String>, false_formatted: Option<String>) -> BoolFieldDataType {
        BoolFieldDataType {
            kind,
            true_formatted,
            false_formatted,
