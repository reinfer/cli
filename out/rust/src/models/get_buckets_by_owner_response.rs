...
pub struct GetBucketsByOwnerResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "buckets")]
    pub buckets: Vec<models::Bucket>,
}

impl GetBucketsByOwnerResponse {
    pub fn new(status: Status, buckets: Vec<models::Bucket>) -> GetBucketsByOwnerResponse {
