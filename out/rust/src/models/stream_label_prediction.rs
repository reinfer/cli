...
pub struct StreamLabelPrediction {
    #[serde(rename = "name")]
    pub name: String,
    /// The confidence in this label occurrence, independent of the particular predicted field values.
    #[serde(rename = "occurrence_confidence")]
    pub occurrence_confidence: Box<models::StreamConfidence>,
    /// The confidence that this label occurs with the specific field values in `fields`. Always less than or equal to `occurence_confidence`.
    #[serde(rename = "extraction_confidence")]
    pub extraction_confidence: Box<models::StreamConfidence>,
    /// The field predictions for this label. All defined label fields will appear in this list---if they're missing in this occurrence, they'll have a null value.
    #[serde(rename = "fields")]
    pub fields: Vec<models::StreamExtractionFieldPrediction>,
}

impl StreamLabelPrediction {
    pub fn new(name: String, occurrence_confidence: models::StreamConfidence, extraction_confidence: models::StreamConfidence, fields: Vec<models::StreamExtractionFieldPrediction>) -> StreamLabelPrediction {
