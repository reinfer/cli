...
pub struct LabelTimeseriesEntry {
    #[serde(rename = "timestamp_str")]
    pub timestamp_str: String,
    #[serde(rename = "expected_count_any")]
    pub expected_count_any: f64,
    #[serde(rename = "expected_count_positive")]
    pub expected_count_positive: f64,
    #[serde(rename = "expected_count_negative")]
    pub expected_count_negative: f64,
    #[serde(rename = "label_sentiment_counts")]
    pub label_sentiment_counts: Vec<f64>,
}

impl LabelTimeseriesEntry {
    pub fn new(timestamp_str: String, expected_count_any: f64, expected_count_positive: f64, expected_count_negative: f64, label_sentiment_counts: Vec<f64>) -> LabelTimeseriesEntry {
        LabelTimeseriesEntry {
            timestamp_str,
            expected_count_any,
            expected_count_positive,
            expected_count_negative,
            label_sentiment_counts,
        }
    }
}
