...
pub struct NewDashboard {
    ...
    #[serde(rename = "blob")]
    pub blob: String,
    #[serde(rename = "default_for_datasets", skip_serializing_if = "Option::is_none")]
    pub default_for_datasets: Option<Vec<String>>,
    #[serde(rename = "dataset_ids")]
    pub dataset_ids: Vec<String>,
}

impl NewDashboard {
    pub fn new(blob: String, dataset_ids: Vec<String>) -> NewDashboard {
        NewDashboard {
            title: None,
            blob,
            default_for_datasets: None,
            dataset_ids,
        }
    }
}
