...
/// struct for typed errors of method [`get_qualified_login_url`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetQualifiedLoginUrlError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_subdomain`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSubdomainError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}
...
pub fn get_qualified_login_url(configuration: &configuration::Configuration, get_qualified_login_url_request: models::GetQualifiedLoginUrlRequest) -> Result<models::GetQualifiedLoginUrlResponse, Error<GetQualifiedLoginUrlError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/deployment/login-location", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetQualifiedLoginUrlError> = serde_json::from_str(&local_var_content).ok();
...
pub fn get_subdomain(configuration: &configuration::Configuration, ) -> Result<models::GetSubdomainResponse, Error<GetSubdomainError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/deployment/subdomain", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSubdomainError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
