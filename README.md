...
- [Ubuntu (x86_64-unknown-linux-gnu)](https://reinfer.dev/public/cli/bin/x86_64-unknown-linux-gnu/0.37.5/re)
- [macOS (aarch64-apple-darwin)](https://reinfer.dev/public/cli/bin/aarch64-apple-darwin/0.37.5/re)
- [Windows (x86_64-pc-windows-gnu)](https://reinfer.dev/public/cli/bin/x86_64-pc-windows-gnu/0.37.5/re.exe)

### Debian / Ubuntu

You can download a `.deb` package [here](https://reinfer.dev/public/cli/debian/reinfer-cli_0.37.5_amd64.deb).
