...
pub struct BinaryLabelHealthWarning {
    #[serde(rename = "kind")]
    pub kind: models::BinaryLabelHealthWarningKind,
    #[serde(rename = "label")]
    pub label: String,
}

impl BinaryLabelHealthWarning {
    pub fn new(kind: models::BinaryLabelHealthWarningKind, label: String) -> BinaryLabelHealthWarning {
