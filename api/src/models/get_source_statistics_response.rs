...
pub struct GetSourceStatisticsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    /// Source statistics
    #[serde(rename = "statistics")]
    pub statistics: Box<models::SourceStatistics>,
}

impl GetSourceStatisticsResponse {
    pub fn new(status: Status, statistics: models::SourceStatistics) -> GetSourceStatisticsResponse {
        GetSourceStatisticsResponse {
            status,
