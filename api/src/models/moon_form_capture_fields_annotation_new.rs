...
pub struct MoonFormCaptureFieldsAnnotationNew {
    #[serde(rename = "fields")]
    pub fields: Vec<models::MoonFormFieldAnnotationNew>,
}

impl MoonFormCaptureFieldsAnnotationNew {
    pub fn new(fields: Vec<models::MoonFormFieldAnnotationNew>) -> MoonFormCaptureFieldsAnnotationNew {
