...
pub struct GetDatasetStatisticsRequest {
    #[serde(rename = "comment_filter", skip_serializing_if = "Option::is_none")]
    pub comment_filter: Option<models::CommentFilter>,
    #[serde(rename = "label_filter", skip_serializing_if = "Option::is_none")]
    pub label_filter: Option<Vec<String>>,
    #[serde(rename = "by_labels", skip_serializing_if = "Option::is_none")]
    pub by_labels: Option<Box<models::ByLabels>>,
    #[serde(rename = "by_label_properties")]
    pub by_label_properties: Vec<models::LabelPropertyId>,
    #[serde(rename = "time_resolution", skip_serializing_if = "Option::is_none")]
    pub time_resolution: Option<models::TimeResolution>,
    #[serde(rename = "string_user_property_counts", skip_serializing_if = "Option::is_none")]
    pub string_user_property_counts: Option<Vec<models::StringUserPropertyCountsSettings>>,
    #[serde(rename = "email_property_counts", skip_serializing_if = "Option::is_none")]
    pub email_property_counts: Option<Box<models::EmailPropertyCountsSettingsByProperty>>,
    #[serde(rename = "source_counts", skip_serializing_if = "Option::is_none")]
    pub source_counts: Option<Box<models::SourceCountsSettings>>,
    #[serde(rename = "label_timeseries", skip_serializing_if = "Option::is_none")]
    pub label_timeseries: Option<bool>,
    #[serde(rename = "label_property_timeseries", skip_serializing_if = "Option::is_none")]
    pub label_property_timeseries: Option<bool>,
    #[serde(rename = "thread_histogram", skip_serializing_if = "Option::is_none")]
    pub thread_histogram: Option<Box<models::ThreadHistogramSettingsByProperty>>,
    #[serde(rename = "nps_property", skip_serializing_if = "Option::is_none")]
    pub nps_property: Option<String>,
    #[serde(rename = "attribute_filters", skip_serializing_if = "Option::is_none")]
    pub attribute_filters: Option<Vec<models::AttributeFilter>>,
    #[serde(rename = "thread_mode", skip_serializing_if = "Option::is_none")]
    pub thread_mode: Option<bool>,
    #[serde(rename = "timezone", skip_serializing_if = "Option::is_none")]
    pub timezone: Option<String>,
}

impl GetDatasetStatisticsRequest {
    pub fn new(by_label_properties: Vec<models::LabelPropertyId>) -> GetDatasetStatisticsRequest {
