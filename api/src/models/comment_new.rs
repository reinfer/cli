...
pub struct CommentNew {
    ...
    pub user_properties: Option<std::collections::HashMap<String, models::UserPropertiesValue>>,
    #[serde(rename = "messages", skip_serializing_if = "Option::is_none")]
    pub messages: Option<Vec<models::Message>>,
...
impl CommentNew {
    pub fn new(id: String) -> CommentNew {
        CommentNew {
            id,
            timestamp: None,
            thread_id: None,
