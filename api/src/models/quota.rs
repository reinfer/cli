...
pub struct Quota {
    /// Quota kind
    #[serde(rename = "quota_kind")]
    pub quota_kind: models::QuotaKind,
    /// The value to set for the corresponding quota
    #[serde(rename = "hard_limit")]
    pub hard_limit: i32,
    /// The current max usage for the corresponding quota
    #[serde(rename = "current_max_usage")]
    pub current_max_usage: i32,
    /// The maximum a user can automatically increase the quota value up to
    #[serde(rename = "auto_increase_up_to", skip_serializing_if = "Option::is_none")]
    pub auto_increase_up_to: Option<i32>,
}

impl Quota {
    pub fn new(quota_kind: models::QuotaKind, hard_limit: i32, current_max_usage: i32) -> Quota {
        Quota {
            quota_kind,
            hard_limit,
            current_max_usage,
