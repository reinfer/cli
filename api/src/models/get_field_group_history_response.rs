...
/// GetFieldGroupHistoryResponse : Response containing field group version history
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetFieldGroupHistoryResponse {
...
impl GetFieldGroupHistoryResponse {
    /// Response containing field group version history
    pub fn new(versions: Vec<models::FieldGroupVersionEntry>) -> GetFieldGroupHistoryResponse {
