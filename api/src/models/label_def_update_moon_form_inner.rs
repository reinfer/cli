...
pub struct LabelDefUpdateMoonFormInner {
    /// Unique identifier for the moon field
    ...
    #[serde(rename = "rule_set", skip_serializing_if = "Option::is_none")]
    pub rule_set: Option<Box<models::BusinessRuleSet>>,
    /// Deprecated. Use field_type_id instead
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// ID of the field type.
    #[serde(rename = "field_type_id", skip_serializing_if = "Option::is_none")]
...
impl LabelDefUpdateMoonFormInner {
    pub fn new(field_id: String, name: String) -> LabelDefUpdateMoonFormInner {
