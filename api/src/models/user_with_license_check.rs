...
pub struct UserWithLicenseCheck {
    #[serde(rename = "id")]
    pub id: String,
    ...
    pub organisation_permissions: std::collections::HashMap<String, Vec<models::ProjectPermission>>,
    #[serde(rename = "derived_organisation_permissions")]
    pub derived_organisation_permissions: std::collections::HashMap<String, Vec<models::ProjectPermission>>,
    #[serde(rename = "global_permissions")]
    pub global_permissions: Vec<models::GlobalPermission>,
    #[serde(rename = "sso_global_permissions")]
    pub sso_global_permissions: Vec<models::GlobalPermission>,
    #[serde(rename = "derived_user_global_permissions")]
    pub derived_user_global_permissions: Vec<models::GlobalPermission>,
    #[serde(rename = "derived_global_permissions")]
    pub derived_global_permissions: Vec<models::GlobalPermission>,
    #[serde(rename = "last_login_at")]
    pub last_login_at: String,
    #[serde(rename = "is_support_user")]
    pub is_support_user: bool,
    #[serde(rename = "user_access_token", skip_serializing_if = "Option::is_none")]
    pub user_access_token: Option<String>,
    #[serde(rename = "license")]
    pub license: models::UserLicense,
    #[serde(rename = "license_check")]
    pub license_check: models::UserLicenseCheck,
}

impl UserWithLicenseCheck {
    pub fn new(id: String, created: String, username: String, email: String, verified: bool, organisation_permissions: std::collections::HashMap<String, Vec<models::ProjectPermission>>, derived_organisation_permissions: std::collections::HashMap<String, Vec<models::ProjectPermission>>, global_permissions: Vec<models::GlobalPermission>, sso_global_permissions: Vec<models::GlobalPermission>, derived_user_global_permissions: Vec<models::GlobalPermission>, derived_global_permissions: Vec<models::GlobalPermission>, last_login_at: String, is_support_user: bool, license: models::UserLicense, license_check: models::UserLicenseCheck) -> UserWithLicenseCheck {
        UserWithLicenseCheck {
            id,
            created,
            username,
            ...
            derived_organisation_permissions,
            global_permissions,
            sso_global_permissions,
            derived_user_global_permissions,
            derived_global_permissions,
            last_login_at,
            is_support_user,
