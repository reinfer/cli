...
pub struct StoreBucketSyncStateRequest {
    #[serde(rename = "bucket_sync_state")]
    pub bucket_sync_state: Box<models::BucketSyncState>,
}

impl StoreBucketSyncStateRequest {
    pub fn new(bucket_sync_state: models::BucketSyncState) -> StoreBucketSyncStateRequest {
        StoreBucketSyncStateRequest {
