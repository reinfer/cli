...
pub struct UiPathProvisionCreateProperties {
    #[serde(rename = "TenantDisplayName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tenant_display_name: Option<Option<String>>,
}

impl UiPathProvisionCreateProperties {
    pub fn new() -> UiPathProvisionCreateProperties {
        UiPathProvisionCreateProperties {
