...
pub struct GetTenantDefaultProjectPermissionsResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetTenantDefaultProjectPermissionsResponse {
    pub fn new(status: Status, default_project_permissions: Vec<models::ProjectPermission>) -> GetTenantDefaultProjectPermissionsResponse {
