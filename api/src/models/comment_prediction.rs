...
pub struct CommentPrediction {
    /// Comment id
    #[serde(rename = "uid")]
    pub uid: String,
    /// List of predicted labels
    #[serde(rename = "labels")]
    pub labels: Vec<models::PredictedLabel>,
    /// List of predicted entities
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<models::PredictedEntity>>,
    /// List of predicted label properties
    #[serde(rename = "label_properties", skip_serializing_if = "Option::is_none")]
    pub label_properties: Option<Vec<models::PredictedLabelProperty>>,
    /// Predicted sentiment
    #[serde(rename = "sentiment", skip_serializing_if = "Option::is_none")]
    pub sentiment: Option<Box<models::CommentSentiment>>,
    /// List of translations
    #[serde(rename = "translations", skip_serializing_if = "Option::is_none")]
    pub translations: Option<Vec<models::Translation>>,
}

impl CommentPrediction {
    pub fn new(uid: String, labels: Vec<models::PredictedLabel>) -> CommentPrediction {
        CommentPrediction {
            uid,
            labels,
            entities: None,
