...
/// ModelRatingAction : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ModelRatingAction {
...
impl std::fmt::Display for ModelRatingAction {
...
impl Default for ModelRatingAction {
    fn default() -> ModelRatingAction {
        Self::Discover
    }
}
