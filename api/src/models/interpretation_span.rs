...
pub struct InterpretationSpan {
    #[serde(rename = "utf16_byte_start")]
    pub utf16_byte_start: i32,
    #[serde(rename = "utf16_byte_end")]
    pub utf16_byte_end: i32,
    /// A value between 1 (relevant) and -1 (irrelevant) which identifies how important the span of text is to the theme
    #[serde(rename = "importance")]
    pub importance: f64,
}

impl InterpretationSpan {
    pub fn new(utf16_byte_start: i32, utf16_byte_end: i32, importance: f64) -> InterpretationSpan {
        InterpretationSpan {
            utf16_byte_start,
            utf16_byte_end,
            importance,
