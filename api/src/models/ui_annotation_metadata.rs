...
pub struct UiAnnotationMetadata {
    #[serde(rename = "assignment_method")]
    pub assignment_method: models::AssignmentMethod,
    #[serde(rename = "view")]
    pub view: models::TrainView,
    #[serde(rename = "reviewed_filter_rule", skip_serializing_if = "Option::is_none")]
    pub reviewed_filter_rule: Option<models::ReviewedFilterRule>,
    #[serde(rename = "retrieval_method")]
    pub retrieval_method: models::RetrievalMethod,
    #[serde(rename = "has_label_filter")]
    pub has_label_filter: bool,
}

impl UiAnnotationMetadata {
    pub fn new(assignment_method: models::AssignmentMethod, view: models::TrainView, retrieval_method: models::RetrievalMethod, has_label_filter: bool) -> UiAnnotationMetadata {
        UiAnnotationMetadata {
            assignment_method,
            view,
            reviewed_filter_rule: None,
            retrieval_method,
            has_label_filter,
        }
    }
