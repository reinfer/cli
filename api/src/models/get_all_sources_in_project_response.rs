...
pub struct GetAllSourcesInProjectResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetAllSourcesInProjectResponse {
    pub fn new(status: Status, sources: Vec<models::Source>) -> GetAllSourcesInProjectResponse {
