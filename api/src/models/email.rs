...
pub struct Email {
    ...
    #[serde(rename = "mime_content")]
    pub mime_content: String,
    #[serde(rename = "metadata", deserialize_with = "Option::deserialize")]
    pub metadata: Option<Box<models::EmailMetadata>>,
...
impl Email {
    pub fn new(id: String, mailbox: String, timestamp: String, mime_content: String, metadata: Option<models::EmailMetadata>, attachments: Vec<models::Attachment>, created_at: Option<String>, updated_at: Option<String>) -> Email {
        Email {
            id,
            mailbox,
            timestamp,
