...
pub struct UpdateCommentLabellingResponse {
...
impl UpdateCommentLabellingResponse {
    pub fn new(comment: models::Comment, labelling: Vec<models::LabellingGroup>, status: Status) -> UpdateCommentLabellingResponse {
