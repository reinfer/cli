...
pub struct QueryAuditEventsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "audit_events")]
    pub audit_events: Vec<models::AuditEvent>,
    #[serde(rename = "tenants")]
    pub tenants: Vec<models::AuditEventsTenant>,
    #[serde(rename = "users", skip_serializing_if = "Option::is_none")]
    pub users: Option<Vec<models::AuditEventsUser>>,
    #[serde(rename = "sources", skip_serializing_if = "Option::is_none")]
    pub sources: Option<Vec<models::AuditEventsSource>>,
    #[serde(rename = "datasets", skip_serializing_if = "Option::is_none")]
    pub datasets: Option<Vec<models::AuditEventsDataset>>,
    #[serde(rename = "triggers", skip_serializing_if = "Option::is_none")]
    pub triggers: Option<Vec<models::AuditEventsTrigger>>,
    #[serde(rename = "projects", skip_serializing_if = "Option::is_none")]
    pub projects: Option<Vec<models::AuditEventsProject>>,
    #[serde(rename = "continuation", skip_serializing_if = "Option::is_none")]
    pub continuation: Option<String>,
}

impl QueryAuditEventsResponse {
    pub fn new(status: Status, audit_events: Vec<models::AuditEvent>, tenants: Vec<models::AuditEventsTenant>) -> QueryAuditEventsResponse {
