...
pub struct Binning {
    #[serde(rename = "fixed")]
    pub fixed: Box<models::ThreadHistogramBinningFixed>,
    #[serde(rename = "custom")]
    pub custom: Box<models::ThreadHistogramBinningCustom>,
    #[serde(rename = "variable")]
    pub variable: Box<models::ThreadHistogramBinningVariable>,
}

impl Binning {
    pub fn new(fixed: models::ThreadHistogramBinningFixed, custom: models::ThreadHistogramBinningCustom, variable: models::ThreadHistogramBinningVariable) -> Binning {
        Binning {
            fixed: Box::new(fixed),
