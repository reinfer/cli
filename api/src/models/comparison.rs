...
pub struct Comparison {
    ...
    pub label_counts: std::collections::HashMap<String, models::LabelComparison>,
}

impl Comparison {
    pub fn new(num_comments: Vec<f64>, label_counts: std::collections::HashMap<String, models::LabelComparison>) -> Comparison {
        Comparison {
            num_comments,
            label_counts,
        }
