...
pub struct PreviewAlertResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "issues")]
    pub issues: Vec<models::IssueDetail>,
    /// The start of the period over which the preview was ran
    #[serde(rename = "timerange_start")]
    pub timerange_start: String,
    /// The end of the period over which the preview was ran
    #[serde(rename = "timerange_end")]
    pub timerange_end: String,
}

impl PreviewAlertResponse {
    pub fn new(status: Status, issues: Vec<models::IssueDetail>, timerange_start: String, timerange_end: String) -> PreviewAlertResponse {
        PreviewAlertResponse {
            status,
            issues,
            timerange_start,
            timerange_end,
