...
pub struct AlertUpdate {
    ...
    #[serde(rename = "subscribed_user_ids", skip_serializing_if = "Option::is_none")]
...
impl AlertUpdate {
    pub fn new(revision: i32, title: String, description: String, dataset_ids: Vec<String>, config: models::AlertConfig) -> AlertUpdate {
        AlertUpdate {
            revision,
            title,
            description,
