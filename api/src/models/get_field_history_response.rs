...
/// GetFieldHistoryResponse : Response containing field version history
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetFieldHistoryResponse {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Status>,
    /// Version history entries
    #[serde(rename = "versions")]
    pub versions: Vec<models::FieldVersionEntry>,
...
impl GetFieldHistoryResponse {
    /// Response containing field version history
    pub fn new(versions: Vec<models::FieldVersionEntry>) -> GetFieldHistoryResponse {
