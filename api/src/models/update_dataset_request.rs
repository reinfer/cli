...
/// UpdateDatasetRequest : Request to update an existing dataset
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateDatasetRequest {
    #[serde(rename = "dataset")]
    pub dataset: Box<models::DatasetUpdate>,
}

impl UpdateDatasetRequest {
    /// Request to update an existing dataset
    pub fn new(dataset: models::DatasetUpdate) -> UpdateDatasetRequest {
