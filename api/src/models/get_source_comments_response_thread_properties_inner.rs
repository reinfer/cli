...
pub struct GetSourceCommentsResponseThreadPropertiesInner {
    ...
    #[serde(rename = "num_participants")]
    pub num_participants: i32,
    #[serde(rename = "first_sender")]
    pub first_sender: String,
    #[serde(rename = "thread_position", skip_serializing_if = "Option::is_none")]
    pub thread_position: Option<i32>,
}

impl GetSourceCommentsResponseThreadPropertiesInner {
    pub fn new(duration: f64, response_time: f64, num_messages: i32, num_participants: i32, first_sender: String) -> GetSourceCommentsResponseThreadPropertiesInner {
