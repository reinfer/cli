...
/// LabelPropertyId : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum LabelPropertyId {
    #[serde(rename = "0000000000000001")]
    Variant0000000000000001,
    #[serde(rename = "0000000000000002")]
    Variant0000000000000002,

}

impl std::fmt::Display for LabelPropertyId {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Variant0000000000000001 => write!(f, "0000000000000001"),
            Self::Variant0000000000000002 => write!(f, "0000000000000002"),
        }
    }
}

impl Default for LabelPropertyId {
    fn default() -> LabelPropertyId {
        Self::Variant0000000000000001
    }
}
