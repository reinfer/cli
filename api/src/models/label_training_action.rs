...
pub struct LabelTrainingAction {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "kind")]
    pub kind: Kind,
...
impl LabelTrainingAction {
    pub fn new(id: String, kind: Kind, sub_kind: String, factor_kind: models::ModelRatingFactorKind, quality: models::DatasetQuality, plan: models::LabelAction) -> LabelTrainingAction {
        LabelTrainingAction {
            id,
            kind,
            sub_kind,
