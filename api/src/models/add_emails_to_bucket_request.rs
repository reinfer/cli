...
pub struct AddEmailsToBucketRequest {
    #[serde(rename = "emails")]
    pub emails: Vec<models::EmailNew>,
}

impl AddEmailsToBucketRequest {
    pub fn new(emails: Vec<models::EmailNew>) -> AddEmailsToBucketRequest {
