...
pub struct GetStreamByNameResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "stream")]
    pub stream: Box<models::Trigger>,
}

impl GetStreamByNameResponse {
    pub fn new(status: Status, stream: models::Trigger) -> GetStreamByNameResponse {
