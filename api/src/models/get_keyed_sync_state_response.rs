...
pub struct GetKeyedSyncStateResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "keyed_sync_state")]
    pub keyed_sync_state: Box<models::KeyedSyncState>,
}

impl GetKeyedSyncStateResponse {
    pub fn new(status: Status, keyed_sync_state: models::KeyedSyncState) -> GetKeyedSyncStateResponse {
        GetKeyedSyncStateResponse {
            status,
