...
pub struct EntityHealthAction {
    #[serde(rename = "kind")]
    pub kind: models::EntityHealthActionKind,
}

impl EntityHealthAction {
    pub fn new(kind: models::EntityHealthActionKind) -> EntityHealthAction {
        EntityHealthAction {
            kind,
        }
    }
