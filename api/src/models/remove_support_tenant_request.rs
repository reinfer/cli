...
pub struct RemoveSupportTenantRequest {
    #[serde(rename = "email")]
    pub email: String,
    #[serde(rename = "user_tenant")]
    pub user_tenant: String,
}

impl RemoveSupportTenantRequest {
    pub fn new(email: String, user_tenant: String) -> RemoveSupportTenantRequest {
