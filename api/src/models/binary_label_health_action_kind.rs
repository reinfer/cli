...
/// BinaryLabelHealthActionKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum BinaryLabelHealthActionKind {
    #[serde(rename = "merge")]
    Merge,
    #[serde(rename = "deconfuse")]
    Deconfuse,

}

impl std::fmt::Display for BinaryLabelHealthActionKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Merge => write!(f, "merge"),
            Self::Deconfuse => write!(f, "deconfuse"),
        }
    }
}

impl Default for BinaryLabelHealthActionKind {
    fn default() -> BinaryLabelHealthActionKind {
        Self::Merge
    }
}
