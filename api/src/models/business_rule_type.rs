...
/// BusinessRuleType : An enumeration.
/// An enumeration.
...
impl Default for BusinessRuleType {
    fn default() -> BusinessRuleType {
        Self::Mandatory
    }
}
