...
pub struct MoonFormLabelAnnotation {
    #[serde(rename = "label")]
    pub label: Box<models::Label>,
    #[serde(rename = "captures")]
    pub captures: Vec<models::MoonFormCaptureFieldsAnnotation>,
}

impl MoonFormLabelAnnotation {
    pub fn new(label: models::Label, captures: Vec<models::MoonFormCaptureFieldsAnnotation>) -> MoonFormLabelAnnotation {
        MoonFormLabelAnnotation {
            label: Box::new(label),
            captures,
        }
    }
