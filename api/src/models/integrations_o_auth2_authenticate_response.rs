...
pub struct IntegrationsOAuth2AuthenticateResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "state")]
    pub state: String,
...
impl IntegrationsOAuth2AuthenticateResponse {
    pub fn new(status: Status, state: String, redirect_uri: String) -> IntegrationsOAuth2AuthenticateResponse {
        IntegrationsOAuth2AuthenticateResponse {
            status,
            state,
            redirect_uri,
        }
