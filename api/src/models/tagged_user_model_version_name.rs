...
/// TaggedUserModelVersionName : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum TaggedUserModelVersionName {
...
impl std::fmt::Display for TaggedUserModelVersionName {
...
impl Default for TaggedUserModelVersionName {
    fn default() -> TaggedUserModelVersionName {
        Self::Staging
    }
}
