...
/// BusinessRuleLogicalOperator : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum BusinessRuleLogicalOperator {
    #[serde(rename = "AND")]
    And,
    #[serde(rename = "OR")]
    Or,
...
impl std::fmt::Display for BusinessRuleLogicalOperator {
...
impl Default for BusinessRuleLogicalOperator {
    fn default() -> BusinessRuleLogicalOperator {
        Self::And
    }
}
