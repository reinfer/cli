...
pub struct LabelGroup {
    ...
    #[serde(rename = "label_collection_name", deserialize_with = "Option::deserialize")]
    pub label_collection_name: Option<String>,
...
impl LabelGroup {
    pub fn new(name: String, label_defs: Vec<models::LabelDef>, label_collection_name: Option<String>, trainable: bool, hidden: bool, instructions: String) -> LabelGroup {
        LabelGroup {
            name,
            label_defs,
