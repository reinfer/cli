...
pub struct Integration {
    ...
    #[serde(rename = "id")]
    pub id: String,
    /// The project which owns the integration
    #[serde(rename = "owner")]
    pub owner: String,
    /// The API name of the integration
    #[serde(rename = "name")]
    pub name: String,
    ...
    /// Custom settings to configure the integration
    #[serde(rename = "configuration")]
    pub configuration: serde_json::Value,
    /// If this integration is active
    #[serde(rename = "enabled")]
    pub enabled: bool,
    /// The type of the integration
    #[serde(rename = "type")]
    pub r#type: models::IntegrationType,
    /// Reason for which the integration was disabled
    #[serde(rename = "disabled_reason", skip_serializing_if = "Option::is_none")]
    pub disabled_reason: Option<models::IntegrationDisabledReason>,
}

impl Integration {
    pub fn new(id: String, owner: String, name: String, title: String, created_at: String, updated_at: String, configuration: serde_json::Value, enabled: bool, r#type: models::IntegrationType) -> Integration {
        Integration {
            id,
            owner,
            name,
