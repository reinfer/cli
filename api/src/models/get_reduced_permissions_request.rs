...
pub struct GetReducedPermissionsRequest {
    #[serde(rename = "global_permissions", skip_serializing_if = "Option::is_none")]
    pub global_permissions: Option<Vec<models::GlobalPermission>>,
    #[serde(rename = "organisation_permissions", skip_serializing_if = "Option::is_none")]
    pub organisation_permissions: Option<Vec<models::ProjectPermission>>,
}

impl GetReducedPermissionsRequest {
    pub fn new() -> GetReducedPermissionsRequest {
        GetReducedPermissionsRequest {
            global_permissions: None,
            organisation_permissions: None,
        }
    }
}
