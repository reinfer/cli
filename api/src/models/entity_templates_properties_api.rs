...
pub struct EntityTemplatesPropertiesApi {
    #[serde(rename = "templates")]
    pub templates: Vec<models::EntityTemplatePropertiesApi>,
}

impl EntityTemplatesPropertiesApi {
    pub fn new(templates: Vec<models::EntityTemplatePropertiesApi>) -> EntityTemplatesPropertiesApi {
