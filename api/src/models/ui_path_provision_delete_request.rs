...
pub struct UiPathProvisionDeleteRequest {
...
impl UiPathProvisionDeleteRequest {
    pub fn new(callback_url: String, organization_id: String, is_hard_delete: bool) -> UiPathProvisionDeleteRequest {
