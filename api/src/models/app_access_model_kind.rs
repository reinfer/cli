...
/// AppAccessModelKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum AppAccessModelKind {
    #[serde(rename = "app_access")]
    AppAccess,

}

impl std::fmt::Display for AppAccessModelKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::AppAccess => write!(f, "app_access"),
        }
    }
}

impl Default for AppAccessModelKind {
    fn default() -> AppAccessModelKind {
        Self::AppAccess
    }
}
