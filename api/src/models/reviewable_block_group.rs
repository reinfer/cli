...
pub struct ReviewableBlockGroup {
    #[serde(rename = "body_blocks")]
    pub body_blocks: Vec<models::ReviewableBlock>,
}

impl ReviewableBlockGroup {
    pub fn new(body_blocks: Vec<models::ReviewableBlock>) -> ReviewableBlockGroup {
