...
pub struct IntegrationError {
    ...
    /// The message on the thrown error
    #[serde(rename = "error_text")]
    pub error_text: String,
    /// The type of server error that occurred
    #[serde(rename = "error_details")]
    pub error_details: Box<models::IntegrationErrorDetails>,
    #[serde(rename = "error_action")]
    pub error_action: Box<models::ErrorAction>,
    /// Timestamp when the error was created
    #[serde(rename = "created_at")]
    pub created_at: String,
    /// Timestamp when a notification was sent if possible
    #[serde(rename = "processed_at", skip_serializing_if = "Option::is_none")]
    pub processed_at: Option<String>,
}

impl IntegrationError {
    pub fn new(id: String, integration_id: String, error_text: String, error_details: models::IntegrationErrorDetails, error_action: models::ErrorAction, created_at: String) -> IntegrationError {
        IntegrationError {
            id,
            integration_id,
            error_text,
            error_details: Box::new(error_details),
