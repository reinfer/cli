...
pub struct DatasetNew {
    ...
    pub entity_defs: Option<Vec<models::EntityDefNew>>,
    #[serde(rename = "general_fields", skip_serializing_if = "Option::is_none")]
    pub general_fields: Option<Vec<models::GeneralFieldDefNew>>,
    ...
    /// The name of the IANA time zone (UTC if missing) used by the frontend to display the timestamps in local time
    ...
    #[serde(rename = "has_sentiment", skip_serializing_if = "Option::is_none")]
    pub has_sentiment: Option<bool>,
    #[serde(rename = "experimental_async_fork_dataset", skip_serializing_if = "Option::is_none")]
    pub experimental_async_fork_dataset: Option<bool>,
    #[serde(rename = "label_groups", skip_serializing_if = "Option::is_none")]
    pub label_groups: Option<Vec<models::LabelGroupNew>>,
    #[serde(rename = "label_defs", skip_serializing_if = "Option::is_none")]
    pub label_defs: Option<Vec<models::LabelDefNew>>,
    #[serde(rename = "copy_annotations_from", skip_serializing_if = "Option::is_none")]
    pub copy_annotations_from: Option<String>,
}

impl DatasetNew {
    pub fn new() -> DatasetNew {
        DatasetNew {
            title: None,
            description: None,
            source_ids: None,
