...
pub struct QueryDatasetUserPropertyValuesRequest {
    #[serde(rename = "limit", skip_serializing_if = "Option::is_none")]
    pub limit: Option<i32>,
    #[serde(rename = "filter", skip_serializing_if = "Option::is_none")]
    pub filter: Option<Box<models::QueryDatasetUserPropertyValuesFilter>>,
}

impl QueryDatasetUserPropertyValuesRequest {
    pub fn new() -> QueryDatasetUserPropertyValuesRequest {
