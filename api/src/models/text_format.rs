...
/// TextFormat - Fixed version that correctly defines TextFormat as an enum.
/// The generated version incorrectly created an empty struct,
/// but the OpenAPI spec defines it as an enum with "markdown" and "plain" values.
