...
pub struct UserModelMetadataSettings {
...
impl UserModelMetadataSettings {
    pub fn new(starred: bool, description: String) -> UserModelMetadataSettings {
        UserModelMetadataSettings {
            starred,
            description,
        }
    }
