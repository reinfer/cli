...
pub struct GetDeprecatedUserModelsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "datasets")]
    pub datasets: Vec<models::Dataset>,
    #[serde(rename = "deprecated_models")]
    pub deprecated_models: Vec<models::DeprecatedUserModelMetadata>,
}

impl GetDeprecatedUserModelsResponse {
    pub fn new(status: Status, datasets: Vec<models::Dataset>, deprecated_models: Vec<models::DeprecatedUserModelMetadata>) -> GetDeprecatedUserModelsResponse {
        GetDeprecatedUserModelsResponse {
            status,
            datasets,
            deprecated_models,
        }
