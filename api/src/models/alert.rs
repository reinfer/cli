...
pub struct Alert {
    ...
    #[serde(rename = "id")]
    pub id: String,
    /// The API name of the alert
    #[serde(rename = "name")]
    pub name: String,
    /// The project which owns the alert
    #[serde(rename = "owner")]
    pub owner: String,
    /// Timestamp when the alert was created
    #[serde(rename = "created_at")]
    pub created_at: String,
    /// Timestamp when the alert was updated
    #[serde(rename = "updated_at")]
    pub updated_at: String,
    /// The latest revision of the alert
    ...
    /// The datasets associated with this alert
    #[serde(rename = "dataset_ids")]
    pub dataset_ids: Vec<String>,
    /// The users subscribed to receive this alert
    #[serde(rename = "subscribed_user_ids")]
    pub subscribed_user_ids: Vec<String>,
    /// Alert Configuration
    #[serde(rename = "config")]
    pub config: Box<models::AlertConfig>,
}

impl Alert {
    pub fn new(id: String, name: String, owner: String, created_at: String, updated_at: String, revision: i32, title: String, description: String, dataset_ids: Vec<String>, subscribed_user_ids: Vec<String>, config: models::AlertConfig) -> Alert {
        Alert {
            id,
            name,
            owner,
