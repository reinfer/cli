...
/// ReviewedFilterRule : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ReviewedFilterRule {
    #[serde(rename = "only_reviewed")]
    Reviewed,
    #[serde(rename = "only_unreviewed")]
    Unreviewed,

}

impl std::fmt::Display for ReviewedFilterRule {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Reviewed => write!(f, "only_reviewed"),
            Self::Unreviewed => write!(f, "only_unreviewed"),
        }
    }
}

impl Default for ReviewedFilterRule {
    fn default() -> ReviewedFilterRule {
        Self::Reviewed
    }
}
