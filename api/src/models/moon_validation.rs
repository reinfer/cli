...
pub struct MoonValidation {
    #[serde(rename = "intent_validation")]
    pub intent_validation: Box<models::IntentValidation>,
    #[serde(rename = "field_validation")]
    pub field_validation: Box<models::MoonIntentFieldsMetrics>,
}

impl MoonValidation {
    pub fn new(intent_validation: models::IntentValidation, field_validation: models::MoonIntentFieldsMetrics) -> MoonValidation {
        MoonValidation {
            intent_validation: Box::new(intent_validation),
            field_validation: Box::new(field_validation),
        }
    }
}
