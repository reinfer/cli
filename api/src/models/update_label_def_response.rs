...
pub struct UpdateLabelDefResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "num_modified")]
    pub num_modified: i32,
    #[serde(rename = "label")]
    pub label: Box<models::LabelDef>,
}

impl UpdateLabelDefResponse {
    pub fn new(status: Status, num_modified: i32, label: models::LabelDef) -> UpdateLabelDefResponse {
