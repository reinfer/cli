...
pub struct PollTriggerResponse {
    #[serde(rename = "status")]
    pub status: Status,
    /// How many comments were skipped
    #[serde(rename = "filtered")]
    pub filtered: i32,
    /// Sequence ID used to advance the trigger once comments are processed
    #[serde(rename = "sequence_id")]
    pub sequence_id: String,
    #[serde(rename = "results")]
    pub results: Vec<models::StreamCommentResult>,
    #[serde(rename = "is_end_sequence")]
    pub is_end_sequence: bool,
}

impl PollTriggerResponse {
    pub fn new(status: Status, filtered: i32, sequence_id: String, results: Vec<models::StreamCommentResult>, is_end_sequence: bool) -> PollTriggerResponse {
        PollTriggerResponse {
            status,
            filtered,
            sequence_id,
