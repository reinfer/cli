...
pub struct ThreadHistogramBinningVariableContainer {
    #[serde(rename = "variable")]
    pub variable: Box<models::ThreadHistogramBinningVariable>,
}

impl ThreadHistogramBinningVariableContainer {
    pub fn new(variable: models::ThreadHistogramBinningVariable) -> ThreadHistogramBinningVariableContainer {
