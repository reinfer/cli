...
pub struct GetAllIntegrationsInProjectResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetAllIntegrationsInProjectResponse {
    pub fn new(status: Status, integrations: Vec<models::Integration>) -> GetAllIntegrationsInProjectResponse {
