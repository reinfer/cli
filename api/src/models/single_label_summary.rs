...
pub struct SingleLabelSummary {
    /// Name of the label
    #[serde(rename = "name")]
    pub name: String,
    /// Unfiltered assigned sentiment
    #[serde(rename = "unfiltered_assigned")]
    pub unfiltered_assigned: Box<models::LabelCounts>,
    /// Filtered sentiment
    #[serde(rename = "filtered", skip_serializing_if = "Option::is_none")]
    pub filtered: Option<Box<models::LabelCounts>>,
    ...
    pub health: Option<Box<models::LabelHealth>>,
}

impl SingleLabelSummary {
    pub fn new(name: String, unfiltered_assigned: models::LabelCounts) -> SingleLabelSummary {
        SingleLabelSummary {
            name,
            unfiltered_assigned: Box::new(unfiltered_assigned),
            filtered: None,
            threshold: None,
            title: None,
            health: None,
