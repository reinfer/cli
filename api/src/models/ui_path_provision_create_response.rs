...
pub struct UiPathProvisionCreateResponse {
...
impl UiPathProvisionCreateResponse {
    pub fn new(tenant_id: String, service_type: String, status: models::UiPathTenantServiceStatus) -> UiPathProvisionCreateResponse {
