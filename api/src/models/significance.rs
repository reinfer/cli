...
pub struct Significance {
    ...
    pub proportion: Box<models::SignificanceValue>,
    #[serde(rename = "positivity")]
    pub positivity: Box<models::SignificanceValue>,
}

impl Significance {
    pub fn new(proportion: models::SignificanceValue, positivity: models::SignificanceValue) -> Significance {
        Significance {
            proportion: Box::new(proportion),
            positivity: Box::new(positivity),
        }
    }
}
