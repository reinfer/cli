...
pub struct IntentsValue {
    ...
    #[serde(rename = "average_precision")]
    pub average_precision: f64,
    #[serde(rename = "optimal_thresholds")]
    pub optimal_thresholds: Box<models::OptimalThreshold>,
    #[serde(rename = "health")]
    ...
    #[serde(rename = "capture_average_precision")]
    pub capture_average_precision: f64,
...
impl IntentsValue {
    pub fn new(train_size: i32, test_size: i32, reviewed_size: i32, average_precision: f64, optimal_thresholds: models::OptimalThreshold, health: models::LabelHealth, capture_average_precision: f64, num_train_captures: i32, num_test_captures: i32, num_reviewed_captures: i32) -> IntentsValue {
        IntentsValue {
            train_size,
            test_size,
            reviewed_size,
            average_precision,
            optimal_thresholds: Box::new(optimal_thresholds),
