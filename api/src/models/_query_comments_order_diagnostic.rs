...
pub struct QueryCommentsOrderDiagnostic {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "diagnostic_kind")]
    pub diagnostic_kind: DiagnosticKind,
    #[serde(rename = "entity_def_id", skip_serializing_if = "Option::is_none")]
    pub entity_def_id: Option<String>,
}

impl QueryCommentsOrderDiagnostic {
    pub fn new(kind: Kind, diagnostic_kind: DiagnosticKind) -> QueryCommentsOrderDiagnostic {
