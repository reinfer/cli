...
/// UserLicenseCheck : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum UserLicenseCheck {
    #[serde(rename = "Failed")]
    Failed,
...
impl std::fmt::Display for UserLicenseCheck {
...
impl Default for UserLicenseCheck {
    fn default() -> UserLicenseCheck {
        Self::Failed
    }
}
