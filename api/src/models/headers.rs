...
/// Headers : An object containing the headers of the email
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct Headers {
    #[serde(rename = "parsed")]
    pub parsed: std::collections::HashMap<String, models::ParsedValue>,
    #[serde(rename = "raw")]
    pub raw: String,
}

impl Headers {
    /// An object containing the headers of the email
    pub fn new(parsed: std::collections::HashMap<String, models::ParsedValue>, raw: String) -> Headers {
        Headers {
            parsed,
            raw,
        }
