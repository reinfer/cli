...
pub struct AnnotationMetadataCount {
    ...
    #[serde(rename = "retrieved_by_text_search", skip_serializing_if = "Option::is_none")]
    pub retrieved_by_text_search: Option<i32>,
    #[serde(rename = "shuffle_label_unfiltered", skip_serializing_if = "Option::is_none")]
    pub shuffle_label_unfiltered: Option<i32>,
    #[serde(rename = "clusters_unfiltered", skip_serializing_if = "Option::is_none")]
    pub clusters_unfiltered: Option<i32>,
    #[serde(rename = "low_confidence", skip_serializing_if = "Option::is_none")]
    pub low_confidence: Option<i32>,
    #[serde(rename = "teach_label_reviewed", skip_serializing_if = "Option::is_none")]
    pub teach_label_reviewed: Option<i32>,
    #[serde(rename = "teach_label_unreviewed", skip_serializing_if = "Option::is_none")]
    pub teach_label_unreviewed: Option<i32>,
}

impl AnnotationMetadataCount {
    pub fn new() -> AnnotationMetadataCount {
        AnnotationMetadataCount {
            unknown: None,
            other: None,
            retrieved_by_text_search: None,
            shuffle_label_unfiltered: None,
            clusters_unfiltered: None,
            low_confidence: None,
            teach_label_reviewed: None,
            teach_label_unreviewed: None,
        }
    }
}
