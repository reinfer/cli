...
pub struct BucketUpdatedBy {
    #[serde(rename = "config_owner")]
...
impl BucketUpdatedBy {
    pub fn new(config_owner: String, config_key: String, shard_index: i32, num_shards: i32) -> BucketUpdatedBy {
        BucketUpdatedBy {
            config_owner,
            config_key,
            shard_index,
