...
/// PrivateKeyApplicationModelKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum PrivateKeyApplicationModelKind {
    #[serde(rename = "private_key")]
    PrivateKey,

}

impl std::fmt::Display for PrivateKeyApplicationModelKind {
...
impl Default for PrivateKeyApplicationModelKind {
    fn default() -> PrivateKeyApplicationModelKind {
        Self::PrivateKey
    }
}
