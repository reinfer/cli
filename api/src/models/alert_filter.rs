...
pub struct AlertFilter {
    #[serde(rename = "comment_filter")]
    pub comment_filter: models::CommentFilter,
    #[serde(rename = "attribute_filters")]
    pub attribute_filters: Vec<models::AttributeFilter>,
}

impl AlertFilter {
    pub fn new(comment_filter: models::CommentFilter, attribute_filters: Vec<models::AttributeFilter>) -> AlertFilter {
        AlertFilter {
            comment_filter,
            attribute_filters,
        }
