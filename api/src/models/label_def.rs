...
pub struct LabelDef {
    ...
    pub pretrained: Option<Box<models::BuiltinLabelDef>>,
    ...
    pub moon_form: Option<Vec<models::MoonFormFieldDef>>,
    #[serde(rename = "_flags", skip_serializing_if = "Option::is_none")]
    pub _flags: Option<Vec<models::LabelDefFlag>>,
}

impl LabelDef {
    pub fn new(name: String) -> LabelDef {
        LabelDef {
            name,
            title: None,
            instructions: None,
