...
pub struct GetDatasetSummaryRequest {
    ...
    /// Label Filters are deprecated, use Attribute Filters instead
...
impl GetDatasetSummaryRequest {
    pub fn new() -> GetDatasetSummaryRequest {
