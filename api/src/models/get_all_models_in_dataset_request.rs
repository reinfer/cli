...
pub struct GetAllModelsInDatasetRequest {
    #[serde(rename = "older_than_version", skip_serializing_if = "Option::is_none")]
    pub older_than_version: Option<i32>,
    ...
    #[serde(rename = "starred", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub starred: Option<Option<bool>>,
...
impl GetAllModelsInDatasetRequest {
    pub fn new() -> GetAllModelsInDatasetRequest {
        GetAllModelsInDatasetRequest {
            older_than_version: None,
            limit: None,
