...
/// BusinessRuleComparisonOperator : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum BusinessRuleComparisonOperator {
    #[serde(rename = "Equals")]
    Equals,
...
impl std::fmt::Display for BusinessRuleComparisonOperator {
...
impl Default for BusinessRuleComparisonOperator {
    fn default() -> BusinessRuleComparisonOperator {
        Self::Equals
    }
}
