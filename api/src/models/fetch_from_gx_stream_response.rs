...
pub struct FetchFromGxStreamResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "results")]
    pub results: Vec<models::StreamCommentExtractionsResult>,
...
impl FetchFromGxStreamResponse {
    pub fn new(status: Status, results: Vec<models::StreamCommentExtractionsResult>, filtered: i32, sequence_id: String) -> FetchFromGxStreamResponse {
        FetchFromGxStreamResponse {
            status,
            results,
            filtered,
            sequence_id,
