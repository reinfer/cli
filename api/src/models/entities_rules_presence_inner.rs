...
pub struct EntitiesRulesPresenceInner {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "rule")]
    pub rule: String,
...
impl EntitiesRulesPresenceInner {
    pub fn new(id: String, rule: String, kind: String) -> EntitiesRulesPresenceInner {
        EntitiesRulesPresenceInner {
            id,
            rule,
            kind,
        }
