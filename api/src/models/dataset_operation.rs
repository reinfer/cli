...
/// DatasetOperation : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum DatasetOperation {
    #[serde(rename = "fork_taxonomy_destination")]
    ForkTaxonomyDestination,
    #[serde(rename = "fork_taxonomy_origin")]
    ForkTaxonomyOrigin,
    #[serde(rename = "reset_annotations_to_model_version")]
    ResetAnnotationsToModelVersion,
    #[serde(rename = "clean_up_entity_captures")]
    CleanUpEntityCaptures,

}

impl std::fmt::Display for DatasetOperation {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::ForkTaxonomyDestination => write!(f, "fork_taxonomy_destination"),
            Self::ForkTaxonomyOrigin => write!(f, "fork_taxonomy_origin"),
            Self::ResetAnnotationsToModelVersion => write!(f, "reset_annotations_to_model_version"),
            Self::CleanUpEntityCaptures => write!(f, "clean_up_entity_captures"),
        }
    }
}

impl Default for DatasetOperation {
    fn default() -> DatasetOperation {
        Self::ForkTaxonomyDestination
    }
}
