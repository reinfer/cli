...
pub struct FieldGroupPredictionPrivate {
    #[serde(rename = "name")]
    pub name: String,
    ...
    #[serde(rename = "fields")]
    pub fields: Vec<models::FieldPredictionPrivate>,
}

impl FieldGroupPredictionPrivate {
    pub fn new(name: String, occurrence_confidence: models::IxpConfidence, extraction_confidence: models::IxpConfidence, fields: Vec<models::FieldPredictionPrivate>) -> FieldGroupPredictionPrivate {
        FieldGroupPredictionPrivate {
            name,
            id: None,
