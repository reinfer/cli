...
/// FieldGroupVersionEntry : A single version entry in field group history
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct FieldGroupVersionEntry {
    ...
    /// Snapshot of the field group at this version
    #[serde(rename = "snapshot")]
    pub snapshot: Box<models::FieldGroupSnapshot>,
}

impl FieldGroupVersionEntry {
    /// A single version entry in field group history
    pub fn new(model_version: i32, timestamp: String, snapshot: models::FieldGroupSnapshot) -> FieldGroupVersionEntry {
        FieldGroupVersionEntry {
            model_version,
            timestamp,
