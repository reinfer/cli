...
pub struct CreateOrUpdateLabelDefsBulkRequestLabelDefsInner {
    #[serde(rename = "name")]
    pub name: String,
    ...
    #[serde(rename = "pretrained", skip_serializing_if = "Option::is_none")]
    pub pretrained: Option<Box<models::BuiltinLabelDefRequest>>,
...
impl CreateOrUpdateLabelDefsBulkRequestLabelDefsInner {
    pub fn new(name: String) -> CreateOrUpdateLabelDefsBulkRequestLabelDefsInner {
