...
pub struct Issue {
    #[serde(rename = "id")]
    pub id: String,
    /// The alert this issue is from.
    #[serde(rename = "alert_id")]
    pub alert_id: String,
    /// Issue details
    #[serde(rename = "detail")]
    pub detail: Box<models::IssueDetail>,
    /// Issue status
    #[serde(rename = "status")]
    pub status: models::IssueStatus,
}

impl Issue {
    pub fn new(id: String, alert_id: String, detail: models::IssueDetail, status: models::IssueStatus) -> Issue {
        Issue {
            id,
            alert_id,
