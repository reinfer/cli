...
pub struct FieldGroupAnnotationPrivate {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(rename = "fields")]
    pub fields: Vec<models::FieldAnnotationPrivate>,
}

impl FieldGroupAnnotationPrivate {
    pub fn new(name: String, fields: Vec<models::FieldAnnotationPrivate>) -> FieldGroupAnnotationPrivate {
