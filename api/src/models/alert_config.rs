...
pub struct AlertConfig {
    #[serde(rename = "kind")]
    pub kind: models::AlertConfigKind,
    #[serde(rename = "filter")]
    pub filter: Box<models::AlertFilter>,
    #[serde(rename = "metric")]
    pub metric: models::AlertMetric,
    #[serde(rename = "period")]
    pub period: Box<models::Period>,
    #[serde(rename = "process")]
    pub process: Box<models::Process>,
}

impl AlertConfig {
    pub fn new(kind: models::AlertConfigKind, filter: models::AlertFilter, metric: models::AlertMetric, period: models::Period, process: models::Process) -> AlertConfig {
        AlertConfig {
            kind,
