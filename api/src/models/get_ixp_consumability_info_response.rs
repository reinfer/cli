...
pub struct GetIxpConsumabilityInfoResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "can_consume_runtime")]
    pub can_consume_runtime: bool,
    #[serde(rename = "can_consume_designtime")]
    pub can_consume_designtime: bool,
}

impl GetIxpConsumabilityInfoResponse {
    pub fn new(status: Status, can_consume_runtime: bool, can_consume_designtime: bool) -> GetIxpConsumabilityInfoResponse {
        GetIxpConsumabilityInfoResponse {
            status,
            can_consume_runtime,
            can_consume_designtime,
        }
    }
}
