...
pub struct StreamExtractionFieldPrediction {
    #[serde(rename = "name")]
    pub name: String,
...
impl StreamExtractionFieldPrediction {
    pub fn new(name: String, value: Option<models::StreamFieldValue>, text_spans: Vec<models::StreamTextSpan>) -> StreamExtractionFieldPrediction {
        StreamExtractionFieldPrediction {
            name,
