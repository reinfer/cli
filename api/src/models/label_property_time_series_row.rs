...
pub struct LabelPropertyTimeSeriesRow {
...
impl LabelPropertyTimeSeriesRow {
    pub fn new(timestamp_str: String, sums: Vec<f64>) -> LabelPropertyTimeSeriesRow {
        LabelPropertyTimeSeriesRow {
            timestamp_str,
            sums,
        }
    }
