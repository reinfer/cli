...
pub struct Translation {
    ...
    /// The time when the message was sent originally
    ...
    #[serde(rename = "body")]
    pub body: Box<models::MessageRichText>,
    /// The subject of the message
    #[serde(rename = "subject", skip_serializing_if = "Option::is_none")]
    pub subject: Option<Box<models::MessageText>>,
    /// The signature of the message
    #[serde(rename = "signature", skip_serializing_if = "Option::is_none")]
    pub signature: Option<Box<models::MessageRichText>>,
}

impl Translation {
    pub fn new(body: models::MessageRichText) -> Translation {
        Translation {
            from: None,
            to: None,
            cc: None,
