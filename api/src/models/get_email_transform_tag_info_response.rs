...
pub struct GetEmailTransformTagInfoResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "email_transform_tag_info")]
    pub email_transform_tag_info: Box<models::EmailTransformTagInfo>,
}

impl GetEmailTransformTagInfoResponse {
    pub fn new(status: Status, email_transform_tag_info: models::EmailTransformTagInfo) -> GetEmailTransformTagInfoResponse {
        GetEmailTransformTagInfoResponse {
            status,
            email_transform_tag_info: Box::new(email_transform_tag_info),
        }
    }
}
