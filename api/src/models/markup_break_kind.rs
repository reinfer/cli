...
/// MarkupBreakKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum MarkupBreakKind {
    #[serde(rename = "br")]
    Br,
    #[serde(rename = "hr")]
    Hr,
...
impl std::fmt::Display for MarkupBreakKind {
...
impl Default for MarkupBreakKind {
    fn default() -> MarkupBreakKind {
        Self::Br
    }
}
