...
pub struct EntityDefSummary {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "health", skip_serializing_if = "Option::is_none")]
    pub health: Option<Box<models::EntityHealth>>,
    /// Total number of assigned entities (with no filter) of this type in the dataset
    #[serde(rename = "unfiltered_assigned")]
    pub unfiltered_assigned: i32,
}

impl EntityDefSummary {
    pub fn new(id: String, unfiltered_assigned: i32) -> EntityDefSummary {
        EntityDefSummary {
            id,
            health: None,
            unfiltered_assigned,
