...
/// LabelDefFlag : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum LabelDefFlag {
    #[serde(rename = "llm_generated")]
    LlmGenerated,

}

impl std::fmt::Display for LabelDefFlag {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::LlmGenerated => write!(f, "llm_generated"),
        }
    }
}

impl Default for LabelDefFlag {
    fn default() -> LabelDefFlag {
        Self::LlmGenerated
    }
}
