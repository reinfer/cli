...
pub struct SyncCommentsFromCsvResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "updated")]
    pub updated: i32,
    #[serde(rename = "updated_properties_only")]
    pub updated_properties_only: i32,
    #[serde(rename = "updated_text_changed")]
    pub updated_text_changed: i32,
...
impl SyncCommentsFromCsvResponse {
    pub fn new(status: Status, updated: i32, updated_properties_only: i32, updated_text_changed: i32, unchanged: i32, new: i32) -> SyncCommentsFromCsvResponse {
        SyncCommentsFromCsvResponse {
            status,
            updated,
            updated_properties_only,
            updated_text_changed,
            unchanged,
            new,
        }
    }
