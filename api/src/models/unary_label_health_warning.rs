...
pub struct UnaryLabelHealthWarning {
    #[serde(rename = "kind")]
    pub kind: models::UnaryLabelHealthWarningKind,
}

impl UnaryLabelHealthWarning {
    pub fn new(kind: models::UnaryLabelHealthWarningKind) -> UnaryLabelHealthWarning {
        UnaryLabelHealthWarning {
            kind,
        }
    }
}
