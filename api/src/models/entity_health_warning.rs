...
pub struct EntityHealthWarning {
    #[serde(rename = "kind")]
    pub kind: models::EntityHealthWarningKind,
}

impl EntityHealthWarning {
    pub fn new(kind: models::EntityHealthWarningKind) -> EntityHealthWarning {
        EntityHealthWarning {
            kind,
        }
    }
