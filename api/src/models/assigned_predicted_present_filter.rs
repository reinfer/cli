...
pub struct AssignedPredictedPresentFilter {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "any_assigned")]
    pub any_assigned: Vec<String>,
    #[serde(rename = "any_predicted")]
    pub any_predicted: Vec<String>,
    #[serde(rename = "none_present")]
    pub none_present: Vec<String>,
}

impl AssignedPredictedPresentFilter {
    pub fn new(kind: Kind, any_assigned: Vec<String>, any_predicted: Vec<String>, none_present: Vec<String>) -> AssignedPredictedPresentFilter {
        AssignedPredictedPresentFilter {
            kind,
            any_assigned,
            any_predicted,
            none_present,
...
pub enum Kind {
    #[serde(rename = "assigned_predicted_present")]
    AssignedPredictedPresent,
}

impl Default for Kind {
    fn default() -> Kind {
        Self::AssignedPredictedPresent
    }
}
