...
pub struct MoonFormGroup {
    #[serde(rename = "group")]
    pub group: String,
    #[serde(rename = "assigned")]
    pub assigned: Vec<models::MoonFormLabelAnnotation>,
    #[serde(rename = "dismissed")]
    pub dismissed: Vec<models::MoonFormLabelAnnotation>,
    #[serde(rename = "predicted", skip_serializing_if = "Option::is_none")]
    pub predicted: Option<Vec<models::MoonFormLabelPrediction>>,
    #[serde(rename = "drafted", skip_serializing_if = "Option::is_none")]
    pub drafted: Option<Vec<models::MoonFormLabelAnnotation>>,
    #[serde(rename = "raw_generation", skip_serializing_if = "Option::is_none")]
    pub raw_generation: Option<String>,
    #[serde(rename = "model_errors")]
    pub model_errors: Vec<models::ModelError>,
}

impl MoonFormGroup {
    pub fn new(group: String, assigned: Vec<models::MoonFormLabelAnnotation>, dismissed: Vec<models::MoonFormLabelAnnotation>, model_errors: Vec<models::ModelError>) -> MoonFormGroup {
        MoonFormGroup {
            group,
            assigned,
            dismissed,
