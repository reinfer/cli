...
/// AttributeFilterAttribute : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum AttributeFilterAttribute {
    #[serde(rename = "labels")]
    Labels,
    #[serde(rename = "entities")]
    Entities,
    #[serde(rename = "attachment_property_num_attachments")]
    AttachmentPropertyNumAttachments,
    #[serde(rename = "attachment_property_num_attachments_with_contents")]
    AttachmentPropertyNumAttachmentsWithContents,
    #[serde(rename = "attachment_property_num_attachments_without_contents")]
    AttachmentPropertyNumAttachmentsWithoutContents,
    #[serde(rename = "attachment_property_types")]
    AttachmentPropertyTypes,
    #[serde(rename = "attachment_property_names")]
    AttachmentPropertyNames,
    #[serde(rename = "attachment_property_extensions")]
    AttachmentPropertyExtensions,
    #[serde(rename = "attachment_property_size")]
    AttachmentPropertySize,
    #[serde(rename = "attachment_property_total_size")]
    AttachmentPropertyTotalSize,

}

impl std::fmt::Display for AttributeFilterAttribute {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Labels => write!(f, "labels"),
            Self::Entities => write!(f, "entities"),
            Self::AttachmentPropertyNumAttachments => write!(f, "attachment_property_num_attachments"),
            Self::AttachmentPropertyNumAttachmentsWithContents => write!(f, "attachment_property_num_attachments_with_contents"),
            Self::AttachmentPropertyNumAttachmentsWithoutContents => write!(f, "attachment_property_num_attachments_without_contents"),
            Self::AttachmentPropertyTypes => write!(f, "attachment_property_types"),
            Self::AttachmentPropertyNames => write!(f, "attachment_property_names"),
            Self::AttachmentPropertyExtensions => write!(f, "attachment_property_extensions"),
            Self::AttachmentPropertySize => write!(f, "attachment_property_size"),
            Self::AttachmentPropertyTotalSize => write!(f, "attachment_property_total_size"),
        }
    }
}

impl Default for AttributeFilterAttribute {
    fn default() -> AttributeFilterAttribute {
        Self::Labels
    }
}
