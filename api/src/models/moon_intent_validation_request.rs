...
pub struct MoonIntentValidationRequest {
    #[serde(rename = "intent_threshold")]
    pub intent_threshold: Box<models::IntentThreshold>,
    #[serde(rename = "capture_threshold")]
    pub capture_threshold: Box<models::CaptureThreshold>,
}

impl MoonIntentValidationRequest {
    pub fn new(intent_threshold: models::IntentThreshold, capture_threshold: models::CaptureThreshold) -> MoonIntentValidationRequest {
        MoonIntentValidationRequest {
            intent_threshold: Box::new(intent_threshold),
            capture_threshold: Box::new(capture_threshold),
        }
    }
}
