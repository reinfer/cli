...
pub struct EntityHealthSmart {
    #[serde(rename = "score")]
    pub score: f64,
    #[serde(rename = "warnings")]
    pub warnings: Vec<models::EntityHealthWarning>,
    #[serde(rename = "actions")]
    pub actions: Vec<models::EntityHealthAction>,
}

impl EntityHealthSmart {
    pub fn new(score: f64, warnings: Vec<models::EntityHealthWarning>, actions: Vec<models::EntityHealthAction>) -> EntityHealthSmart {
        EntityHealthSmart {
            score,
            warnings,
            actions,
