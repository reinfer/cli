...
pub struct GetDatasetSummaryResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "summary")]
    pub summary: Box<models::DatasetSummary>,
}

impl GetDatasetSummaryResponse {
    pub fn new(status: Status, summary: models::DatasetSummary) -> GetDatasetSummaryResponse {
