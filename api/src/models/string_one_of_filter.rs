...
pub struct StringOneOfFilter {
    /// A list of string values for which the filter should apply
    #[serde(rename = "one_of", skip_serializing_if = "Option::is_none")]
    pub one_of: Option<Vec<String>>,
    /// A list of string values for which the filter should not apply
...
impl StringOneOfFilter {
    pub fn new() -> StringOneOfFilter {
        StringOneOfFilter {
            one_of: None,
            not_one_of: None,
