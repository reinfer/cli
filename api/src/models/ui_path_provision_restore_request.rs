...
pub struct UiPathProvisionRestoreRequest {
...
impl UiPathProvisionRestoreRequest {
    pub fn new(callback_url: Option<String>, status: models::UiPathTenantServiceStatus, organization_id: String) -> UiPathProvisionRestoreRequest {
        UiPathProvisionRestoreRequest {
            callback_url,
            status,
            organization_id,
        }
