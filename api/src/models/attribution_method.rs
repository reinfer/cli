...
/// AttributionMethod : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum AttributionMethod {
    #[serde(rename = "table_heuristic")]
    TableHeuristic,
    #[serde(rename = "word_ids")]
    WordIds,
...
impl std::fmt::Display for AttributionMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::TableHeuristic => write!(f, "table_heuristic"),
            Self::WordIds => write!(f, "word_ids"),
        }
    }
}

impl Default for AttributionMethod {
    fn default() -> AttributionMethod {
        Self::TableHeuristic
    }
}
