...
pub struct GetThreadThemesRequest {
    /// ID of the source containing the comment
    #[serde(rename = "source_id")]
    pub source_id: String,
    /// ID of thread in external system
    #[serde(rename = "thread_id")]
    pub thread_id: String,
}

impl GetThreadThemesRequest {
    pub fn new(source_id: String, thread_id: String) -> GetThreadThemesRequest {
        GetThreadThemesRequest {
            source_id,
            thread_id,
        }
    }
