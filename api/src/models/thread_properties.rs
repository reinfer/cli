...
pub struct ThreadProperties {
    ...
    #[serde(rename = "response_time", deserialize_with = "Option::deserialize")]
    pub response_time: Option<f64>,
    #[serde(rename = "num_messages")]
    pub num_messages: i32,
    #[serde(rename = "num_participants")]
    pub num_participants: i32,
    #[serde(rename = "first_sender", deserialize_with = "Option::deserialize")]
    pub first_sender: Option<String>,
    #[serde(rename = "thread_position", skip_serializing_if = "Option::is_none")]
    pub thread_position: Option<i32>,
}

impl ThreadProperties {
    pub fn new(duration: Option<f64>, response_time: Option<f64>, num_messages: i32, num_participants: i32, first_sender: Option<String>) -> ThreadProperties {
        ThreadProperties {
            duration,
            response_time,
            num_messages,
