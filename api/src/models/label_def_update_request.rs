...
/// LabelDefUpdateRequest : Request to update a label def in a dataset
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LabelDefUpdateRequest {
    #[serde(rename = "label")]
    pub label: Box<models::LabelDefUpdate>,
}

impl LabelDefUpdateRequest {
    /// Request to update a label def in a dataset
    pub fn new(label: models::LabelDefUpdate) -> LabelDefUpdateRequest {
