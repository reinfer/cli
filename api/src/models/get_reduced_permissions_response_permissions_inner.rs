...
pub struct GetReducedPermissionsResponsePermissionsInner {
}

impl GetReducedPermissionsResponsePermissionsInner {
    pub fn new() -> GetReducedPermissionsResponsePermissionsInner {
