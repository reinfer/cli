...
pub struct GetAllLabelGroupsResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetAllLabelGroupsResponse {
    pub fn new(status: Status, label_groups: Vec<models::LabelGroup>) -> GetAllLabelGroupsResponse {
        GetAllLabelGroupsResponse {
            status,
            label_groups,
        }
    }
