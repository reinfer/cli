...
pub struct GetBucketSyncStateResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "bucket_sync_state")]
    pub bucket_sync_state: Box<models::BucketSyncState>,
}

impl GetBucketSyncStateResponse {
    pub fn new(status: Status, bucket_sync_state: models::BucketSyncState) -> GetBucketSyncStateResponse {
        GetBucketSyncStateResponse {
            status,
            bucket_sync_state: Box::new(bucket_sync_state),
        }
    }
}
