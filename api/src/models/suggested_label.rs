...
pub struct SuggestedLabel {
    ...
    pub sentiment: models::LabelSentiment,
    /// The instructions of the suggested label, if available.
    #[serde(rename = "instructions", skip_serializing_if = "Option::is_none")]
    pub instructions: Option<String>,
}

impl SuggestedLabel {
    pub fn new(name: String, sentiment: models::LabelSentiment) -> SuggestedLabel {
        SuggestedLabel {
            name,
            sentiment,
            instructions: None,
