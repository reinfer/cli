...
pub struct IxpUploadDocumentResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "document")]
    pub document: Box<models::IxpUploadedDocument>,
}

impl IxpUploadDocumentResponse {
    pub fn new(status: Status, document: models::IxpUploadedDocument) -> IxpUploadDocumentResponse {
        IxpUploadDocumentResponse {
            status,
