...
pub struct TenantNew {
    ...
    /// Associate this tenant with a UiPath tenant.
    #[serde(rename = "uipath_context", skip_serializing_if = "Option::is_none")]
    pub uipath_context: Option<Box<models::FieldUipathContextModel>>,
    /// Support ID/Licence Code that links user with UiPath support
    #[serde(rename = "uipath_support_id", skip_serializing_if = "Option::is_none")]
    pub uipath_support_id: Option<String>,
}

impl TenantNew {
    pub fn new() -> TenantNew {
        TenantNew {
            title: None,
            description: None,
            uipath_context: None,
            uipath_support_id: None,
        }
    }
}
