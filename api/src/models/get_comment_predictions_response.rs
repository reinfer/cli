...
pub struct GetCommentPredictionsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "predictions")]
    pub predictions: Vec<models::CommentPrediction>,
    #[serde(rename = "model", deserialize_with = "Option::deserialize")]
    pub model: Option<Box<models::PredictionsModel>>,
}

impl GetCommentPredictionsResponse {
    pub fn new(status: Status, predictions: Vec<models::CommentPrediction>, model: Option<models::PredictionsModel>) -> GetCommentPredictionsResponse {
