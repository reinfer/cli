...
pub struct GetAllDashboardsInDatasetResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetAllDashboardsInDatasetResponse {
    pub fn new(status: Status, dashboards: Vec<models::Dashboard>, default: Option<String>) -> GetAllDashboardsInDatasetResponse {
