...
pub struct StreamCommentExtractionsResult {
    #[serde(rename = "comment")]
    pub comment: Box<models::Comment>,
    #[serde(rename = "predictions")]
    pub predictions: Vec<models::GroupPredictions>,
    #[serde(rename = "sequence_id")]
    pub sequence_id: String,
}

impl StreamCommentExtractionsResult {
    pub fn new(comment: models::Comment, predictions: Vec<models::GroupPredictions>, sequence_id: String) -> StreamCommentExtractionsResult {
        StreamCommentExtractionsResult {
