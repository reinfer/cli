...
/// KeyedMailboxSyncState : Sync state for an entire mailbox (not folder-specific).
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct KeyedMailboxSyncState {
...
impl KeyedMailboxSyncState {
    /// Sync state for an entire mailbox (not folder-specific).
    pub fn new(mailbox_name: String, status: models::SyncStatus, last_synced_at: String) -> KeyedMailboxSyncState {
