...
pub struct GetAllStreamsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "streams")]
    pub streams: Vec<models::Trigger>,
}

impl GetAllStreamsResponse {
    pub fn new(status: Status, streams: Vec<models::Trigger>) -> GetAllStreamsResponse {
