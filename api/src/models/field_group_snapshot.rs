...
/// FieldGroupSnapshot : Snapshot of a field group at a specific model version
...
pub struct FieldGroupSnapshot {
    ...
    /// List of field IDs in this field group
    #[serde(rename = "field_ids")]
    pub field_ids: Vec<String>,
}

impl FieldGroupSnapshot {
    /// Snapshot of a field group at a specific model version
    pub fn new(name: String, field_ids: Vec<String>) -> FieldGroupSnapshot {
        FieldGroupSnapshot {
            name,
            instructions: None,
            field_ids,
