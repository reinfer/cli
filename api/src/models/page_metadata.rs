...
pub struct PageMetadata {
    #[serde(rename = "thumbnail_size")]
    pub thumbnail_size: Box<models::PageDimensions>,
    #[serde(rename = "full_size")]
    pub full_size: Box<models::PageDimensions>,
}

impl PageMetadata {
    pub fn new(thumbnail_size: models::PageDimensions, full_size: models::PageDimensions) -> PageMetadata {
        PageMetadata {
            thumbnail_size: Box::new(thumbnail_size),
            full_size: Box::new(full_size),
        }
    }
}
