...
pub struct GetBucketStatisticsResponse {
    ...
    pub statistics: Box<models::BucketStatistics>,
}

impl GetBucketStatisticsResponse {
    pub fn new(status: Status, statistics: models::BucketStatistics) -> GetBucketStatisticsResponse {
