...
pub struct TaggedIxpModelVersion {
...
impl TaggedIxpModelVersion {
    pub fn new(tag_name: String, version: i32, updated_at: Option<String>) -> TaggedIxpModelVersion {
        TaggedIxpModelVersion {
            tag_name,
            version,
            updated_at,
        }
