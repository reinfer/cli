...
pub struct DocumentLabelPropertyPrediction {
    #[serde(rename = "property_id")]
    pub property_id: String,
    #[serde(rename = "property_name")]
    pub property_name: models::LabelPropertyName,
    #[serde(rename = "value")]
    pub value: f64,
}

impl DocumentLabelPropertyPrediction {
    pub fn new(property_id: String, property_name: models::LabelPropertyName, value: f64) -> DocumentLabelPropertyPrediction {
        DocumentLabelPropertyPrediction {
            property_id,
            property_name,
            value,
        }
