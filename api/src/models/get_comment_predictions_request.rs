...
pub struct GetCommentPredictionsRequest {
    /// List of comment uids to get predictions for
    #[serde(rename = "uids")]
    pub uids: Vec<String>,
    #[serde(rename = "threshold", skip_serializing_if = "Option::is_none")]
    pub threshold: Option<Box<models::Threshold1>>,
    #[serde(rename = "labels", skip_serializing_if = "Option::is_none")]
    pub labels: Option<Vec<models::TriggerLabelThreshold>>,
}

impl GetCommentPredictionsRequest {
    pub fn new(uids: Vec<String>) -> GetCommentPredictionsRequest {
