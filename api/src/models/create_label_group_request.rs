...
pub struct CreateLabelGroupRequest {
    #[serde(rename = "label_collection_name", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub label_collection_name: Option<Option<String>>,
...
impl CreateLabelGroupRequest {
    pub fn new() -> CreateLabelGroupRequest {
