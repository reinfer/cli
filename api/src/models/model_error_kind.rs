...
pub enum ModelErrorKind {
    ...
    #[serde(rename = "FORBIDDEN_BY_GOVERNANCE_POLICY")]
    ForbiddenByGovernancePolicy,
...
impl std::fmt::Display for ModelErrorKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::ContentPolicyViolation => write!(f, "CONTENT_POLICY_VIOLATION"),
            Self::ForbiddenByGovernancePolicy => write!(f, "FORBIDDEN_BY_GOVERNANCE_POLICY"),
        }
    }
}

impl Default for ModelErrorKind {
    fn default() -> ModelErrorKind {
        Self::Unknown
    }
}
