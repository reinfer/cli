...
pub struct MessageRichText {
    /// Text content of the message part
    #[serde(rename = "text")]
    pub text: String,
    /// The original language from which the message was translated, if applicable
    #[serde(rename = "translated_from", skip_serializing_if = "Option::is_none")]
    pub translated_from: Option<String>,
    /// Markup content of the message part
    #[serde(rename = "text_markup", skip_serializing_if = "Option::is_none")]
    pub text_markup: Option<Vec<models::MessageRichTextTextMarkupInner>>,
    /// Markup for the translated part
    #[serde(rename = "translated_from_markup", skip_serializing_if = "Option::is_none")]
    pub translated_from_markup: Option<Vec<models::MessageRichTextTextMarkupInner>>,
}

impl MessageRichText {
    pub fn new(text: String) -> MessageRichText {
        MessageRichText {
            text,
            translated_from: None,
            text_markup: None,
            translated_from_markup: None,
        }
    }
}
