...
pub struct GetTrainingActionsLabelsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "training_actions_labels")]
    pub training_actions_labels: Vec<models::GetTrainingActionsLabelsResponseTrainingActionsLabelsInner>,
}

impl GetTrainingActionsLabelsResponse {
    pub fn new(status: Status, training_actions_labels: Vec<models::GetTrainingActionsLabelsResponseTrainingActionsLabelsInner>) -> GetTrainingActionsLabelsResponse {
        GetTrainingActionsLabelsResponse {
            status,
            training_actions_labels,
        }
    }
}
