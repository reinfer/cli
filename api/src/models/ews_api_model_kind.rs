...
/// EwsApiModelKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum EwsApiModelKind {
    #[serde(rename = "ews")]
    Ews,

}

impl std::fmt::Display for EwsApiModelKind {
...
impl Default for EwsApiModelKind {
    fn default() -> EwsApiModelKind {
        Self::Ews
    }
}
