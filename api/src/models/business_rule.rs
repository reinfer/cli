...
pub struct BusinessRule {
    ...
    pub name: String,
    #[serde(rename = "type")]
    pub r#type: models::BusinessRuleType,
    #[serde(rename = "logical_operator")]
    pub logical_operator: models::BusinessRuleLogicalOperator,
    #[serde(rename = "expression")]
    pub expression: String,
    #[serde(rename = "comparison_operator")]
    pub comparison_operator: models::BusinessRuleComparisonOperator,
    #[serde(rename = "set_values")]
    pub set_values: Vec<String>,
}

impl BusinessRule {
    pub fn new(name: String, r#type: models::BusinessRuleType, logical_operator: models::BusinessRuleLogicalOperator, expression: String, comparison_operator: models::BusinessRuleComparisonOperator, set_values: Vec<String>) -> BusinessRule {
        BusinessRule {
            name,
            r#type,
            logical_operator,
