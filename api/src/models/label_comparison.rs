...
pub struct LabelComparison {
    ...
    pub significance: Box<models::Significance>,
}

impl LabelComparison {
    pub fn new(positive: Vec<f64>, negative: Vec<f64>, significance: models::Significance) -> LabelComparison {
        LabelComparison {
            positive,
            negative,
            significance: Box::new(significance),
        }
    }
}
