...
pub struct OAuth2SalesforceCallbackRequest {
    /// State
    #[serde(rename = "state")]
    pub state: String,
    /// Code
...
impl OAuth2SalesforceCallbackRequest {
    pub fn new(state: String, code: String) -> OAuth2SalesforceCallbackRequest {
        OAuth2SalesforceCallbackRequest {
            state,
            code,
        }
    }
