...
pub struct ResetAnnotationsToPreviousPinnedModelRequest {
    /// Model version to reset to
    #[serde(rename = "model_version")]
    pub model_version: i32,
}

impl ResetAnnotationsToPreviousPinnedModelRequest {
    pub fn new(model_version: i32) -> ResetAnnotationsToPreviousPinnedModelRequest {
