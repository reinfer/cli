...
pub struct CreateDatasetResponse {
    ...
    #[serde(rename = "num_copied", skip_serializing_if = "Option::is_none")]
    pub num_copied: Option<i32>,
}

impl CreateDatasetResponse {
    pub fn new(status: Status, dataset: models::Dataset) -> CreateDatasetResponse {
