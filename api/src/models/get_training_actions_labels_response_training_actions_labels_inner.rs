...
pub struct GetTrainingActionsLabelsResponseTrainingActionsLabelsInner {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "plan")]
    pub plan: Box<models::LabelAction>,
    #[serde(rename = "factor_kind")]
    pub factor_kind: models::ModelRatingFactorKind,
    #[serde(rename = "quality")]
    pub quality: models::DatasetQuality,
    #[serde(rename = "sub_kind")]
    pub sub_kind: String,
    #[serde(rename = "search_term", skip_serializing_if = "Option::is_none")]
    pub search_term: Option<String>,
}

impl GetTrainingActionsLabelsResponseTrainingActionsLabelsInner {
    pub fn new(id: String, kind: Kind, plan: models::LabelAction, factor_kind: models::ModelRatingFactorKind, quality: models::DatasetQuality, sub_kind: String) -> GetTrainingActionsLabelsResponseTrainingActionsLabelsInner {
        GetTrainingActionsLabelsResponseTrainingActionsLabelsInner {
            id,
            kind,
            plan: Box::new(plan),
            factor_kind,
