...
pub struct UpdateTenantEntityDefIdsResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl UpdateTenantEntityDefIdsResponse {
    pub fn new(status: Status, entity_def_ids: Vec<String>) -> UpdateTenantEntityDefIdsResponse {
