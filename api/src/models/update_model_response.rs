...
pub struct UpdateModelResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "labeller")]
    pub labeller: Box<models::UserModelMetadata>,
}

impl UpdateModelResponse {
    pub fn new(status: Status, labeller: models::UserModelMetadata) -> UpdateModelResponse {
        UpdateModelResponse {
            status,
            labeller: Box::new(labeller),
        }
    }
}
