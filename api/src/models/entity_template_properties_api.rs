...
pub struct EntityTemplatePropertiesApi {
...
impl EntityTemplatePropertiesApi {
    pub fn new(template: String, pattern: String) -> EntityTemplatePropertiesApi {
        EntityTemplatePropertiesApi {
            template,
            pattern,
        }
    }
