...
pub struct QueryCommentsOrderAttachmentTextSearch {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "query")]
    pub query: String,
...
impl QueryCommentsOrderAttachmentTextSearch {
    pub fn new(kind: Kind, query: String) -> QueryCommentsOrderAttachmentTextSearch {
