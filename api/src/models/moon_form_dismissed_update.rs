...
pub struct MoonFormDismissedUpdate {
    ...
    pub captures: Option<Vec<models::MoonFormLabelAnnotationUpdate>>,
    #[serde(rename = "entities")]
    pub entities: Vec<models::MoonFormFieldAnnotationNew>,
    #[serde(rename = "labels")]
    pub labels: Vec<models::Label>,
}

impl MoonFormDismissedUpdate {
    pub fn new(entities: Vec<models::MoonFormFieldAnnotationNew>, labels: Vec<models::Label>) -> MoonFormDismissedUpdate {
        MoonFormDismissedUpdate {
            captures: None,
            entities,
            labels,
        }
