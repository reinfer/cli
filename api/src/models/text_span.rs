...
/// TextSpan : Definition of a text span that is returned
...
impl TextSpan {
    /// Definition of a text span that is returned
    pub fn new(content_part: models::ContentPart, message_index: i32, utf16_byte_start: i32, utf16_byte_end: i32, char_start: i32, char_end: i32) -> TextSpan {
        TextSpan {
            content_part,
            message_index,
            utf16_byte_start,
