...
pub struct Coocurrence {
    #[serde(rename = "row_major_matrix")]
    pub row_major_matrix: Vec<f64>,
    #[serde(rename = "label_indices")]
    pub label_indices: Vec<i32>,
}

impl Coocurrence {
    pub fn new(row_major_matrix: Vec<f64>, label_indices: Vec<i32>) -> Coocurrence {
        Coocurrence {
            row_major_matrix,
            label_indices,
        }
