...
pub struct GetLabelValidationResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "label_validation")]
    pub label_validation: Box<models::LabelMetrics>,
    #[serde(rename = "moon_validation", skip_serializing_if = "Option::is_none")]
    pub moon_validation: Option<Box<models::MoonValidation>>,
}

impl GetLabelValidationResponse {
    pub fn new(status: Status, label_validation: models::LabelMetrics) -> GetLabelValidationResponse {
        GetLabelValidationResponse {
            status,
            label_validation: Box::new(label_validation),
            moon_validation: None,
        }
    }
}
