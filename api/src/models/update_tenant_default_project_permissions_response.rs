...
pub struct UpdateTenantDefaultProjectPermissionsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "default_project_permissions")]
    pub default_project_permissions: Vec<models::ProjectPermission>,
}

impl UpdateTenantDefaultProjectPermissionsResponse {
    pub fn new(status: Status, default_project_permissions: Vec<models::ProjectPermission>) -> UpdateTenantDefaultProjectPermissionsResponse {
        UpdateTenantDefaultProjectPermissionsResponse {
            status,
