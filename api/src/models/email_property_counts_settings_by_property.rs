...
pub struct EmailPropertyCountsSettingsByProperty {
    #[serde(rename = "to", skip_serializing_if = "Option::is_none")]
    pub to: Option<Box<models::EmailPropertyCounts>>,
    #[serde(rename = "cc", skip_serializing_if = "Option::is_none")]
    pub cc: Option<Box<models::EmailPropertyCounts>>,
    #[serde(rename = "bcc", skip_serializing_if = "Option::is_none")]
    pub bcc: Option<Box<models::EmailPropertyCounts>>,
    #[serde(rename = "sender", skip_serializing_if = "Option::is_none")]
    pub sender: Option<Box<models::EmailPropertyCounts>>,
    #[serde(rename = "recipient", skip_serializing_if = "Option::is_none")]
    pub recipient: Option<Box<models::EmailPropertyCounts>>,
    #[serde(rename = "recipient_domain", skip_serializing_if = "Option::is_none")]
    pub recipient_domain: Option<Box<models::EmailPropertyCounts>>,
    #[serde(rename = "sender_domain", skip_serializing_if = "Option::is_none")]
    pub sender_domain: Option<Box<models::EmailPropertyCounts>>,
    #[serde(rename = "recipient_organisation", skip_serializing_if = "Option::is_none")]
    pub recipient_organisation: Option<Box<models::EmailPropertyCounts>>,
    #[serde(rename = "sender_organisation", skip_serializing_if = "Option::is_none")]
    pub sender_organisation: Option<Box<models::EmailPropertyCounts>>,
}

impl EmailPropertyCountsSettingsByProperty {
    pub fn new() -> EmailPropertyCountsSettingsByProperty {
