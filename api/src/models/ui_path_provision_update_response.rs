...
pub struct UiPathProvisionUpdateResponse {
...
impl UiPathProvisionUpdateResponse {
    pub fn new(tenant_id: String, service_type: String, status: models::UiPathTenantServiceStatus) -> UiPathProvisionUpdateResponse {
