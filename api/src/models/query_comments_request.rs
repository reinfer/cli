...
pub struct QueryCommentsRequest {
    ...
    #[serde(rename = "collapse_mode", skip_serializing_if = "Option::is_none")]
    pub collapse_mode: Option<CollapseMode>,
...
impl QueryCommentsRequest {
    pub fn new(order: models::Order) -> QueryCommentsRequest {
