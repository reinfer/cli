...
pub struct StreamCommentResult {
    #[serde(rename = "comment")]
    pub comment: Box<models::Comment>,
    #[serde(rename = "sequence_id")]
    pub sequence_id: String,
    #[serde(rename = "labels", skip_serializing_if = "Option::is_none")]
    pub labels: Option<Vec<models::PredictedLabel>>,
    ...
    pub label_properties: Option<Vec<models::DocumentLabelPropertyPrediction>>,
}

impl StreamCommentResult {
    pub fn new(comment: models::Comment, sequence_id: String) -> StreamCommentResult {
        StreamCommentResult {
