...
pub struct EntityDefUpdate {
    ...
    pub inherits_from: Vec<models::EntityDefUpdateInheritsFromInner>,
    #[serde(rename = "trainable")]
    pub trainable: bool,
    #[serde(rename = "rules", skip_serializing_if = "Option::is_none")]
    pub rules: Option<Box<models::EntityRuleSetUpdateApi>>,
...
impl EntityDefUpdate {
    pub fn new(id: String, name: String, title: String, inherits_from: Vec<models::EntityDefUpdateInheritsFromInner>, trainable: bool) -> EntityDefUpdate {
        EntityDefUpdate {
            id,
            color: None,
            name,
