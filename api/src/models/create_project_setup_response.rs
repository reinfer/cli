...
pub struct CreateProjectSetupResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "created")]
    pub created: Box<models::CreateProjectSetupCreatedResponse>,
    #[serde(rename = "project")]
    pub project: Box<models::Project>,
    #[serde(rename = "source")]
    pub source: Box<models::Source>,
    #[serde(rename = "dataset")]
    pub dataset: Box<models::Dataset>,
}

impl CreateProjectSetupResponse {
    pub fn new(status: Status, created: models::CreateProjectSetupCreatedResponse, project: models::Project, source: models::Source, dataset: models::Dataset) -> CreateProjectSetupResponse {
        CreateProjectSetupResponse {
            status,
