...
pub struct ConversationalFilterResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "filter", skip_serializing_if = "Option::is_none")]
    pub filter: Option<models::CommentFilter>,
...
impl ConversationalFilterResponse {
    pub fn new(status: Status, resolved: i32, unresolved: i32, thread_mode: bool) -> ConversationalFilterResponse {
        ConversationalFilterResponse {
            status,
            filter: None,
