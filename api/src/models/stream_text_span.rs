...
pub struct StreamTextSpan {
    /// The part of the comment that contains this span.
    #[serde(rename = "content_part")]
    pub content_part: models::ContentPart,
    /// The index of the message in the comment that contains this span.
    #[serde(rename = "message_index")]
    pub message_index: i32,
    /// The start byte index of the span in UTF-16 encoding.
    #[serde(rename = "utf16_byte_start")]
    pub utf16_byte_start: i32,
    /// The end byte index of the span in UTF-16 encoding.
    #[serde(rename = "utf16_byte_end")]
    pub utf16_byte_end: i32,
}

impl StreamTextSpan {
    pub fn new(content_part: models::ContentPart, message_index: i32, utf16_byte_start: i32, utf16_byte_end: i32) -> StreamTextSpan {
        StreamTextSpan {
            content_part,
            message_index,
            utf16_byte_start,
