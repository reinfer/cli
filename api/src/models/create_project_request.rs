...
pub struct CreateProjectRequest {
    ...
    pub project: Box<models::ProjectNew>,
    #[serde(rename = "user_ids", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<String>>,
    #[serde(rename = "uipath_user_ids", skip_serializing_if = "Option::is_none")]
    pub uipath_user_ids: Option<Vec<String>>,
}

impl CreateProjectRequest {
    pub fn new(project: models::ProjectNew) -> CreateProjectRequest {
