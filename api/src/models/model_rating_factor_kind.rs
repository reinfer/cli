...
/// ModelRatingFactorKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ModelRatingFactorKind {
    #[serde(rename = "biased")]
    Biased,
    #[serde(rename = "coverage")]
    Coverage,
    #[serde(rename = "lowest_label_health")]
    LowestLabelHealth,
    #[serde(rename = "overall_label_health")]
    OverallLabelHealth,

}

impl std::fmt::Display for ModelRatingFactorKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Biased => write!(f, "biased"),
            Self::Coverage => write!(f, "coverage"),
            Self::LowestLabelHealth => write!(f, "lowest_label_health"),
            Self::OverallLabelHealth => write!(f, "overall_label_health"),
        }
    }
}

impl Default for ModelRatingFactorKind {
    fn default() -> ModelRatingFactorKind {
        Self::Biased
    }
}
