...
pub struct LabelHealthSmart {
    #[serde(rename = "score")]
    pub score: f64,
    #[serde(rename = "warnings")]
    pub warnings: Vec<models::LabelHealthWarning>,
    #[serde(rename = "actions")]
    pub actions: Vec<models::LabelHealthAction>,
}

impl LabelHealthSmart {
    pub fn new(score: f64, warnings: Vec<models::LabelHealthWarning>, actions: Vec<models::LabelHealthAction>) -> LabelHealthSmart {
        LabelHealthSmart {
            score,
            warnings,
            actions,
