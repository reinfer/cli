...
pub struct MoonFormCaptureFieldsAnnotation {
    #[serde(rename = "fields")]
    pub fields: Vec<models::MoonFormFieldAnnotation>,
}

impl MoonFormCaptureFieldsAnnotation {
    pub fn new(fields: Vec<models::MoonFormFieldAnnotation>) -> MoonFormCaptureFieldsAnnotation {
        MoonFormCaptureFieldsAnnotation {
            fields,
        }
    }
}
