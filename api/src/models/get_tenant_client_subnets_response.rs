...
pub struct GetTenantClientSubnetsResponse {
    #[serde(rename = "status")]
    pub status: Status,
...
impl GetTenantClientSubnetsResponse {
    pub fn new(status: Status, client_subnets: Vec<String>) -> GetTenantClientSubnetsResponse {
