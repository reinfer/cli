...
pub struct QueryCommentsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    ...
    pub results: Vec<models::AnnotatedComment>,
    #[serde(rename = "num_results", skip_serializing_if = "Option::is_none")]
    pub num_results: Option<Box<models::QueryResultCounts>>,
...
impl QueryCommentsResponse {
    pub fn new(status: Status, entity_defs: Vec<models::EntityDef>, results: Vec<models::AnnotatedComment>) -> QueryCommentsResponse {
