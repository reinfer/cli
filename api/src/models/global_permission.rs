...
/// GlobalPermission : An enumeration.
/// An enumeration.
...
pub enum GlobalPermission {
    ...
    ArtefactsRead,
    #[serde(rename = "support-users-write")]
    SupportUsersWrite,
    #[serde(rename = "tenant-users-read")]
    TenantUsersRead,
    #[serde(rename = "tenant-admin")]
    TenantAdmin,
    #[serde(rename = "support-tenant-admin")]
    SupportTenantAdmin,
    #[serde(rename = "feature-qos")]
    FeatureQos,
    #[serde(rename = "feature-pretrained-labels")]
    FeaturePretrainedLabels,
    #[serde(rename = "tenant-quota-read")]
    TenantQuotaRead,
    #[serde(rename = "tenant-quota-write")]
    TenantQuotaWrite,
    #[serde(rename = "deployment-quota-read")]
    DeploymentQuotaRead,
    #[serde(rename = "deployment-quota-write")]
    DeploymentQuotaWrite,
    #[serde(rename = "role-cm-tenant-admin")]
    RoleCmTenantAdmin,
    #[serde(rename = "dialog")]
    Dialog,
...
impl std::fmt::Display for GlobalPermission {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::ArtefactsRead => write!(f, "artefacts-read"),
            Self::SupportUsersWrite => write!(f, "support-users-write"),
            Self::TenantUsersRead => write!(f, "tenant-users-read"),
            Self::TenantAdmin => write!(f, "tenant-admin"),
            Self::SupportTenantAdmin => write!(f, "support-tenant-admin"),
            Self::FeatureQos => write!(f, "feature-qos"),
            Self::FeaturePretrainedLabels => write!(f, "feature-pretrained-labels"),
            Self::TenantQuotaRead => write!(f, "tenant-quota-read"),
            Self::TenantQuotaWrite => write!(f, "tenant-quota-write"),
            Self::DeploymentQuotaRead => write!(f, "deployment-quota-read"),
            Self::DeploymentQuotaWrite => write!(f, "deployment-quota-write"),
            Self::RoleCmTenantAdmin => write!(f, "role-cm-tenant-admin"),
