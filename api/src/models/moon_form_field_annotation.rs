...
pub struct MoonFormFieldAnnotation {
    ...
    #[serde(rename = "name")]
    pub name: String,
    /// Deprecated. Will be set to the first span, if there's exactly one span.
    #[serde(rename = "span", skip_serializing_if = "Option::is_none")]
    pub span: Option<Box<models::TextSpan>>,
    #[serde(rename = "spans")]
    pub spans: Vec<models::TextSpan>,
    #[serde(rename = "kind")]
    pub kind: String,
...
impl MoonFormFieldAnnotation {
    pub fn new(id: String, field_type_id: String, name: String, spans: Vec<models::TextSpan>, kind: String, formatted_value: String, field_id: String, document_spans: Vec<models::DocumentSpan>) -> MoonFormFieldAnnotation {
