...
pub struct UpdateTenantDefaultProjectPermissionsRequest {
    #[serde(rename = "default_project_permissions")]
    pub default_project_permissions: Vec<models::ProjectPermission>,
}

impl UpdateTenantDefaultProjectPermissionsRequest {
    pub fn new(default_project_permissions: Vec<models::ProjectPermission>) -> UpdateTenantDefaultProjectPermissionsRequest {
        UpdateTenantDefaultProjectPermissionsRequest {
