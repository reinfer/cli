...
pub struct StringUserPropertySummary {
    ...
    pub cardinality: i32,
    #[serde(rename = "values")]
    pub values: Vec<models::StringUserPropertyCountSingle>,
}

impl StringUserPropertySummary {
    pub fn new(full_name: String, count: i32, cardinality: i32, values: Vec<models::StringUserPropertyCountSingle>) -> StringUserPropertySummary {
        StringUserPropertySummary {
            full_name,
            count,
            cardinality,
            values,
