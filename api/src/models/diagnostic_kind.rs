...
impl std::fmt::Display for DiagnosticKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::LabelOnlyNeglect => write!(f, "label_only_neglect"),
            Self::Neglect => write!(f, "neglect"),
            Self::TeachEntity => write!(f, "teach_entity"),
            Self::MissedEntity => write!(f, "missed_entity"),
            Self::CheckEntity => write!(f, "check_entity"),
            Self::ExtractionErrorRate => write!(f, "extraction_error_rate"),
        }
    }
}
