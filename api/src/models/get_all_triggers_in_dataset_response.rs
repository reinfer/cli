...
pub struct GetAllTriggersInDatasetResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "triggers")]
    pub triggers: Vec<models::Trigger>,
}

impl GetAllTriggersInDatasetResponse {
    pub fn new(status: Status, triggers: Vec<models::Trigger>) -> GetAllTriggersInDatasetResponse {
