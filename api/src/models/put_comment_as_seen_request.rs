...
pub struct PutCommentAsSeenRequest {
    #[serde(rename = "is_with_annotation")]
    pub is_with_annotation: bool,
}

impl PutCommentAsSeenRequest {
    pub fn new(is_with_annotation: bool) -> PutCommentAsSeenRequest {
        PutCommentAsSeenRequest {
            is_with_annotation,
        }
    }
}
