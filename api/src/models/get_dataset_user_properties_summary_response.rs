...
pub struct GetDatasetUserPropertiesSummaryResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "user_properties")]
    pub user_properties: Box<models::UserPropertiesSummary>,
}

impl GetDatasetUserPropertiesSummaryResponse {
    pub fn new(status: Status, user_properties: models::UserPropertiesSummary) -> GetDatasetUserPropertiesSummaryResponse {
