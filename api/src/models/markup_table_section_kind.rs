...
/// MarkupTableSectionKind : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum MarkupTableSectionKind {
    #[serde(rename = "thead")]
    Thead,
    #[serde(rename = "tfoot")]
    Tfoot,
...
impl std::fmt::Display for MarkupTableSectionKind {
...
impl Default for MarkupTableSectionKind {
    fn default() -> MarkupTableSectionKind {
        Self::Thead
    }
}
