...
pub struct GetAllProjectsV1Response {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "projects")]
    pub projects: Vec<models::ProjectV1>,
}

impl GetAllProjectsV1Response {
    pub fn new(status: Status, projects: Vec<models::ProjectV1>) -> GetAllProjectsV1Response {
        GetAllProjectsV1Response {
            status,
            projects,
        }
    }
