...
pub struct NumberUserPropertySummary {
...
impl NumberUserPropertySummary {
    pub fn new(full_name: String, count: i32) -> NumberUserPropertySummary {
        NumberUserPropertySummary {
            full_name,
            count,
        }
    }
