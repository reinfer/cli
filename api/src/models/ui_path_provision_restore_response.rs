...
pub struct UiPathProvisionRestoreResponse {
...
impl UiPathProvisionRestoreResponse {
    pub fn new(tenant_id: String, service_type: String, status: models::UiPathTenantServiceStatus) -> UiPathProvisionRestoreResponse {
        UiPathProvisionRestoreResponse {
            tenant_id,
            service_type,
            status,
        }
