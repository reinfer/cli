...
impl Filter {
    pub fn new(kind: Kind, any_of: Vec<String>, none_of: Vec<String>, any_assigned: Vec<String>, any_predicted: Vec<String>, none_present: Vec<String>, query: String) -> Filter {
        Filter {
            kind,
            any_of,
            none_of,
