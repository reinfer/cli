...
pub struct CreateProjectSetupRequest {
    #[serde(rename = "project")]
    pub project: Box<models::ProjectSetupNewProject>,
    #[serde(rename = "source")]
    pub source: Box<models::Source1>,
    #[serde(rename = "dataset")]
    pub dataset: Box<models::ProjectSetupNewDataset>,
    #[serde(rename = "stream")]
    pub stream: Box<models::ProjectSetupNewStream>,
    #[serde(rename = "users")]
    pub users: Box<models::ProjectSetupNewUsers>,
}

impl CreateProjectSetupRequest {
    pub fn new(project: models::ProjectSetupNewProject, source: models::Source1, dataset: models::ProjectSetupNewDataset, stream: models::ProjectSetupNewStream, users: models::ProjectSetupNewUsers) -> CreateProjectSetupRequest {
