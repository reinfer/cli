...
pub struct ThreadHistogramCounts {
    #[serde(rename = "bins")]
    pub bins: Vec<models::HistogramBin>,
    #[serde(rename = "labels")]
    pub labels: Vec<String>,
}

impl ThreadHistogramCounts {
    pub fn new(bins: Vec<models::HistogramBin>, labels: Vec<String>) -> ThreadHistogramCounts {
        ThreadHistogramCounts {
            bins,
            labels,
        }
    }
