...
pub struct PrivateKeyApplicationModel {
    #[serde(rename = "kind", skip_serializing_if = "Option::is_none")]
    pub kind: Option<models::PrivateKeyApplicationModelKind>,
...
impl PrivateKeyApplicationModel {
    pub fn new(tenant_id: String, client_id: String, thumbprint: String) -> PrivateKeyApplicationModel {
