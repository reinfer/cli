...
pub struct GetSourceCommentsResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "comments")]
    pub comments: Vec<models::Comment>,
    #[serde(rename = "thread_properties", skip_serializing_if = "Option::is_none")]
    pub thread_properties: Option<Vec<models::GetSourceCommentsResponseThreadPropertiesInner>>,
    #[serde(rename = "continuation", skip_serializing_if = "Option::is_none")]
    pub continuation: Option<String>,
}

impl GetSourceCommentsResponse {
    pub fn new(status: Status, comments: Vec<models::Comment>) -> GetSourceCommentsResponse {
        GetSourceCommentsResponse {
            status,
            comments,
