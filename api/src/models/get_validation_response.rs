...
pub struct GetValidationResponse {
    #[serde(rename = "status")]
    pub status: Status,
    ...
    pub validation: Box<models::ValidationSummary>,
    #[serde(rename = "moon", skip_serializing_if = "Option::is_none")]
    pub moon: Option<Box<models::MoonSummaryMetrics>>,
}

impl GetValidationResponse {
    pub fn new(status: Status, entity_defs: Vec<models::EntityDef>, label_groups: Vec<models::LabelGroup>, validation: models::ValidationSummary) -> GetValidationResponse {
