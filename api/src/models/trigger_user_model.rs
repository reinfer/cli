...
pub struct TriggerUserModel {
    #[serde(rename = "version")]
    pub version: i32,
    #[serde(rename = "label_thresholds", skip_serializing_if = "Option::is_none")]
    pub label_thresholds: Option<Vec<models::TriggerLabelThreshold>>,
}

impl TriggerUserModel {
    pub fn new(version: i32) -> TriggerUserModel {
        TriggerUserModel {
            version,
