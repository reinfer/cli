...
pub enum TrainView {
    ...
    Explore,
    #[serde(rename = "train_single")]
    TrainSingle,
    #[serde(rename = "train_multiple")]
    TrainMultiple,

}

impl std::fmt::Display for TrainView {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Discover => write!(f, "discover"),
            Self::Explore => write!(f, "explore"),
            Self::TrainSingle => write!(f, "train_single"),
            Self::TrainMultiple => write!(f, "train_multiple"),
        }
    }
}

impl Default for TrainView {
    fn default() -> TrainView {
        Self::Discover
    }
}
