...
pub struct PredictRawEmailsRequest {
    #[serde(rename = "documents")]
    pub documents: Vec<models::RawEmailDocument>,
    #[serde(rename = "threshold", skip_serializing_if = "Option::is_none")]
    pub threshold: Option<Box<models::Threshold>>,
    #[serde(rename = "labels", skip_serializing_if = "Option::is_none")]
    pub labels: Option<Vec<models::TriggerLabelThreshold>>,
...
impl PredictRawEmailsRequest {
    pub fn new(documents: Vec<models::RawEmailDocument>) -> PredictRawEmailsRequest {
