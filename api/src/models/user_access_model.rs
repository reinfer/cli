...
pub struct UserAccessModel {
    #[serde(rename = "kind")]
    pub kind: models::UserAccessModelKind,
...
impl UserAccessModel {
    pub fn new(kind: models::UserAccessModelKind, username: String) -> UserAccessModel {
        UserAccessModel {
            kind,
            username,
            password: None,
