...
/// MoonFormFieldAnnotationNew : Entity annotation for a verbatim
...
pub struct MoonFormFieldAnnotationNew {
    ...
    pub span: Option<Box<models::CommentSpanNewUtf16>>,
    /// Spans of the entity in the comment.
    #[serde(rename = "spans", skip_serializing_if = "Option::is_none")]
    pub spans: Option<Vec<models::CommentSpanNewUtf16>>,
    #[serde(rename = "formatted_value")]
    pub formatted_value: String,
    #[serde(rename = "field_id", skip_serializing_if = "Option::is_none")]
    pub field_id: Option<String>,
    #[serde(rename = "document_spans", skip_serializing_if = "Option::is_none")]
    pub document_spans: Option<Vec<models::DocumentSpan>>,
    /// Whether the field is confirmed.
    #[serde(rename = "confirmed", skip_serializing_if = "Option::is_none")]
    pub confirmed: Option<bool>,
}

impl MoonFormFieldAnnotationNew {
    /// Entity annotation for a verbatim
    pub fn new(formatted_value: String) -> MoonFormFieldAnnotationNew {
