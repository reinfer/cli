...
pub struct TaxonomyExtractionPrivate {
    #[serde(rename = "name")]
    pub name: Name,
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(rename = "field_groups")]
    pub field_groups: Vec<models::MatchedFieldGroupExtractions>,
    #[serde(rename = "draft_field_groups", skip_serializing_if = "Option::is_none")]
    pub draft_field_groups: Option<Vec<models::MatchedFieldGroupExtractions>>,
    #[serde(rename = "model_errors")]
    pub model_errors: Vec<models::ModelError>,
}

impl TaxonomyExtractionPrivate {
    pub fn new(name: Name, field_groups: Vec<models::MatchedFieldGroupExtractions>, model_errors: Vec<models::ModelError>) -> TaxonomyExtractionPrivate {
        TaxonomyExtractionPrivate {
            name,
            id: None,
            field_groups,
            draft_field_groups: None,
            model_errors,
        }
    }
}
