...
pub struct FieldAnnotationPrivate {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "id")]
    pub id: String,
    ...
    #[serde(rename = "confirmed", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub confirmed: Option<Option<bool>>,
}

impl FieldAnnotationPrivate {
    pub fn new(name: String, id: String, text_spans: Vec<models::TextSpan>, document_spans: Vec<models::DocumentSpan>, value: Option<models::FieldValuePrivate>) -> FieldAnnotationPrivate {
        FieldAnnotationPrivate {
            name,
            id,
            text_spans,
            document_spans,
