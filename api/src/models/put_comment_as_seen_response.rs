...
pub struct PutCommentAsSeenResponse {
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "training_action_completeness")]
    pub training_action_completeness: models::TrainingActionCompleteness,
}

impl PutCommentAsSeenResponse {
    pub fn new(status: Status, training_action_completeness: models::TrainingActionCompleteness) -> PutCommentAsSeenResponse {
        PutCommentAsSeenResponse {
            status,
