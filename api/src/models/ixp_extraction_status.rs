...
/// IxpExtractionStatus : An enumeration.
/// An enumeration.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum IxpExtractionStatus {
    #[serde(rename = "ready")]
    Ready,
...
impl std::fmt::Display for IxpExtractionStatus {
...
impl Default for IxpExtractionStatus {
    fn default() -> IxpExtractionStatus {
        Self::Ready
    }
}
