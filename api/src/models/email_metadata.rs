...
pub struct EmailMetadata {
    #[serde(rename = "sensitivity", deserialize_with = "Option::deserialize")]
    pub sensitivity: Option<String>,
    #[serde(rename = "size", deserialize_with = "Option::deserialize")]
    pub size: Option<i32>,
    #[serde(rename = "categories")]
    pub categories: Vec<String>,
    #[serde(rename = "importance", deserialize_with = "Option::deserialize")]
    pub importance: Option<String>,
    #[serde(rename = "has_attachments", deserialize_with = "Option::deserialize")]
    pub has_attachments: Option<bool>,
    #[serde(rename = "conversation_id", deserialize_with = "Option::deserialize")]
    pub conversation_id: Option<String>,
    #[serde(rename = "conversation_topic", deserialize_with = "Option::deserialize")]
    pub conversation_topic: Option<String>,
    #[serde(rename = "is_read", deserialize_with = "Option::deserialize")]
    pub is_read: Option<bool>,
    #[serde(rename = "folder")]
    pub folder: Vec<String>,
    #[serde(rename = "received_at", deserialize_with = "Option::deserialize")]
    pub received_at: Option<String>,
}

impl EmailMetadata {
    pub fn new(sensitivity: Option<String>, size: Option<i32>, categories: Vec<String>, importance: Option<String>, has_attachments: Option<bool>, conversation_id: Option<String>, conversation_topic: Option<String>, is_read: Option<bool>, folder: Vec<String>, received_at: Option<String>) -> EmailMetadata {
        EmailMetadata {
            sensitivity,
            size,
            categories,
