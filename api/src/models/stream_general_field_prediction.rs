...
pub struct StreamGeneralFieldPrediction {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "value", deserialize_with = "Option::deserialize")]
    pub value: Option<Box<models::StreamFieldValue>>,
    #[serde(rename = "confidence", deserialize_with = "Option::deserialize")]
    pub confidence: Option<f64>,
    /// The text spans in the comment that correspond to this field.
    #[serde(rename = "text_spans")]
    pub text_spans: Vec<models::StreamTextSpan>,
}

impl StreamGeneralFieldPrediction {
    pub fn new(name: String, value: Option<models::StreamFieldValue>, confidence: Option<f64>, text_spans: Vec<models::StreamTextSpan>) -> StreamGeneralFieldPrediction {
