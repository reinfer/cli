...
pub struct GeneralFieldDefUpdate {
    ...
    #[serde(rename = "field_type_name", skip_serializing_if = "Option::is_none")]
...
impl GeneralFieldDefUpdate {
    pub fn new(api_name: String, title: String) -> GeneralFieldDefUpdate {
        GeneralFieldDefUpdate {
            field_id: None,
            field_type_id: None,
