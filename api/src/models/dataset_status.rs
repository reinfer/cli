...
pub struct DatasetStatus {
    #[serde(rename = "training_complete", deserialize_with = "Option::deserialize")]
    pub training_complete: Option<f64>,
    #[serde(rename = "validation_complete", deserialize_with = "Option::deserialize")]
    pub validation_complete: Option<f64>,
    #[serde(rename = "training_completion_time")]
    pub training_completion_time: String,
    #[serde(rename = "inference_complete")]
    pub inference_complete: f64,
    #[serde(rename = "total_comments_with_text")]
    pub total_comments_with_text: i32,
    #[serde(rename = "inference_stats_by_version")]
    pub inference_stats_by_version: std::collections::HashMap<String, models::InferenceStats>,
    #[serde(rename = "inference_stuck")]
    pub inference_stuck: bool,
    #[serde(rename = "operation", deserialize_with = "Option::deserialize")]
    pub operation: Option<models::DatasetOperation>,
}

impl DatasetStatus {
    pub fn new(training_complete: Option<f64>, validation_complete: Option<f64>, training_completion_time: String, inference_complete: f64, total_comments_with_text: i32, inference_stats_by_version: std::collections::HashMap<String, models::InferenceStats>, inference_stuck: bool, operation: Option<models::DatasetOperation>) -> DatasetStatus {
        DatasetStatus {
            training_complete,
            validation_complete,
            training_completion_time,
            inference_complete,
            total_comments_with_text,
            inference_stats_by_version,
            inference_stuck,
            operation,
        }
    }
