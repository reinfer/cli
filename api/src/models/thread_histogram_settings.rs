...
pub struct ThreadHistogramSettings {
    #[serde(rename = "binning")]
    pub binning: Box<models::Binning>,
}

impl ThreadHistogramSettings {
    pub fn new(binning: models::Binning) -> ThreadHistogramSettings {
        ThreadHistogramSettings {
            binning: Box::new(binning),
        }
    }
}
