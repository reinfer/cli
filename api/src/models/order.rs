...
pub enum Order {
    #[serde(rename="recent")]
    Recent(Box<models::QueryCommentsOrderRecent>),
    #[serde(rename="any_label_asc")]
    AnyLabelAsc(Box<models::QueryCommentsOrderAnyLabel>),
    #[serde(rename="sample")]
    Sample(Box<models::QueryCommentsOrderSample>),
    #[serde(rename="diagnostic")]
    Diagnostic(Box<models::QueryCommentsOrderDiagnostic>),
    #[serde(rename="learning")]
    Learning(Box<models::QueryCommentsOrderLearning>),
    #[serde(rename="label_property")]
    LabelProperty(Box<models::QueryCommentsOrderLabelProperty>),
    #[serde(rename="by_label")]
    ByLabel(Box<models::QueryCommentsOrderByLabel>),
    #[serde(rename="text_search")]
    TextSearch(Box<models::QueryCommentsOrderTextSearch>),
    #[serde(rename="attachment_text_search")]
    AttachmentTextSearch(Box<models::QueryCommentsOrderAttachmentTextSearch>),
    #[serde(rename="check")]
    Check(Box<models::QueryCommentsOrderCheck>),
    #[serde(rename="missed")]
    Missed(Box<models::QueryCommentsOrderMissed>),
}

impl Default for Order {
    fn default() -> Self {
        Self::Recent(Default::default())
    }
}
...
pub enum DiagnosticKind {
    ...
    Informative,
    #[serde(rename = "label_only_neglect")]
    LabelOnlyNeglect,
    #[serde(rename = "neglect")]
    Neglect,
    #[serde(rename = "teach_entity")]
    TeachEntity,
    #[serde(rename = "missed_entity")]
    MissedEntity,
    #[serde(rename = "check_entity")]
    CheckEntity,
    #[serde(rename = "extraction_error_rate")]
    ExtractionErrorRate,
}

impl Default for DiagnosticKind {
    fn default() -> DiagnosticKind {
        Self::Bias
    }
}
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
