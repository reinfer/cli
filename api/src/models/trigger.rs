...
pub struct Trigger {
    ...
    pub model: Option<Box<models::TriggerUserModel>>,
}

impl Trigger {
    pub fn new(id: String, dataset_id: String, name: String, title: String, description: String, created_at: String, updated_at: Option<String>) -> Trigger {
        Trigger {
            id,
            dataset_id,
            name,
