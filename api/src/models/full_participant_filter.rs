...
pub struct FullParticipantFilter {
    #[serde(rename = "one_of", skip_serializing_if = "Option::is_none")]
    pub one_of: Option<Vec<String>>,
    #[serde(rename = "not_one_of", skip_serializing_if = "Option::is_none")]
    pub not_one_of: Option<Vec<String>>,
    #[serde(rename = "domain_one_of", skip_serializing_if = "Option::is_none")]
    pub domain_one_of: Option<Vec<String>>,
    #[serde(rename = "domain_not_one_of", skip_serializing_if = "Option::is_none")]
    pub domain_not_one_of: Option<Vec<String>>,
    #[serde(rename = "organisation_one_of", skip_serializing_if = "Option::is_none")]
    pub organisation_one_of: Option<Vec<String>>,
    #[serde(rename = "organisation_not_one_of", skip_serializing_if = "Option::is_none")]
    pub organisation_not_one_of: Option<Vec<String>>,
}

impl FullParticipantFilter {
    pub fn new() -> FullParticipantFilter {
        FullParticipantFilter {
            one_of: None,
            not_one_of: None,
            domain_one_of: None,
