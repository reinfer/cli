...
pub struct IssueDetail {
    /// The start period (inclusive) this issue is for
    #[serde(rename = "start")]
    pub start: String,
    /// The end period (exclusive) this issue is for
    #[serde(rename = "end")]
    pub end: String,
    /// The value of this issue that triggered the alert. For example, for a volume based alert, the comment volume in this time period.
    #[serde(rename = "value")]
    pub value: f64,
    /// True if this issue is currently ongoing
    #[serde(rename = "ongoing")]
    pub ongoing: bool,
}

impl IssueDetail {
    pub fn new(start: String, end: String, value: f64, ongoing: bool) -> IssueDetail {
        IssueDetail {
            start,
            end,
            value,
