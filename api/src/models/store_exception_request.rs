...
pub struct StoreExceptionRequest {
    #[serde(rename = "exceptions")]
    pub exceptions: Vec<models::ExceptionModel>,
}

impl StoreExceptionRequest {
    pub fn new(exceptions: Vec<models::ExceptionModel>) -> StoreExceptionRequest {
