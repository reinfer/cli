...
pub struct DatasetUpdateEntityDefsInner {
    #[serde(rename = "id")]
    pub id: String,
    ...
    pub inherits_from: Box<models::InheritsFrom>,
    #[serde(rename = "trainable")]
    pub trainable: bool,
    #[serde(rename = "rules", skip_serializing_if = "Option::is_none")]
    pub rules: Option<Box<models::EntityRuleSetNewApi>>,
    #[serde(rename = "_entity_def_flags", skip_serializing_if = "Option::is_none")]
    pub _entity_def_flags: Option<Vec<models::EntityDefFlag>>,
    #[serde(rename = "instructions", skip_serializing_if = "Option::is_none")]
    pub instructions: Option<String>,
}

impl DatasetUpdateEntityDefsInner {
    pub fn new(id: String, name: String, title: String, inherits_from: models::InheritsFrom, trainable: bool) -> DatasetUpdateEntityDefsInner {
        DatasetUpdateEntityDefsInner {
            id,
            color: None,
            name,
            title,
            inherits_from: Box::new(inherits_from),
            trainable,
            rules: None,
            _entity_def_flags: None,
            instructions: None,
        }
    }
}
