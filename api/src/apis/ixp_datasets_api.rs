...
/// struct for typed errors of method [`create_ixp_dataset`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateIxpDatasetError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`delete_ixp_dataset`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteIxpDatasetError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}
...
pub fn create_ixp_dataset(configuration: &configuration::Configuration, create_ixp_dataset_request: models::CreateIxpDatasetRequest) -> Result<models::CreateIxpDatasetResponse, Error<CreateIxpDatasetError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/ixp/datasets", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateIxpDatasetError> = serde_json::from_str(&local_var_content).ok();
...
pub fn delete_ixp_dataset(configuration: &configuration::Configuration, dataset_id: &str) -> Result<models::DeleteIxpDatasetResponse, Error<DeleteIxpDatasetError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/ixp/datasets/{dataset_id}", local_var_configuration.base_path, dataset_id=crate::apis::urlencode(dataset_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteIxpDatasetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
