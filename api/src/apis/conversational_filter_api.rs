...
/// struct for typed errors of method [`query_conversational_filter`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum QueryConversationalFilterError {
...
pub fn query_conversational_filter(configuration: &configuration::Configuration, owner: &str, dataset_name: &str, conversational_filter_request: models::ConversationalFilterRequest) -> Result<models::ConversationalFilterResponse, Error<QueryConversationalFilterError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/datasets/{owner}/{dataset_name}/conversational-filter-query", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), dataset_name=crate::apis::urlencode(dataset_name));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueryConversationalFilterError> = serde_json::from_str(&local_var_content).ok();
