...
pub fn get_document(configuration: &configuration::Configuration, source_id: &str, comment_id: &str) -> Result<std::path::PathBuf, Error<GetDocumentError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/sources/id:{source_id}/documents/{comment_id}", local_var_configuration.base_path, source_id=crate::apis::urlencode(source_id), comment_id=crate::apis::urlencode(comment_id));
...
pub fn upload_document(configuration: &configuration::Configuration, source_id: &str, file: Option<std::path::PathBuf>) -> Result<models::UploadDocumentResponse, Error<UploadDocumentError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/sources/id:{source_id}/documents", local_var_configuration.base_path, source_id=crate::apis::urlencode(source_id));
