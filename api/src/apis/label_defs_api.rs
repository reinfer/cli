...
#[serde(untagged)]
pub enum CreateLabelDefsBulkError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`delete_label_def`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteLabelDefError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_field_group_history`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFieldGroupHistoryError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_field_history`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFieldHistoryError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_label_def`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetLabelDefError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`update_label_def`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateLabelDefError {
    Status4XX(models::ErrorResponse),
    Status5XX(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}
...
pub fn create_label_defs_bulk(configuration: &configuration::Configuration, owner: &str, dataset_name: &str, label_group_name: &str, create_or_update_label_defs_bulk_request: models::CreateOrUpdateLabelDefsBulkRequest) -> Result<models::CreateLabelDefsBulkResponse, Error<CreateLabelDefsBulkError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/datasets/{owner}/{dataset_name}/labels/{label_group_name}", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), dataset_name=crate::apis::urlencode(dataset_name), label_group_name=crate::apis::urlencode(label_group_name));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateLabelDefsBulkError> = serde_json::from_str(&local_var_content).ok();
...
pub fn delete_label_def(configuration: &configuration::Configuration, owner: &str, dataset_name: &str, label_group_name: &str, label_name: &str) -> Result<models::DeleteLabelDefResponse, Error<DeleteLabelDefError>> {
    ...
    local_var_req_builder = local_var_req_builder.query(&[("label_name", &label_name.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    if let Some(ref local_var_apikey) = local_var_configuration.api_key {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteLabelDefError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn get_field_group_history(configuration: &configuration::Configuration, owner: &str, dataset_name: &str, label_group_name: &str, label_name: &str, older_than_version: Option<i32>) -> Result<models::GetFieldGroupHistoryResponse, Error<GetFieldGroupHistoryError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/datasets/{owner}/{dataset_name}/labels/{label_group_name}/{label_name}/history", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), dataset_name=crate::apis::urlencode(dataset_name), label_group_name=crate::apis::urlencode(label_group_name), label_name=crate::apis::urlencode(label_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = older_than_version {
        local_var_req_builder = local_var_req_builder.query(&[("older_than_version", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFieldGroupHistoryError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn get_field_history(configuration: &configuration::Configuration, owner: &str, dataset_name: &str, label_group_name: &str, label_name: &str, field_id: &str, older_than_version: Option<i32>) -> Result<models::GetFieldHistoryResponse, Error<GetFieldHistoryError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/datasets/{owner}/{dataset_name}/labels/{label_group_name}/{label_name}/fields/{field_id}/history", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), dataset_name=crate::apis::urlencode(dataset_name), label_group_name=crate::apis::urlencode(label_group_name), label_name=crate::apis::urlencode(label_name), field_id=crate::apis::urlencode(field_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFieldHistoryError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn get_label_def(configuration: &configuration::Configuration, owner: &str, dataset_name: &str, label_group_name: &str, label_name: &str) -> Result<models::GetLabelDefResponse, Error<GetLabelDefError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLabelDefError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn update_label_def(configuration: &configuration::Configuration, owner: &str, dataset_name: &str, label_group_name: &str, label_name: &str, label_def_update_request: models::LabelDefUpdateRequest) -> Result<models::UpdateLabelDefResponse, Error<UpdateLabelDefError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateLabelDefError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
