...
pub fn get_pretrained_labels(configuration: &configuration::Configuration, model_family: &str) -> Result<models::GetPretrainedLabelsResponse, Error<GetPretrainedLabelsError>> {
