...
/// struct for typed errors of method [`get_deprecated_user_models`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetDeprecatedUserModelsError {
...
pub fn get_deprecated_user_models(configuration: &configuration::Configuration, ) -> Result<models::GetDeprecatedUserModelsResponse, Error<GetDeprecatedUserModelsError>> {
    ...
    let local_var_uri_str = format!("{}/api/_private/deprecated-user-models", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDeprecatedUserModelsError> = serde_json::from_str(&local_var_content).ok();
