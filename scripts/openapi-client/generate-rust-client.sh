...
# Generate Rust client from a local spec file into ./api (or -o path).
# Usage: scripts/openapi-client/generate-rust-client.sh -i out/reinfer-v1.openapi-v3.1.json [-o api]
